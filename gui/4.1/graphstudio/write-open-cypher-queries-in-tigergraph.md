...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/graphstudio/write-open-cypher-queries-in-tigergraph)[Next](https://docs.tigergraph.com/gui/4.1/graphstudio/write-open-cypher-queries-in-tigergraph)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/graphstudio/write-open-cypher-queries-in-tigergraph)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/graphstudio/write-open-cypher-queries-in-tigergraph)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/graphstudio/pages/write-open-cypher-queries-in-tigergraph.adoc)
### Contents
  * [Writing openCypher Queries in GraphStudio](https://docs.tigergraph.com/gui/4.1/graphstudio/write-open-cypher-queries-in-tigergraph#_writing_opencypher_queries_in_graphstudio)
...
## [](https://docs.tigergraph.com/gui/4.1/graphstudio/write-open-cypher-queries-in-tigergraph#_writing_opencypher_queries_in_graphstudio)Writing openCypher Queries in GraphStudio
To write openCypher queries in GraphStudio, follow these steps:
  * Open GraphStudio and navigate to the "Write Queries" menu.


![openCypher writeQueriesMenu](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/openCypher_writeQueriesMenu.png)
  * Click on the


![openCypher GreenPlusButton](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/openCypher_GreenPlusButton.png)
and select "openCypher" as the query type, then click “Create”.
![openCypher AddQueryType](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/openCypher_AddQueryType.png)
