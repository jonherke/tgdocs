...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices)[Next](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/graphstudio/pages/explore-graph/search-for-vertices.adoc)
### Contents
  * [Search for vertices by ID](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices#_search_for_vertices_by_id)
  * [Let GraphStudio pick vertices](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices#_let_graphstudio_pick_vertices)
  * [Search with attribute filters](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices#_search_with_attribute_filters)
...
The first button in the Explore Graph Menu is the "Search Vertices" option ![search btn](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/search_btn.png). This option lets you select an initial set of vertices for your exploration. It is also the default option when you first enter the Explore Graph page. Clicking the button again will hide the Parameter Panel to increase space for the Graph Exploration Panel.
## [](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices#_search_for_vertices_by_id)Search for vertices by ID
...
![search vertex by id](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/search_vertex_by_id.png)
## [](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices#_let_graphstudio_pick_vertices)Let GraphStudio pick vertices
If you don’t have a particular vertex ID in mind, you can have GraphStudio pick some vertices for you. In the Parameter Panel, enter a number of vertices to pick, and click on the Pick vertices button![pick vertices btn](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/pick_vertices_btn.png). The explorer will pick this number of vertices for each vertex type included in your search.
![pick vertices](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/pick_vertices.png)
...
![pick vertex by type](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/pick-vertex-by-type.png)
## [](https://docs.tigergraph.com/gui/4.1/graphstudio/explore-graph/search-for-vertices#_search_with_attribute_filters)Search with attribute filters
...
![attr filter](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/attr-filter.png)
Click ADD, then the filter condition is shown below company vertex type:
![attr filter added](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/attr-filter-added.png)
Click the Pick vertices button​ ![pick vertices btn](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/pick_vertices_btn.png) again, TigerGraph will search for up to 1 company vertex with a `foundYear >= 2012`.
...
![new exploration result merged](https://docs.tigergraph.com/gui/4.1/graphstudio/_images/new_exploration_result_merged.png)
