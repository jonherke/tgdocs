...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/admin-portal/components/gsql)[Next](https://docs.tigergraph.com/gui/4.1/admin-portal/components/gsql)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/admin-portal/components/gsql)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/admin-portal/components/gsql)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/admin-portal/pages/components/gsql.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/4.1/admin-portal/components/gsql#_change_a_configuration_parameter)
...
![gsql page](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/gsql-page.png)
The following parameters can be changed in the Admin Portal:
  * GSQL.QueryResponseMaxSizeByte


## [](https://docs.tigergraph.com/gui/4.1/admin-portal/components/gsql#_change_a_configuration_parameter)Change a configuration parameter
