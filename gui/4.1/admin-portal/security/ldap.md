...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/admin-portal/security/ldap)[Next](https://docs.tigergraph.com/gui/4.1/admin-portal/security/ldap)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/admin-portal/security/ldap)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/admin-portal/security/ldap)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/admin-portal/pages/security/ldap.adoc)
### Contents
  * [LDAP Page](https://docs.tigergraph.com/gui/4.1/admin-portal/security/ldap#_ldap_page)
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/security/ldap#_ldap_page)LDAP Page
You can set up and configure LDAP settings through this page. To repopulate the fields with the default data, click the refresh button in the upper right corner of the page ![refresh button](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/refresh-button.png).
![ldap page](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/ldap-page.png)
...
![password show](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/password-show.png)
...
![ldap file uploading](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/ldap-file-uploading.png)
![ldap file uploaded](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/ldap-file-uploaded.png)
