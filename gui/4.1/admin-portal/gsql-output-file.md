...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file)[Next](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/admin-portal/pages/gsql-output-file.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_prerequisites)
  * [Procedure](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_procedure)
  * [Navigate to GSQL Output File page](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_navigate_to_gsql_output_file_page)
  * [Select nodes and provide file path](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_select_nodes_and_provide_file_path)
  * [Preview and download file](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_preview_and_download_file)
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_prerequisites)Prerequisites
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_procedure)Procedure
### [](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_navigate_to_gsql_output_file_page)Navigate to GSQL Output File page
...
![GSQL output file page](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/gsql-output-file-initial.png)
### [](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_select_nodes_and_provide_file_path)Select nodes and provide file path
...
---  
### [](https://docs.tigergraph.com/gui/4.1/admin-portal/gsql-output-file#_preview_and_download_file)Preview and download file
Once you provide a valid file path, you will be able to preview and download the file.
![File in preview](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/file-in-preview.png)
