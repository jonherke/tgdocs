...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README)[Next](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/admin-portal/pages/management/README.adoc)
### Contents
  * [Upgrading the Tools Suite](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README#_upgrading_the_tools_suite)
...
![admin portal onprem](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/admin-portal-onprem.png)
The following types of management are available on both platforms:
  * [User Management](https://docs.tigergraph.com/gui/4.1/admin-portal/management/user-management): Manage users, privileges, and data access
  * [Component Configuration](https://docs.tigergraph.com/gui/4.1/admin-portal/components/README): See and change configuation settings for various components of the TigerGraph system


The following types of management are available only on the self-managed (on-premises) edition of TigerGraph:
  * [License Management](https://docs.tigergraph.com/gui/4.1/admin-portal/management/license): See details about and update a license key
  * [Security Management](https://docs.tigergraph.com/gui/4.1/admin-portal/security/sso): Configure SSO and LDAP.
  * [Upgrading the Tools Suite](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README#_upgrading_the_tools_suite)
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/management/README#_upgrading_the_tools_suite)Upgrading the Tools Suite
...
![newer tools found](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/newer-tools-found.png)
