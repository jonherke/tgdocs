...
Page 1[Prev](https://docs.tigergraph.com/gui/4.1/admin-portal/overview)[Next](https://docs.tigergraph.com/gui/4.1/admin-portal/overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.1/admin-portal/overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.1/admin-portal/overview)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.1/modules/admin-portal/pages/overview.adoc)
### Contents
  * [Log On](https://docs.tigergraph.com/gui/4.1/admin-portal/overview#_log_on)
  * [Design controls](https://docs.tigergraph.com/gui/4.1/admin-portal/overview#_design_controls)
  * [Session Timeout](https://docs.tigergraph.com/gui/4.1/admin-portal/overview#_session_timeout)
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/overview#_log_on)Log On
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/overview#_design_controls)Design controls
The user menu is accessible from the User icon ![account btn](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/account_btn.png) in the header.
![admin user menu updated](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/admin-user-menu-updated.png)
...
![light theme](https://docs.tigergraph.com/gui/4.1/admin-portal/_images/light-theme.png)
...
## [](https://docs.tigergraph.com/gui/4.1/admin-portal/overview#_session_timeout)Session Timeout
