...
Page 1[Prev](https://docs.tigergraph.com/gui/3.6/graphstudio/explore-graph/run-gsql-queries)[Next](https://docs.tigergraph.com/gui/3.6/graphstudio/explore-graph/run-gsql-queries)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.6/graphstudio/explore-graph/run-gsql-queries)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.6/graphstudio/explore-graph/run-gsql-queries)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.6/modules/graphstudio/pages/explore-graph/run-gsql-queries.adoc)
# Run GSQL Queries
If you have written and installed some GSQL queries (see more at [Write Queries](https://docs.tigergraph.com/gui/3.6/graphstudio/write-queries)), you can run the queries mixed with the graph exploration functionalities mentioned above.
Click the fifth button in the Explore Graph Menu, which is the "Run queries" option ![code btn](https://docs.tigergraph.com/gui/3.6/graphstudio/_images/code_btn.png). In the dropdown list, choose the query you want to run. Input the parameters and click Run query button ![run query](https://docs.tigergraph.com/gui/3.6/graphstudio/_images/run_query.png). The query execution result subgraph will be merged with previous graph exploration result and highlighted:
![run gsql query](https://docs.tigergraph.com/gui/3.6/graphstudio/_images/run-gsql-query.png)
