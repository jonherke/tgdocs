...
Page 1[Prev](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso)[Next](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.6/modules/admin-portal/pages/security/sso.adoc)
### Contents
  * [Service provider information](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_service_provider_information)
  * [Hostname](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_hostname)
  * [X509 certificate and private key](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_x509_certificate_and_private_key)
  * [Identity provider information](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_identity_provider_information)
  * [Security options](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_security_options)
...
The settings on this page are related to set up Single Sign-on (SSO) on TigerGraph. This page does not appear on the Admin Portal for TigerGraph Cloud solutions because of the unified [User Authentication](https://docs.tigergraph.com/cloud/main/security/manage-db-users) system present in TigerGraph Cloud.
![sso page](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/sso-page.png)
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_service_provider_information)Service provider information
When you configure SSO on TigerGraph with a trusted identity provider, TigerGraph is the service provider.
### [](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_hostname)Hostname
The URL at which you access GraphStudio.
### [](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_x509_certificate_and_private_key)X509 certificate and private key
...
![sso file upload](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/sso-file-upload.png)
...
![self sign](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/self-sign.png)


## [](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_identity_provider_information)Identity provider information
...
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/security/sso#_security_options)Security options
...
It is recommended that you enable as many of the options as possible for maximum security. However, some identity providers do not support enabling certain options at the same time. Refer to your identity provider’s documentation to determine which options to use:
  * [Auth0](https://auth0.com/docs/configure/saml-configuration/customize-saml-assertions#saml-assertion-attributes)
  * [Okta](https://developer.okta.com/docs/reference/api/apps/#settings-9)
  * [Azure Active Directory (AD)](https://docs.microsoft.com/en-us/azure/active-directory/manage-apps/add-application-portal-setup-sso)
