...
Page 1[Prev](https://docs.tigergraph.com/gui/3.6/admin-portal/components/gsql)[Next](https://docs.tigergraph.com/gui/3.6/admin-portal/components/gsql)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.6/admin-portal/components/gsql)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.6/admin-portal/components/gsql)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.6/modules/admin-portal/pages/components/gsql.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.6/admin-portal/components/gsql#_change_a_configuration_parameter)
...
Click "GSQL" under "Components" in the left navigation panel to show the GSQL configuration page. The GSQL page in Admin Portal allows you to change the value of certain GSQL configuration parameters.
![gsql page](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/gsql-page.png)
The following parameters can be changed in Admin Portal:
  * GSQL.QueryResponseMaxSizeByte


## [](https://docs.tigergraph.com/gui/3.6/admin-portal/components/gsql#_change_a_configuration_parameter)Change a configuration parameter
...
Once you confirm, the GSQL server will restart to apply the changes, which will usually take several seconds. You will be notified after the changes are applied.
