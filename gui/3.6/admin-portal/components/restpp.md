...
Page 1[Prev](https://docs.tigergraph.com/gui/3.6/admin-portal/components/restpp)[Next](https://docs.tigergraph.com/gui/3.6/admin-portal/components/restpp)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.6/admin-portal/components/restpp)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.6/admin-portal/components/restpp)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.6/modules/admin-portal/pages/components/restpp.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.6/admin-portal/components/restpp#_change_a_configuration_parameter)
...
![restpp page](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/restpp-page.png)
The following parameters are configurable in Admin Portal:
  * Default query timeout


## [](https://docs.tigergraph.com/gui/3.6/admin-portal/components/restpp#_change_a_configuration_parameter)Change a configuration parameter
