...
Page 1[Prev](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx)[Next](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.6/modules/admin-portal/pages/components/nginx.adoc)
### Contents
  * [Allowed CIDR list](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx#_allowed_cidr_list)
  * [Response header](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx#_response_header)
  * [SSL for Nginx](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx#_ssl_for_nginx)
...
You can configure Nginx settings on **Admin Portal** **Management** **Security** **Nginx** page. Configurable settings include:
  * SSL configuration
  * Allowed CIDR list (whitelist IP)
  * Response header.


## [](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx#_allowed_cidr_list)Allowed CIDR list
...
![nginx allowed](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/nginx-allowed.png)
...
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx#_response_header)Response header
...
![nginx response header one](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/nginx-response-header-one.png)
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/components/nginx#_ssl_for_nginx)SSL for Nginx
![ssl for nginx](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/ssl-for-nginx.png) 
...
![ssl uploading](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/ssl-uploading.png)
