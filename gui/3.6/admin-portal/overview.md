...
Page 1[Prev](https://docs.tigergraph.com/gui/3.6/admin-portal/overview)[Next](https://docs.tigergraph.com/gui/3.6/admin-portal/overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.6/admin-portal/overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.6/admin-portal/overview)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.6/modules/admin-portal/pages/overview.adoc)
### Contents
  * [Log On](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_log_on)
  * [Page Layout](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_page_layout)
  * [Page Header](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_page_header)
  * [Cluster service status](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_cluster_service_status)
  * [Session Timeout](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_session_timeout)
...
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_log_on)Log On
...
If you are already at GraphStudio, click the **Admin** button at the right end of the top menu bar to navigate to Admin Portal.
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_page_layout)Page Layout
...
![dashboard](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/dashboard.png)
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_page_header)Page Header
The user menu is accessible from the User icon ![account btn](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/account_btn.png) in the header.
![admin user menu updated](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/admin-user-menu-updated.png)
You can switch between a dark theme and a light theme. The light theme is shown below:
![light theme](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/light-theme.png)
...
You can navigate to GraphStudio by clicking on the **GraphStudio** button in the upper right corner.
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_cluster_service_status)Cluster service status
The bottom of the navigation menu shows the cluster service status.
![service status](https://docs.tigergraph.com/gui/3.6/admin-portal/_images/service-status.png)
See the [Glossary](https://docs.tigergraph.com/tigergraph-server/4.2/intro/internal-architecture) section for information on these services.
## [](https://docs.tigergraph.com/gui/3.6/admin-portal/overview#_session_timeout)Session Timeout
