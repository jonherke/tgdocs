...
Page 1[Prev](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema)[Next](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.2/modules/graphstudio/pages/design-schema.adoc)
### Contents
  * [Design Schema](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_design_schema)
  * [Global View vs. Graph View](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_global_view_vs_graph_view)
  * [Add a vertex type](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_add_a_vertex_type)
  * [Vertex attributes](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_vertex_attributes)
  * [Add an edge type](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#add-an-edge-type-)
  * [Edge attributes](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_edge_attributes)
  * [Edit Vertex Or Edge Type](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#edit-vertex-or-edge-type-)
  * [Delete Vertex Or Edge Type](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#delete-vertex-or-edge-type-)
  * [Undo and redo](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#redo-and-undo-)
  * [View global vertex and edge types](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_view_global_vertex_and_edge_types)
  * [Publish schema](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#publish-schema-)
  * [Change or edit an existing schema](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_change_or_edit_an_existing_schema)
...
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_design_schema)Design Schema
...
![schema](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/schema.png)
...
---  
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_global_view_vs_graph_view)Global View vs. Graph View
...
![screen shot 2020 06 10 at 13.01.14](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/screen-shot-2020-06-10-at-13.01.14.png)
...
![schema local](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/schema-local.png)
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_add_a_vertex_type)Add a vertex type
Click the add vertex type button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/add_vertex_type.png) to add a vertex type. The working space will enter Add Vertex mode and open the add vertex type panel to the right:
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/add-vertex-panel.png)
...
### [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_vertex_attributes)Vertex attributes
...
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/add-attribute.png)
...
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/attribute-with-index.png)
...
---  
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#add-an-edge-type-)Add an edge type
Click the add edge type button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/add_edge_type.png) to enter Add Edge mode and add an edge type.
...
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/click_edge_type_source_vertex.png)
Click the target vertex type. The add edge type panel will appear to the right:
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/add-edge-panel.png)
...
### [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_edge_attributes)Edge attributes
![edge attributes](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/edge-attributes.png)
...
---  
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#edit-vertex-or-edge-type-)Edit Vertex Or Edge Type
You can edit the vertex types or edge types at any time after you add them. Click one vertex type circle or one edge link, then click the edit button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/edit.png) or double-click on the selected vertex or edge. working space will enter Edit mode, allowing you to use the Edit Attributes panel to make the same kinds of changes as in the Add panel.
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/edit-panel.png)
...
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/view-panel.png)
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#delete-vertex-or-edge-type-)Delete Vertex Or Edge Type
You can delete a vertex type or an edge type by first choosing the vertex type circles or edge type links, then clicking the delete button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/delete_btn.png) . In order to delete multiple vertex types and edge types, hold down the "Shift" key while you select multiple items.
Note that user cannot delete a global vertex or edge type using the delete button in a graph.   
---  
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#redo-and-undo-)Undo and redo
You can undo and redo your changes with the undo and redo buttons: ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/redo_undo_btn.png) . history since the time you entered the Design Schema page is recorded.
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_view_global_vertex_and_edge_types)View global vertex and edge types
Click the view global vertex and edge types button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/view-global-type-button.png) to assign global vertex and edge types to a graph, or drop them from a graph. The working space will enter View Global Vertex and Edge Types mode. The add vertex type panel will appear to the right:
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/view-global-types-panel.png)
...
---  
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#publish-schema-)Publish schema
Once you are satisfied with the graph schema, click the publish schema button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/publish_btn.png) to publish the schema to the TigerGraph system. If you are publishing a brand new schema, a progress bar will appear:
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/installing_schema_enterprise.png)
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/design-schema#_change_or_edit_an_existing_schema)Change or edit an existing schema
If a schema already exists, **Publish Schema** ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/publish_btn.png) will modify the existing schema.
...
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/affected_ve_types.png)
Finally, when you click publish schema button ![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/publish_btn.png) , a pop up window will summarize your changes to the schema. The vertex and edge types that will be removed are highlighted. Make sure you confirm the changes before continue:
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/screen-shot-2019-01-24-at-11.28.29-am.png)
Click continue button, and GraphStudio will start changing your schema:
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/changing_schema.png)
...
![image](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/migrate_data_mapping.png)
