...
Page 1[Prev](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices)[Next](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.2/modules/graphstudio/pages/explore-graph/expand-from-vertices.adoc)
### Contents
  * [1. Choose vertices To expand from](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices#_choose_vertices_to_expand_from)
  * [2. Set expansion conditions](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices#_set_expansion_conditions)
  * [3. Expand](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices#_expand)
...
The second button in the Explore Graph Menu is the "Expand from vertices" option![k step](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/k-step.png). "Expand" in this context means find 1-step or multi-step neighbors of the selected vertices. Clicking the button again will hide the Parameter Panel to increase space for the Graph Exploration Panel. To expand from vertices, you need to have at least one selected vertex in the Graph Exploration Panel. If no vertices are visible, please refer to the previous section "Search Vertices in Graph" to search for some vertices.
Shortcut: double-clicking on a vertex will expand to up to 200 neighbors of that vertex.  
---  
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices#_choose_vertices_to_expand_from)1. Choose vertices To expand from
...
![select multiple vertices](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/select-multiple-vertices.png)
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices#_set_expansion_conditions)2. Set expansion conditions
...
![config](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/config.png)
...
![add expansion step](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/add_expansion_step.png)
Similarly, you can remove expansion steps by clicking the "Remove Expansion Step" button.
![remove expansion step](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/remove_expansion_step.png)
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/expand-from-vertices#_expand)3. Expand
After setting the conditions for each expansion step, click on the "Expand" button![expand](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/expand.png)to perform the expansion. The Graph Exploration Panel will be updated to include the expansion result. The expansion starting vertices will be highlighted with a white border. Here is a sample two-step expansion starting from 1 vertex:
![two step](https://docs.tigergraph.com/gui/4.2/graphstudio/_images/two-step.png)
