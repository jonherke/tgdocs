...
Page 1[Prev](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api)[Next](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.2/modules/graphstudio/pages/explore-graph/query-status-api.adoc)
### Contents
  * [Authentication](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_authentication)
  * [Sample Request:](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_sample_request)
  * [Parameters](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_parameters)
  * [Response Fields](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_response_fields)
...
After you run queries in [Detached Mode](https://docs.tigergraph.com/gsql-ref/current/querying/query-operations#_detached_mode_async_option) via the RESTPP endpoint with the GSQL-ASYNC header set to true, you can use the Query Status API to obtain the status and results of the related request_id. This is similar to what you can retrieve from the RESTPP [Query Status API](https://docs.tigergraph.com/tigergraph-server/current/api/built-in-endpoints#_check_query_status_detached_mode) , along with the GPE logs.
GET /api/queries/<graphName>/query_status?requestid=<requestid>
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_authentication)Authentication
...
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_sample_request)Sample Request:
  * Request
  * Response
...
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_parameters)Parameters
...
## [](https://docs.tigergraph.com/gui/4.2/graphstudio/explore-graph/query-status-api#_response_fields)Response Fields
Field | Description  
---|---  
