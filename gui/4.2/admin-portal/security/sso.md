...
Page 1[Prev](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso)[Next](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/4.2/modules/admin-portal/pages/security/sso.adoc)
### Contents
  * [Service provider information](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_service_provider_information)
  * [Hostname](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_hostname)
  * [X509 certificate and private key](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_x509_certificate_and_private_key)
  * [Identity provider information](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_identity_provider_information)
  * [Security options](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_security_options)
...
![sso page](https://docs.tigergraph.com/gui/4.2/admin-portal/_images/sso-page.png)
## [](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_service_provider_information)Service provider information
When you configure SSO on TigerGraph with a trusted identity provider, TigerGraph is the service provider.
### [](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_hostname)Hostname
The URL at which you access GraphStudio.
### [](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_x509_certificate_and_private_key)X509 certificate and private key
...
![sso file upload](https://docs.tigergraph.com/gui/4.2/admin-portal/_images/sso-file-upload.png)
...
![self sign](https://docs.tigergraph.com/gui/4.2/admin-portal/_images/self-sign.png)


## [](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_identity_provider_information)Identity provider information
...
## [](https://docs.tigergraph.com/gui/4.2/admin-portal/security/sso#_security_options)Security options
