...
Page 1[Prev](https://docs.tigergraph.com/gui/3.9/graphstudio/actions)[Next](https://docs.tigergraph.com/gui/3.9/graphstudio/actions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.9/graphstudio/actions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.9/graphstudio/actions)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.9/modules/graphstudio/pages/actions.adoc)
### Contents
  * [Clear all graph data](https://docs.tigergraph.com/gui/3.9/graphstudio/actions#_clear_all_graph_data)
  * [Rebuild all graph data](https://docs.tigergraph.com/gui/3.9/graphstudio/actions#_rebuild_all_graph_data)
...
## [](https://docs.tigergraph.com/gui/3.9/graphstudio/actions#_clear_all_graph_data)Clear all graph data
![clear all graph data](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/clear-all-graph-data.png)
...
---  
## [](https://docs.tigergraph.com/gui/3.9/graphstudio/actions#_rebuild_all_graph_data)Rebuild all graph data
![rebuild all graph data](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/rebuild-all-graph-data.png)
