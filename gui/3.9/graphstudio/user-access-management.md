...
Page 1[Prev](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management)[Next](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.9/modules/graphstudio/pages/user-access-management.adoc)
### Contents
  * [Log On](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management#_log_on)
  * [Role- and graph-based access control](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management#_role_and_graph_based_access_control)
  * [GlobalView and Select A Graph](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management#_globalview_and_select_a_graph)
...
## [](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management#_log_on)Log On
...
![no accessible graphs](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/no-accessible-graphs.png)
Once inside GraphStudio, log out by clicking the User icon ![account btn](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/account_btn.png) and **Log Out**.
![logout \(1\)](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/logout%20\(1\).png)
## [](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management#_role_and_graph_based_access_control)Role- and graph-based access control
...
![user access control](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/user-access-control.png)
...
## [](https://docs.tigergraph.com/gui/3.9/graphstudio/user-access-management#_globalview_and_select_a_graph)GlobalView and Select A Graph
...
![global view](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/global-view.png)
...
![switch graph \(1\)](https://docs.tigergraph.com/gui/3.9/graphstudio/_images/switch-graph%20\(1\).png)
