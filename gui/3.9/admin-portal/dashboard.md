...
Page 1[Prev](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard)[Next](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.9/modules/admin-portal/pages/dashboard.adoc)
### Contents
  * [Overview](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_overview)
  * [Historic cluster monitoring](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_historic_cluster_monitoring)
  * [Selecting the time range](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_selecting_the_time_range)
  * [Machine Monitor](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_machine_monitor)
...
## [](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_overview)Overview
The Overview tab shows a map of all services that are part of the TigerGraph system and how they relate to each other.
![overview dependency view](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/overview-dependency-view.png)
...
![service monitor table view](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/service-monitor-table-view.png)
_Service monitoring table_
## [](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_historic_cluster_monitoring)Historic cluster monitoring
The Cluster Monitoring page shows resources used by different system components over time.
![historic cluster monitoring](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/historic-cluster-monitoring.png) _Cluster monitoring page_
### [](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_selecting_the_time_range)Selecting the time range
...
![charts list \(1\)](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/charts_list%20\(1\).png)
![query performance charts \(1\)](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/query_performance_charts%20\(1\).png)
_Query monitoring panel_
### [](https://docs.tigergraph.com/gui/3.9/admin-portal/dashboard#_machine_monitor)Machine Monitor
The Machine Monitoring panel includes four charts.
![cluster monitoring](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/cluster-monitoring.png)
