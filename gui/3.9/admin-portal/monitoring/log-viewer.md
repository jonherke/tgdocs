...
Page 1[Prev](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer)[Next](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.9/modules/admin-portal/pages/monitoring/log-viewer.adoc)
### Contents
  * [Open a log file from the file directory](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer#_open_a_log_file_from_the_file_directory)
  * [Search logs](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer#_search_logs)
...
![logs monitoring page](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/logs-monitoring-page.png)
...
---  
## [](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer#_open_a_log_file_from_the_file_directory)Open a log file from the file directory
...
![file listing](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/file-listing.png)
Choose one single log file by clicking on it, and the content will be shown in the display panel. The title will show the machine ID and the path of the opened log file. To the right, there is a download button ![download log btn](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/download-log-btn.png) for downloading the selected log file. Loaded log lines will add to the end of the file (the latest log content) and the system will keep pulling to update the log.
...
---  
![display log](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/display-log.png)
## [](https://docs.tigergraph.com/gui/3.9/admin-portal/monitoring/log-viewer#_search_logs)Search logs
If your browser window is wide, you will see the search panel at the top.
![image](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/log-search-panel.png)
If your browser window is narrow, the search panel collapsed. Click the btn:[Search] button to open it.
![log search button](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/log-search-button.png)
...
Use the expand ![image](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/expand-btn.png) or collapse ![image](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/collapse-btn.png) buttons for more space to view the log content, if necessary.
![image](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/search-result.png)
...
![image](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/single-search-result.png)
Clicking on a single search result will show the log content in the display panel and highlight the matching log line.
![image](https://docs.tigergraph.com/gui/3.9/admin-portal/_images/line-highlight-log%20\(1\).png)
