...
Page 1[Prev](https://docs.tigergraph.com/gui/3.11/graphstudio/known-issues)[Next](https://docs.tigergraph.com/gui/3.11/graphstudio/known-issues)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.11/graphstudio/known-issues)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.11/graphstudio/known-issues)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.11/modules/graphstudio/pages/known-issues.adoc)
# Known Issues
...
On Explore Graph, Build Graph Pattern and Write Query pages, a refresh button ![refresh button](https://docs.tigergraph.com/gui/3.11/graphstudio/_images/refresh-button.png) to retrieve updated data is used in the visualization viewer. If your color/size configs use an accumulator as a variable, it will be lost in the new visualization after clicking the refresh button.
### Report bugs to us
