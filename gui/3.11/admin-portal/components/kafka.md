...
Page 1[Prev](https://docs.tigergraph.com/gui/3.11/admin-portal/components/kafka)[Next](https://docs.tigergraph.com/gui/3.11/admin-portal/components/kafka)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.11/admin-portal/components/kafka)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.11/admin-portal/components/kafka)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.11/modules/admin-portal/pages/components/kafka.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.11/admin-portal/components/kafka#_change_a_configuration_parameter)
...
![kafka component mgmt](https://docs.tigergraph.com/gui/3.11/admin-portal/_images/kafka-component-mgmt.png)
...
## [](https://docs.tigergraph.com/gui/3.11/admin-portal/components/kafka#_change_a_configuration_parameter)Change a configuration parameter
