...
Page 1[Prev](https://docs.tigergraph.com/gui/3.11/admin-portal/components/gpe)[Next](https://docs.tigergraph.com/gui/3.11/admin-portal/components/gpe)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.11/admin-portal/components/gpe)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.11/admin-portal/components/gpe)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.11/modules/admin-portal/pages/components/gpe.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.11/admin-portal/components/gpe#_change_a_configuration_parameter)
...
![gpe component mgmt](https://docs.tigergraph.com/gui/3.11/admin-portal/_images/gpe-component-mgmt.png)
The following parameters can be changed in Admin Portal:
  * Maximum GPE memory per node (MB)


## [](https://docs.tigergraph.com/gui/3.11/admin-portal/components/gpe#_change_a_configuration_parameter)Change a configuration parameter
