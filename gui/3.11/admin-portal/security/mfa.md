...
Page 1[Prev](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa)[Next](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.11/modules/admin-portal/pages/security/mfa.adoc)
### Contents
  * [Azure Active Directory (AD)](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa#_azure_active_directory_ad)
  * [Prerequisites](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa#_prerequisites)
  * [Procedure](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa#_procedure)
...
## [](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa#_azure_active_directory_ad)Azure Active Directory (AD)
This section describes how to set up MFA with Azure Active Directory.
### [](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa#_prerequisites)Prerequisites
  1. [Set up SSO with Azure Active Directory](https://docs.tigergraph.com/gui/3.11/admin-portal/security/sso-aad).
  2. An Azure AD Tenant must be granted `Conditional Access Administrator` permissions.


### [](https://docs.tigergraph.com/gui/3.11/admin-portal/security/mfa#_procedure)Procedure
