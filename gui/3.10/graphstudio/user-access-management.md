...
Page 1[Prev](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management)[Next](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.10/modules/graphstudio/pages/user-access-management.adoc)
### Contents
  * [Log On](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management#_log_on)
  * [Role- and graph-based access control](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management#_role_and_graph_based_access_control)
  * [GlobalView and Select A Graph](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management#_globalview_and_select_a_graph)
...
GraphStudio follows the TigerGraph user authentication and role-based access control model as described in the document [User Access Management](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/).
## [](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management#_log_on)Log On
If the GSQL `tigergraph` superuser password hasn’t been changed from the default of `tigergraph`, then no user login is needed for GraphStudio. Otherwise, users must provide a username and password to log in to GraphStudio. In addition, your system administrator can integrate TigerGraph with other user access management systems (e.g., LDAP, Active Directory, or SAML-based Single Sign On). See the [User Access Management](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/) guide for information on setting up LDAP or SSO.
...
![no accessible graphs](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/no-accessible-graphs.png)
Once inside GraphStudio, log out by clicking the User icon ![account btn](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/account_btn.png) and **Log Out**.
![logout \(1\)](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/logout%20\(1\).png)
## [](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management#_role_and_graph_based_access_control)Role- and graph-based access control
...
![user access control](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/user-access-control.png)
...
---|---|---|---|---|---|---  
Create a new graph schema | YES | YES  
Drop a graph | YES | Can only drop graphs created by herself  
Modify a graph schema | YES | YES | YES | YES  
View a graph schema | YES | YES | YES | YES | YES | YES | YES  
Create a data mapping | YES | YES | YES | YES  
View a data mapping | YES | YES | YES | YES | YES | YES | YES  
Load data | YES | YES | YES | YES | YES | YES  
Explore a graph | YES | YES | YES | YES | YES | YES  
Write a query | YES | YES | YES | YES | YES  
Run a query | YES | YES | YES | YES | YES | YES  
## [](https://docs.tigergraph.com/gui/3.10/graphstudio/user-access-management#_globalview_and_select_a_graph)GlobalView and Select A Graph
The TigerGraph system can support multiple graphs within one TigerGraph instance. Read more at [MultiGraph - An Overview](https://docs.tigergraph.com/tigergraph-server/4.2/intro/multigraph-overview).
Superuser and globaldesigner users see the global view by default.
![global view](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/global-view.png)
...
![switch graph \(1\)](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/switch-graph%20\(1\).png)
