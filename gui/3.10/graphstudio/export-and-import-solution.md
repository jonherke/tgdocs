...
Page 1[Prev](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution)[Next](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.10/modules/graphstudio/pages/export-and-import-solution.adoc)
### Contents
  * [Export and Import](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution#_export_and_import)
  * [Export](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution#_export)
  * [Import](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution#_import)
...
## [](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution#_export_and_import)Export and Import
...
---  
### [](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution#_export)Export
Click **Export Current Solution** to start to export the whole solution as a tar file.
![export solution](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/export-solution.png)
...
![export options](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/export-options.png)
...
This `ExportedGraph.zip` file is identical to what is produced by running the [database export command](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/database-import-export) with the template option and the data option(if the corresponding checkbox is selected).  
---  
...
---  
### [](https://docs.tigergraph.com/gui/3.10/graphstudio/export-and-import-solution#_import)Import
Click **Import an Existing Solution** to upload a previously exported tar file.
![import solution](https://docs.tigergraph.com/gui/3.10/graphstudio/_images/import-solution.png)
