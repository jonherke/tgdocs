...
Page 1[Prev](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gpe)[Next](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gpe)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gpe)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gpe)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.10/modules/admin-portal/pages/components/gpe.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gpe#_change_a_configuration_parameter)
...
You can configure GPE settings on the **Admin Portal** **Management** **Security** **GPE** page.
The GPE is the execution engine for graph processing requests in the database.
![gpe component mgmt](https://docs.tigergraph.com/gui/3.10/admin-portal/_images/gpe-component-mgmt.png)
The following parameters can be changed in Admin Portal:
  * Maximum GPE memory per node (MB)


## [](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gpe#_change_a_configuration_parameter)Change a configuration parameter
...
Once you confirm, the GPE server will restart to apply the changes, which will usually take several seconds. You will be notified after the changes are applied.
