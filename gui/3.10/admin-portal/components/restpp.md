...
Page 1[Prev](https://docs.tigergraph.com/gui/3.10/admin-portal/components/restpp)[Next](https://docs.tigergraph.com/gui/3.10/admin-portal/components/restpp)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.10/admin-portal/components/restpp)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.10/admin-portal/components/restpp)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.10/modules/admin-portal/pages/components/restpp.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.10/admin-portal/components/restpp#_change_a_configuration_parameter)
...
You can configure RESTPP settings on the **Admin Portal** **Management** **Conponents** **RESTPP** page.
![restpp page](https://docs.tigergraph.com/gui/3.10/admin-portal/_images/restpp-page.png)
The following parameters are configurable in Admin Portal:
  * Default query timeout (seconds)
  * Maximum concurrent running ["heavy" built-in queries](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/workload-management#_limit_number_of_current_built_in_heavy_queries)
  * Maximum concurrent running queries
  * Maximum delay queue size


See [Workload Management](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/workload-management) for more information about some of these settings.
## [](https://docs.tigergraph.com/gui/3.10/admin-portal/components/restpp#_change_a_configuration_parameter)Change a configuration parameter
...
Once you confirm, the RESTPP server will restart to apply the changes, which will usually take several seconds. You will be notified after the changes are applied.
