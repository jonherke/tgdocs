...
Page 1[Prev](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gui)[Next](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gui)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gui)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gui)
...
[Edit this Page](https://github.com/tigergraph/gui-docs/edit/3.10/modules/admin-portal/pages/components/gui.adoc)
### Contents
  * [Change a configuration parameter](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gui#_change_a_configuration_parameter)
...
![gui page](https://docs.tigergraph.com/gui/3.10/admin-portal/_images/gui-page.png)
...
## [](https://docs.tigergraph.com/gui/3.10/admin-portal/components/gui#_change_a_configuration_parameter)Change a configuration parameter
