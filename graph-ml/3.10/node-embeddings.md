...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/)[Next](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/node-embeddings/pages/index.adoc)
...
The TigerGraph Graph Data Science Library provides the following node embedding algorithms:
  * [Fast Random Projection](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/fast-random-projection)
  * [NodePiece](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece) is a highly scalable node embedding technique. It is implemented in the pyTigerGraph library. Using it requires a few additional steps, but it is our most scalable offering.
  * **Weisfeiler-Lehman isomorphism** has been moved to the [Classification](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/) category.
  * **Node2Vec** has been retired (as of v3.9.2) because it did not meet our standards for efficiency and scalability of memory usage. [Fast Random Projection](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/fast-random-projection) is a better alternative.
