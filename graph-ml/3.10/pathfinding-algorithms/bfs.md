...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs)[Next](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/pathfinding-algorithms/pages/bfs.adoc)
### Contents
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_example)
...
Algorithm link: [Breadth-First Search](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Path/bfs)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_parameters)Parameters
**Parameter** | Description | Default  
---|---|---  
`SET<STRING> v_type_set` | Vertex types to traverse | (empty set of strings)  
`SET<STRING> e_type_set` | Edge types to traverse | (empty string)  
`INT max_hops` | Maximum hops for the algorithm to look from each vertex | 10  
`VERTEX v_start` | Source vertex for traversal. Provide the vertex ID and type as a tuple: `("id","type")` | N/A  
`BOOL print_results` | Whether to print JSON output | True  
`STRING result_attribute` | The vertex attribute to store results to in `INT` format | (empty string)  
`STRING file_path` | The path for a CSV output file | (empty string)  
`BOOL display_edges` | Whether to output edges for visualization | False  
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_output)Output
...
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_time_complexity)Time complexity
...
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/bfs#_example)Example
...
![bfs ex](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/_images/bfs-ex.png)
