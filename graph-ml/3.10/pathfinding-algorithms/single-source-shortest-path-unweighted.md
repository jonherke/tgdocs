...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted)[Next](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/pathfinding-algorithms/pages/single-source-shortest-path-unweighted.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_time_complexity)
  * [Space complexity](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_space_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_example)
...
Algorithm link: [Single-source Shortest Path (Unweighted)](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Path/shortest_path/unweighted)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_notes)Notes
On a graph with weighted edges, use [Single-source Shortest Path (Weighted)](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-weighted). With weighted edges, the algorithm must search the whole graph, whether you want the path for just one destination or for all destinations.
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_parameters)Parameters
...
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_output)Output
...
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_time_complexity)Time complexity
This algorithm has a time complexity of O(E), where E is equal to the number of edges.
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_space_complexity)Space complexity
This algorithm has a space complexity of O(VlogV), where V is equal to the number of vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/single-source-shortest-path-unweighted#_example)Example
...
![Generic graph with unweighted edges](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/_images/screen-shot-2019-01-09-at-6.20.14-pm.png)
```
[
 {
  "ResultSet": [
