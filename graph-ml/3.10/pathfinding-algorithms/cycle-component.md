...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component)[Next](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/pathfinding-algorithms/pages/cycle-component.adoc)
### Contents
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_time_complexity)
  * [Space complexity](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_space_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_example)
...
Algorithm link: [Cycle Component](https://github.com/tigergraph/gsql-graph-algorithms/blob/master/algorithms/Path/cycle_component/tg_cycle_component.gsql)
The Cycle Component algorithm finds vertices that are on a cycle. It can be used as a helper algorithm for the [Cycle Detection](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-detection) algorithm. It returns a set of only the vertices which are on at least one cycle, which saves memory compared to finding and returning all cycles.
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_parameters)Parameters
Parameter | Data type | Description  
---|---|---  
`v_type` | `STRING` | The type of vertex to search for.  
`e_type` | `STRING` | The type of edge to search for.  
`print_results` | `BOOL` | Whether or not to print the path to the console.  
`result_attribute` | `STRING` | The attribute on the vertex that will store the result.  
`file_path` | `STRING` | If not empty, write output to this file.  
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_output)Output
This query returns the vertices that appear on at least one cycle in JSON format.
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_time_complexity)Time complexity
This algorithm has a time complexity of O(VE), where V is the number of vertices and E is the number of edges.
### [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_space_complexity)Space complexity
This algorithm has a space complexity of O(V), where V is the number of vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/cycle-component#_example)Example
You can run this query on the default Friendship graph included with the Getting Started with Docker tutorial.
![cycle component graph dark](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/_images/cycle-component-graph-dark.png)
In this graph, there is a cycle that includes Tom, Dan, and Jenny. Running tg_cycle_component returns those three vertices.
![cycle component results dark](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/_images/cycle-component-results-dark.png)
```
[
 {
  "V": [
