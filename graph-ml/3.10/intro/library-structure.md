...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure)[Next](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/intro/pages/library-structure.adoc)
### Contents
  * [GDBMS_ALGO and algorithms](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_gdbms_algo_and_algorithms)
  * [UDF](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_udf)
  * [graphs folder](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_graphs)
  * [Release Branches](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_release_branches)
...
You can download the library from GitHub: [https://github.com/tigergraph/gsql-graph-algorithm](https://github.com/tigergraph/gsql-graph-algorithms)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_gdbms_algo_and_algorithms)GDBMS_ALGO and algorithms
...
## [](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_udf)UDF
...
For more on UDFs, see [Query User-Defined Functions](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/query-user-defined-functions).
## [](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_graphs)`graphs` folder
...
## [](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure#_release_branches)Release Branches
