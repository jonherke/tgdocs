...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality)[Next](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/centrality-algorithms/pages/degree-centrality.adoc)
### Contents
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_time_complexity)
  * [Run commands](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_run_commands)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_example)
...
Algorithm link: [Degree Centrality](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Centrality/degree)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_parameters)Parameters
...
`SET<STRING> reverse_e_type_set` | A set of reverse edge types. If an edge is undirected, put the edge name in the set as well. | (empty set of strings)  
`BOOL in_degree` | Boolean value that indicates whether to count the incoming edges as part of a vertex’s degree centrality. | True  
`BOOL out_degree` | Boolean value that indicates whether to count the outgoing edges as part of a vertex’s degree centrality. | True  
...
`STRING result_attribute` | If not empty, save the degree centrality score of each vertex to this attribute. | (empty string)  
`STRING file_path` | If not empty, save results in CSV to this file. | (empty string)  
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_output)Output
The vertices with the highest degree centrality scores along with their scores.
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_time_complexity)Time complexity
The algorithm has a time complexity of O(E), where E is the total number of edges in the graph.
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_run_commands)Run commands
#### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_schema_free_query)Schema-Free Query
```
...
#### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_packaged_template_query)Packaged Template Query
```
...
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/degree-centrality#_example)Example
Suppose we have the following graph:
![social graph 2022 10](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/_images/social-graph-2022-10.png)
