...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test)[Next](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Harmonic Centrality](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test)


[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/centrality-algorithms/pages/alg-header-test.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_output)
  * [Result size](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_result_size)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_example)
...
---|---|---  
Undirected, Directed | Unweighted | Homogeneous, Heterogeneous  
  ...
  * **Format and Deployment Options**
    ...
    * Packaged template
    * GSQL source code: [Harmonic Centrality](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Centrality/harmonic)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_notes)Notes
For more information, see the paper on Harmonic Centrality: [Marchiori and Latora 2000, _Harmony in the Small-World_](https://arxiv.org/pdf/cond-mat/0008357.pdf).
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_parameters)Parameters
Name | Description | Default value  
---|---|---  
`SET<STRING> v_type_set` | Vertex types to calculate harmonic centrality for | (empty set of strings)  
`SET<STRING> e_type_set` | Edge types to traverse | (empty set of strings)  
`SET<STRING> reverse_e_type_set` | Reverse edge types to traverse | (empty set of strings)  
`INT max_hops` | The maximum number of hops the algorithm considers for each vertex. If set to a non-positive value, the limit is ignored. | 10  
`INT top_k` | Output the highest `k` scores | 100  
`BOOL wf` | Whether to use the Wasserman-Faust normalization for multi-component graphs | True  
`BOOL print_results` | Whether to output JSON to standard output | True  
`STRING result_attribute` | If not empty, store centrality values in FLOAT format to this attribute | (empty string)  
`STRING file_path` | If not empty, write output to this file in CSV. | (empty string)  
`BOOL display_edges` | Whether to include the graph’s edges in the JSON output so that the full graph can be displayed. | False  
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_output)Output
...
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_result_size)Result size
...
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_time_complexity)Time complexity
The algorithm has a time complexity of O(E), where E is the number of edges.
Parallel processing reduces the time needed for computation.
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/alg-header-test#_example)Example
...
![assets%2F LHvjxIN4 6bA0T QmU%2F MjV3bZEHcUwHHMYo7gT%2F MjVDzTrVXazrel4EdU7%2Fimage](https://gblobscdn.gitbook.com/assets%2F-LHvjxIN4__6bA0T-QmU%2F-MjV3bZEHcUwHHMYo7gT%2F-MjVDzTrVXazrel4EdU7%2Fimage.png?alt=media&token=1611630a-1bf9-4097-b432-0a0c1c388f22)
  * GSQL command
  * Result
