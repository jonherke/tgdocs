...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank)[Next](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/centrality-algorithms/pages/personalized-pagerank.adoc)
### Contents
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank#_parameters)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank#_example)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank#_parameters)Parameters
**Parameter** | Description | Default  
---|---|---  
`SET<VERTEX> source` | IDs and types of vertices to use. Provide each vertex ID and type as a tuple: `("id","type")` | (empty set of string tuples)  
`STRING e_type` | Name of edge types to use | (empty string)  
...
## [](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/personalized-pagerank#_example)Example
...
![Visualized results of example query on social10 graph](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/_images/screen-shot-2019-04-25-at-4.09.01-pm%20\(1\).png)
