...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/)[Next](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/using-an-algorithm/pages/index.adoc)
### Contents
  * [Install/Run on GraphStudio](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_installrun_on_graphstudio)
  * [Install/Run as Standard GSQL Queries](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_installrun_as_standard_gsql_queries)
  * [Install/Run as Packaged Template Queries](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_installrun_as_packaged_template_queries)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_output)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_installrun_on_graphstudio)Install/Run on GraphStudio
Nearly all algorithms are available in [GraphStudio’s built-in menu of graph algorithms](https://docs.tigergraph.com/gui/4.2/graphstudio/write-queries#_create_a_query_or_add_a_query_from_the_algorithm_library) that lets you click-to-choose and then install any or all graph algorithms. For new users on TigerGraph Cloud, this is the simplest way.
## [](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_installrun_as_standard_gsql_queries)Install/Run as Standard GSQL Queries
...
See [Algorithms as GSQL Queries](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/algorithms-as-gsql-queries).
## [](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_installrun_as_packaged_template_queries)Install/Run as Packaged Template Queries
Database versions 3.8 and higher offer selected algorithms in an additional format, as packaged template queries. The packaging simplifies the installation and management of the library, and new CALL command performs just-in-time compilation of the template queries to offer even better performance than before. TigerGraph is continually improving its library. To get the latest version, users can always go to our GitHub repository: [GSQL Graph Algorithm Repository](https://github.com/tigergraph/gsql-graph-algorithms).
See [Packaged Template Algorithms](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/packaged-template-algorithms).
## [](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/#_output)Output
...
If you are running an algorithm on a TigerGraph Cloud cluster, you need to use AdminPortal to download the algorithm’s output files to your local machine. See [Download GSQL Output File](https://docs.tigergraph.com/gui/4.2/admin-portal/gsql-output-file) for details.
