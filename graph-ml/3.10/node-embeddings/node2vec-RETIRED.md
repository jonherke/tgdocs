...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED)[Next](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Node2Vec](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED)


[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/node-embeddings/pages/node2vec-RETIRED.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED#_parameters)
...
Algorithm link: [Node2Vec](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/GraphML/Embeddings/Node2Vec)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED#_notes)Notes
Node2Vec consumes a lot of memory and is less scalable than [Fast Random Projection](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/fast-random-projection). It is included in the library for legacy reasons, but in most cases, Fast Random Projection is recommended instead.
This algorithm ignores edge weights.
## [](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED#_specifications)Specifications
```
...
Installing this query requires [installing a UDF](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/query-user-defined-functions), which can be found in the [GitHub repository of the query](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/GraphML/Embeddings/Node2Vec). If you are running the query on a cluster, you need to manually install the UDF on every node of the cluster.
### [](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/node2vec-RETIRED#_parameters)Parameters
