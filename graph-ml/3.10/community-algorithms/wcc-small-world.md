...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world)[Next](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/community-algorithms/pages/wcc-small-world.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_notes)
  * [References](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_references)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_example)
...
Algorithm link: [WCC (Small-World Optimized)](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Community/connected_components/weakly_connected_components/small_world)
...
The algorithm starts by selecting an initial pivot vertex _v_ with a high product of indegree and outdegree. From the initial pivot vertex, the algorithm uses Breadth-First Search to determine the massive weakly connected component. The vertices that are not included in this SCC are passed off to the next step.
After identifying the first WCC, the algorithm uses the coloring method to identify the WCCs in the remaining vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_notes)Notes
...
### [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_references)References
[Slota et al., _BFS and Coloring-based Parallel Algorithms for Strongly Connected Components and Related Problems._](https://www.osti.gov/servlets/purl/1115145)
## [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_parameters)Parameters
Name | Description | Default value  
---|---|---  
`STRING v_type` | The vertex type to count as part of a connected component | (empty string)  
`STRING e_type` | The edge type to traverse | (empty string)  
`UINT threshold` | The threshold used to choose initial pivot vertices. Only vertices whose product of indegree and outdegree exceed this threshold will be considered candidates for the pivot vertex. | `100000`  
`BOOL print_results` | If true, the algorithm will return the number of vertices in each connected component. | True  
### [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_output)Output
If `print_results` is set to true, the algorithm will return the number of vertices in each weakly connected component.
### [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_time_complexity)Time complexity
The algorithm has a time complexity of O(E∗d), where E is the number of edges and d is max(diameter of components).
## [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/wcc-small-world#_example)Example
...
![img](https://gblobscdn.gitbook.com/assets%2F-LHvjxIN4__6bA0T-QmU%2F-MjpghRK59F9jlLUrQCW%2F-MjpqQY6nQAyQ7fovfBw%2Fimage.png?alt=media&token=d04eabf3-f08c-49e2-94fd-f65488ba3495)
  * GSQL Command
  * Result
