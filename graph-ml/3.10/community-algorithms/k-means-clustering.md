...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering)[Next](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/community-algorithms/pages/k-means-clustering.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering#_parameters)
...
Algorithm link: [k-Means Clustering](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Community/k_means)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering#_notes)Notes
This algorithm ignores edges in the graph and looks only at vertex attributes.
This query uses another subquery [`tg_kmeans_sub`](https://github.com/tigergraph/gsql-graph-algorithms/blob/master/algorithms/Community/k_means/tg_kmeans_sub.gsql), which needs to be installed before `tg_kmeans` can be installed.
...
## [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering#_specifications)Specifications
```
...
## [](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/k-means-clustering#_parameters)Parameters
Name | Description | Default Value  
---|---|---  
`INT k` | The starting value of the K range | `2`  
`INT max_k` | The ending value of the K range | `5`  
`FLOAT max_change` | The maximum centroid vector change condition | `1`  
`STRING v_type` | Vertex type to start from | (empty string)  
`STRING e_type` | Edge type to traverse | (empty string)  
`BOOL random` | Whether to start from either random or non-random centroid positions | `FALSE`  
`BOOL print_accum` | Whether to print JSON output to the console | `FALSE`  
`STRING file_path` | File to write CSV output to | (empty string)  
