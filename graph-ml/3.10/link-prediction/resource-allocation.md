...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation)[Next](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/link-prediction/pages/resource-allocation.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_example)
...
Algorithm link: [Resource Allocation](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Topological%20Link%20Prediction/resource_allocation)
...
RA(x,y)=∑u∈N(x)∩N(y)1|N(u)|
Where N(u) is the set of nodes adjacent to _u_.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_notes)Notes
This algorithm ignores edge weights.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_parameters)Parameters
...
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_output)Output
Returns a closeness value for two input vertices.
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_time_complexity)Time complexity
The algorithm has a time complexity of O(D1+D2), where D1 and D2 are the degrees of the two vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/resource-allocation#_example)Example
