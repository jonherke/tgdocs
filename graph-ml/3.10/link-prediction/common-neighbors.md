...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors)[Next](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/link-prediction/pages/common-neighbors.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_example)
...
Algorithm Link: [Common Neighbors](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Topological%20Link%20Prediction/common_neighbors)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_notes)Notes
This algorithm ignores edge weights.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_parameters)Parameters
...
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_output)Output
Returns the number of common neighbors between two vertices expressed as a `closeness` value.
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_time_complexity)Time complexity
The algorithm has a time complexity of O(D1+D2), where D1 and D2 are the degrees of the two vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/common-neighbors#_example)Example
