...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community)[Next](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/link-prediction/pages/same-community.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_example)
...
Algorithm link: [Same Community](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Topological%20Link%20Prediction/same_community)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_notes)Notes
The algorithm assumes that a community ID is stored in an integer attribute on each vertex. For this to happen, usually a [Community Detection](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/) algorithm is run to create such community IDs.
This algorithm ignores edge weights.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_parameters)Parameters
...
`STRING communityAttribute` | The vertex attribute used to store a vertex’s community ID. | (A blank string)  
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_output)Output
  * Returns `1` if the two vertices are in the same community.
  * Returns `0` if the two vertices are not in the same community.


### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_time_complexity)Time complexity
The algorithm has a time complexity of O(1).
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/same-community#_example)Example
Suppose we have the following vertices:
![same community ex](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/_images/same-community-ex.png)
Their community IDs were generated by running the [Weakly Connected Components](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/connected-components) algorithm on the graph. If we run the algorithm between Kevin and Jenny, we get 1 because the two vertices are in the same community as indicated by their `community` attribute:
  * Query
  * Result
