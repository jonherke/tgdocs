...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors)[Next](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/link-prediction/pages/total-neighbors.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_parameters)
  * [Output](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_output)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_time_complexity)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_example)
...
Algorithm link: [Total Neighbors](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Topological%20Link%20Prediction/total_neighbors)
The algorithm counts the total number of neighbors, or vertices connected by one hop, of two vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_notes)Notes
This algorithm ignores edge weights.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_parameters)Parameters
...
`SET<STRING> e_type_set` | Edge types to traverse. | (an empty set of strings)  
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_output)Output
The total number of neighbors of two vertices as a `closeness` value.
### [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_time_complexity)Time complexity
The algorithm has a time complexity of O(D1+D2), where D1 and D2 are the degrees of the two vertices.
## [](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/total-neighbors#_example)Example
