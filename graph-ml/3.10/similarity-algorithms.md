...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/)[Next](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/similarity-algorithms/pages/index.adoc)
### Contents
  * [Neighborhood Similarity Algorithms](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/#_neighborhood_similarity_algorithms)
  * [Vector Similarity Functions](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/#_vector_similarity_functions)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/#_neighborhood_similarity_algorithms)Neighborhood Similarity Algorithms
...
## [](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/#_vector_similarity_functions)Vector Similarity Functions
...
Because they are functions, they are documented in the GSQL Reference Manual section on [Vector Functions](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/vector-functions).
  1. Technically, these are functions, not algorithms. Whereas a GSQL algorithm IS a query, a function can be used someplace _within_ a query, to compute a value.
  2. These vector functions look only at lists or sets of values. They do not look at vertices or edges.
  3. These vector functions are currently implemented as pre-installed user-defined functions (UDFs) within the Graph Data Science Library. It is not necessary to install any particular algorithm in order to use these functions.
