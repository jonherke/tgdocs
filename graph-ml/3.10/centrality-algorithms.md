...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/)[Next](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/centrality-algorithms/pages/index.adoc)
# Centrality Algorithms
Centrality algorithms find the important vertices in a graph based on their connections with other vertices. A centrality algorithm usually assigns scores to vertices or edges based on how close they are to the center of connection-based activity. The definition of closeness and what constitutes the center of connection-based activity depend on the algorithm.
