...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring)[Next](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/classification-algorithms/pages/greedy-graph-coloring.adoc)
### Contents
  * [Notes](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_notes)
  * [Specifications](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_specifications)
  * [Parameters](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_parameters)
  * [Time complexity](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_time_complexity)
  * [Run commands](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_run_commands)
  * [Example](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_example)
...
Algorithm link: [Greedy Graph Coloring](https://github.com/tigergraph/gsql-graph-algorithms/tree/master/algorithms/Classification/greedy_graph_coloring)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_notes)Notes
This algorithm ignores edge weights.
## [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_specifications)Specifications
```
...
### [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_parameters)Parameters
Name | Description  
---|---  
`SET<STRING> v_type_set` | A set of all vertex types to color.  
`SET<STRING> e_type_set` | A set of all edge types to traverse.  
`INT max_colors` | The Maximum number of colors that can be used. Use a large number like `999999` unless there is a strict limit.  
...
### [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_time_complexity)Time complexity
The algorithm has a worst-case time complexity of O(V2+E), where V is the number of vertices and E is the number of edges.
### [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_run_commands)Run commands
#### [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_schema_free_query)Schema-Free Query
```
...
#### [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_packaged_template_query)Packaged Template Query
```
...
## [](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/greedy-graph-coloring#_example)Example
On the [social10](https://github.com/tigergraph/gsql-graph-algorithms/blob/master/tests/social/data/social10.csv) graph, say we want to color the `Person` vertices in such a way that any two vertices that are either connected by a `Friend` edge or a `Coworker` edge do not have the same color. By running the `greedy_graph_color` algorithm, we get the following result:
```
...
![Visualized result - no neighboring vertices share the same color](https://gblobscdn.gitbook.com/assets%2F-LHvjxIN4__6bA0T-QmU%2F-MTIVaC7IrVUxaa6b0wB%2F-MTIboMHDZfHMiJfFS-d%2Fimage.png?alt=media&token=434b94b8-702f-447a-9a91-8d91a6d341ab)
