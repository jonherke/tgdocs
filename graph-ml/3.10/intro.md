...
Page 1[Prev](https://docs.tigergraph.com/graph-ml/3.10/intro/)[Next](https://docs.tigergraph.com/graph-ml/3.10/intro/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/graph-ml/3.10/intro/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/graph-ml/3.10/intro/)
...
[Edit this Page](https://github.com/tigergraph/tigdsl-docs/edit/3.10/modules/intro/pages/index.adoc)
### Contents
  * [Get to know the Graph Data Science (GDS) Library](https://docs.tigergraph.com/graph-ml/3.10/intro/#_get_to_know_the_graph_data_science_gds_library)
  * [Release Branches](https://docs.tigergraph.com/graph-ml/3.10/intro/#_release_branches)
...
## [](https://docs.tigergraph.com/graph-ml/3.10/intro/#_get_to_know_the_graph_data_science_gds_library)Get to know the Graph Data Science (GDS) Library
![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/lang2.png) **Using a Algorithm** Information on how to use a TigerGraph Graph Data Science (GDS) Library algorithm. [Using an Algorithm |](https://docs.tigergraph.com/graph-ml/3.10/using-an-algorithm/) [Library Structure |](https://docs.tigergraph.com/graph-ml/3.10/intro/library-structure) [Algorithm Table](https://docs.tigergraph.com/graph-ml/3.10/intro/algorithm-table) | ![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/TG_Icon_Library-51.png) **Centrality Algorithms** [Centrality Algorithms](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/) find the important vertices in a graph based on their connections with other vertices.  
---|---  
![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/querying-homecard.png) **Classification Algorithms** [Classification Algorithms](https://docs.tigergraph.com/graph-ml/3.10/classification-algorithms/) label vertices to sort them into various defined classes. | ![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/Copy%20of%20TG_Icon_Library-218.png) **Community Algorithms** [Community Algorithms](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/) group together vertices or edges that satisfy some rule for being connected to one another.  
![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/TG_Icon_Library-166.png) **Node Embedding Algorithms** [Node Embeddings](https://docs.tigergraph.com/graph-ml/3.10/node-embeddings/) are vector representations of vertex properties in a graph. | ![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/TG_Icon_Library-146.png) **Pathfinding Algorithms** [Pathfinding Algorithms](https://docs.tigergraph.com/graph-ml/3.10/pathfinding-algorithms/) find the best path(s) among a set of vertices according to length or cost.  
![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/TG_Icon_Library-92.png) **Similarity Algorithms** [Similarity Algorithms](https://docs.tigergraph.com/graph-ml/3.10/similarity-algorithms/) assign a score to a pair of vertices based on how similar they are, usually by referring to their neighborhoods. | ![admin](https://docs.tigergraph.com/graph-ml/3.10/intro/_images/TG_Icon_Library-48.png) **Topological Link Prediction Algorithms** [Link Prediction](https://docs.tigergraph.com/graph-ml/3.10/link-prediction/) determine the closeness of a pair of vertices to make predictions about their relationships.  
...
### [](https://docs.tigergraph.com/graph-ml/3.10/intro/#_release_branches)Release Branches
