...
Page 1[Prev](https://docs.tigergraph.com/insights/4.1/intro/get-started)[Next](https://docs.tigergraph.com/insights/4.1/intro/get-started)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/insights/4.1/intro/get-started)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/insights/4.1/intro/get-started)
...
[Edit this Page](https://github.com/tigergraph/insights-docs/edit/4.1/modules/intro/pages/get-started.adoc)
### Contents
  * [Supported Browsers](https://docs.tigergraph.com/insights/4.1/intro/get-started#_supported_browsers)
  * [Limitations](https://docs.tigergraph.com/insights/4.1/intro/get-started#_limitations)
...
Launch TigerGraph Insights from the nine-dot TigerGraph Suite button ![nine dot button](https://docs.tigergraph.com/insights/4.1/intro/_images/nine-dot-button.png) in the GUI of any cloud or local TigerGraph instance.
![tools](https://docs.tigergraph.com/insights/4.1/intro/_images/tools.png)
From there, you can create [Applications](https://docs.tigergraph.com/insights/4.1/intro/applications) that display [Widgets](https://docs.tigergraph.com/insights/4.1/widgets/) for users to interact with.
## [](https://docs.tigergraph.com/insights/4.1/intro/get-started#_supported_browsers)Supported Browsers
...
## [](https://docs.tigergraph.com/insights/4.1/intro/get-started#_limitations)Limitations
