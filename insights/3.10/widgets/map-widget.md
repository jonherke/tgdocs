...
Page 1[Prev](https://docs.tigergraph.com/insights/3.10/widgets/map-widget)[Next](https://docs.tigergraph.com/insights/3.10/widgets/map-widget)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/insights/3.10/widgets/map-widget)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/insights/3.10/widgets/map-widget)
...
[Edit this Page](https://github.com/tigergraph/insights-docs/edit/3.10/modules/widgets/pages/map-widget.adoc)
### Contents
  * [Inputs](https://docs.tigergraph.com/insights/3.10/widgets/map-widget#_inputs)
  * [Widget window](https://docs.tigergraph.com/insights/3.10/widgets/map-widget#_widget_window)
...
## [](https://docs.tigergraph.com/insights/3.10/widgets/map-widget#_inputs)Inputs
Accepts data as vertices and edges.
## [](https://docs.tigergraph.com/insights/3.10/widgets/map-widget#_widget_window)Widget window
![map interface](https://docs.tigergraph.com/insights/3.10/widgets/_images/map-interface.png)
...
If there are other vertex attributes with different names that you would like to map to coordinates in the map viewer, you can change them in the **Data** section on the right side of the window.
Map widgets support [Conditional Styling](https://docs.tigergraph.com/insights/3.10/widgets/conditional-styling).
