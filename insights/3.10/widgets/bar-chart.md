...
Page 1[Prev](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart)[Next](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart)
...
[Edit this Page](https://github.com/tigergraph/insights-docs/edit/3.10/modules/widgets/pages/bar-chart.adoc)
### Contents
  * [Inputs](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_inputs)
  * [Widget window](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_widget_window)
  * [Sorting and grouping](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_sorting_and_grouping)
  * [Display options](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_display_options)
...
## [](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_inputs)Inputs
Accepts data as vertices and edges for a pattern search result. For a GSQL query result, accepts a list of objects that contain at least one numeric attribute to be used as the height of the bar.
## [](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_widget_window)Widget window
![bar chart interface](https://docs.tigergraph.com/insights/3.10/widgets/_images/bar-chart-interface.png)
### [](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_sorting_and_grouping)Sorting and grouping
...
### [](https://docs.tigergraph.com/insights/3.10/widgets/bar-chart#_display_options)Display options
