...
Page 1[Prev](https://docs.tigergraph.com/insights/3.11/widgets/map-widget)[Next](https://docs.tigergraph.com/insights/3.11/widgets/map-widget)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/insights/3.11/widgets/map-widget)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/insights/3.11/widgets/map-widget)
...
[Edit this Page](https://github.com/tigergraph/insights-docs/edit/3.11/modules/widgets/pages/map-widget.adoc)
### Contents
  * [Inputs](https://docs.tigergraph.com/insights/3.11/widgets/map-widget#_inputs)
  * [Widget window](https://docs.tigergraph.com/insights/3.11/widgets/map-widget#_widget_window)
...
## [](https://docs.tigergraph.com/insights/3.11/widgets/map-widget#_inputs)Inputs
Accepts data as vertices and edges.
## [](https://docs.tigergraph.com/insights/3.11/widgets/map-widget#_widget_window)Widget window
![map interface](https://docs.tigergraph.com/insights/3.11/widgets/_images/map-interface.png)
...
Map widgets support [Conditional Styling](https://docs.tigergraph.com/insights/3.11/widgets/conditional-styling).
