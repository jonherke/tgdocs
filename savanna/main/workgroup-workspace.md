...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/workgroup-workspace/)[Next](https://docs.tigergraph.com/savanna/main/workgroup-workspace/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/workgroup-workspace/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/workgroup-workspace/)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/workgroup-workspace/pages/index.adoc)
### Contents
  * [Workgroup Overview](https://docs.tigergraph.com/savanna/main/workgroup-workspace/#_workgroup_overview)
  * [Workspace and Database Overview](https://docs.tigergraph.com/savanna/main/workgroup-workspace/#_workspace_and_database_overview)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/workgroup-workspace/#_next_steps)
...
In TigerGraph Savanna, the concepts of workgroup, workspace, and database are used to organize and manage projects and data within the platform. By utilizing [workgroups](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/workgroup), [workspaces and databases](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace), TigerGraph Savanna provides a flexible and scalable environment for managing projects, allocating compute resources, and working with graph data effectively.
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/#_workgroup_overview)[Workgroup Overview](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/workgroup)
Learn [How to Create a Workgroup](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup) the first step before creating a [Workspace](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace) and learning [How to Manage Workgroup and Workspace Permissions](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-workgroup-access).
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/#_workspace_and_database_overview)[Workspace and Database Overview](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace)
Learn [How to Create a Workspace](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace) and unlock its many features.
Such as:
  * [Workspace Settings](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/settings) - Learn how advanced settings in workspace allow users to customize and fine tune various aspects of their workspace configuration.
  * [Read/Write and Read Only Workspaces](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/readwrite-readonly) - Learn how Read-Write (RW) and Read-Only (RO) Workspaces will connect to a database.
  * [Workspace Size](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size) - Learn how to specify the size based on your data and performance requirements.
  * [Expansion and Shrink](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/expansion-shrink) - Learn how to adjust the capacity of your workspaces as your data grows or changes.
  * [Backup and Restore](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/backup-and-restore) - Learn how to create backup points and restore your workspace to a specific point in time.
  * [Connect via APIs](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/connect-via-api) - Learn how to connect to your graph database using REST APIs.
  * [Monitor Workspaces](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces) - Learn how TigerGraph Savanna offers comprehensive monitoring capabilities that allow you to track the status and resource usage of your workspaces.


## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/#_next_steps)Next Steps
Next, learn how to [Load Data](https://docs.tigergraph.com/savanna/main/graph-development/load-data/) into TigerGraph Savanna.
