...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/administration/security/password-policy)[Next](https://docs.tigergraph.com/savanna/main/administration/security/password-policy)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/administration/security/password-policy)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/administration/security/password-policy)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/administration/pages/security/password-policy.adoc)
# Password Policy
TigerGraph Savanna user accounts have their own password requirements separate from the [TigerGraph Server password policy](https://docs.tigergraph.com/tigergraph-server/4.2/security/password-policy).
...
---  
Organization Admins do not have access to change or reset user passwords in an Organization account. If you forget your password, click the **Forgot Password?** button during login, or contact support@tigergraph.com for assistance.
