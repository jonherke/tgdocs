...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/administration/settings/)[Next](https://docs.tigergraph.com/savanna/main/administration/settings/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/administration/settings/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/administration/settings/)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/administration/pages/settings/index.adoc)
### Contents
  * [Organization Management](https://docs.tigergraph.com/savanna/main/administration/settings/#_organization_management)
  * [API Keys](https://docs.tigergraph.com/savanna/main/administration/settings/#_api_keys)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/administration/settings/#_next_steps)
...
## [](https://docs.tigergraph.com/savanna/main/administration/settings/#_organization_management)[Organization Management](https://docs.tigergraph.com/savanna/main/administration/settings/how2-use-organization-mgnt)
Learn about the organization management features that allow you to configure organization settings.
## [](https://docs.tigergraph.com/savanna/main/administration/settings/#_api_keys)[API Keys](https://docs.tigergraph.com/savanna/main/administration/settings/how2-create-api-key)
Learn how to create API keys for your organization.
## [](https://docs.tigergraph.com/savanna/main/administration/settings/#_next_steps)Next Steps
