...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup)[Next](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/workgroup-workspace/pages/workgroups/how2-create-a-workgroup.adoc)
### Contents
  * [Create a Workgroup](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup#_create_a_workgroup)
  * [Next Step](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup#_next_step)
...
To learn more about workgroups see [Workgroup Overview](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/workgroup). To create a workgroup in TigerGraph Savanna, follow the steps below.
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup#_create_a_workgroup)Create a Workgroup
...
![landing page](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/landing-page.png)
  3. Alternatively, from the dashboard, navigate to the **Workgroups** section and click on the **Create Workgroup** or you can click on the ![plusbutton](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/plusbutton.png) button next to **Workgroups**.
![no workgroup](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/no-workgroup.png)
  4. Provide a name for the workgroup.
Choose a name that reflects the purpose of your project or initiative.  
---  
![create workgroup](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/create-workgroup.png)
  5. Choose the cloud provider and the region
TigerGraph Savanna currently only operates on [Amazon Web Services (AWS)](https://docs.tigergraph.com/savanna/main/resources/aws). We are actively working on expanding to [Google Cloud Platform (GCP)](https://docs.tigergraph.com/savanna/main/resources/gcp) and [Microsoft Azure](https://docs.tigergraph.com/savanna/main/resources/azure). Visit each platform’s reference page to learn more about the available regions.  
---  
  6. Finally, click on the **Next** button to create the workgroup.


## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/how2-create-a-workgroup#_next_step)Next Step
