...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces)[Next](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/workgroup-workspace/pages/workgroups/monitor-workspaces.adoc)
### Contents
  * [How to Start Monitoring](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces#_how_to_start_monitoring)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces#_next_steps)
...
Monitoring the performance and health of your workspaces is essential for efficient operations. TigerGraph Savanna offers comprehensive monitoring capabilities that allow you to track the status and resource usage of your workspaces. You can monitor metrics such as CPU utilization, memory usage, and storage consumption, enabling you to optimize performance, identify bottlenecks, and ensure the smooth operation of TigerGraph databases using a Grafana dashboard.
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces#_how_to_start_monitoring)How to Start Monitoring
To start monitoring, follow these steps:
  1. Go to the `Monitor` tab on your workgroup dashboard.
![tabs](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/tabs.png)
  2. Alternatively, go to the workspace **…​** menu.
![Screenshot 2024 04 30 at 10.25.29 AM](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/Screenshot%202024-04-30%20at%2010.25.29 AM.png)
  3. Click the ![Screenshot 2024 04 17 at 5.45.39 PM](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/Screenshot%202024-04-17%20at%205.45.39 PM.png) button from the workspace menu to go to the **Monitor** tab and display the Grafana dashboard of your workspace.
![workspace monitor tab](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspace-monitor-tab.png)


## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workgroups/monitor-workspaces#_next_steps)Next Steps
