...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace)[Next](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/workgroup-workspace/pages/workspaces/how2-create-a-workspace.adoc)
### Contents
  * [Create a Workspace](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace#_create_a_workspace)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace#_next_steps)
...
To learn more about workspaces see [Workspace Overview](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace). To create a workspace in TigerGraph Savanna follow the steps below:
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace#_create_a_workspace)Create a Workspace
  1. Log in to your TigerGraph Savanna account.
![login](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/login.png)
  2. From the dashboard, navigate to the **Workgroups** section Click on the **Create Workspace** button.
![workspacecreate](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspacecreate.png)
  3. Provide a name for the workspace.
Choose a name that reflects the purpose of your workspace.  
---  
![workspaceinfo](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspaceinfo.png)
  4. Select a TigerGraph workspace runtime.
  5. Specify workspace size and advanced settings.
![workspaceDetails](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspaceDetails.png)
  6. For supported workspace sizes, please go to the [Workspace Size](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size) page.
  7. For advanced settings please refer to [Workspace Settings](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/settings) page.
  8. Specify database name or attach to an existing database.
    1. This allows you to create Read-Write (RW) workspace or Read-Only (RO) workspace. For more details, please refer to [Read/Write and Read Only Workspaces](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/readwrite-readonly).
  9. Specify Solutions for your workspace, for more details please visit [Solutions](https://docs.tigergraph.com/savanna/main/integrations/solutions) page.
![solution add on](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/solution-add-on.png)
  10. Specify Add-ons to your workspace, for more details please visit [Add-Ons](https://docs.tigergraph.com/savanna/main/integrations/add-ons) page.
![Add onsimage](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/Add-onsimage.png)
  11. Click on the **Create** button to create the workspace.
Currently, only one Read-Write workspace can be created for any given database. This means that multiple simultaneous Read-Write workspaces cannot be created, potentially limiting certain collaborative or concurrent development scenarios.  
---  
Users cannot re-create the Read-Write workspace once it has been terminated.  
---  
  12. The workspace will then start to build. This progress can be monitored on the **General Tab**.
![workspace general tab](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspace-general-tab.png)
  13. Once built you can view details about your workspace on the workspace tab. And you can view information about your database on the database tab.
![workspace info tab](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspace-info-tab.png)
![workspace database tab](https://docs.tigergraph.com/savanna/main/workgroup-workspace/_images/workspace-database-tab.png)


## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/how2-create-a-workspace#_next_steps)Next Steps
Now, that you have a workspace created see [Workspace Settings](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/settings) or learn more about [Read/Write and Read Only Workspaces](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/readwrite-readonly).
