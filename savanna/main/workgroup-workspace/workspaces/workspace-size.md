...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size)[Next](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/workgroup-workspace/pages/workspaces/workspace-size.adoc)
### Contents
  * [Workspace Size Table](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size#_workspace_size_table)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size#_next_steps)
...
When creating a workspace, you can specify the size based on your data and performance requirements. TigerGraph Savanna offers multiple size options, allowing you to choose the appropriate capacity for your graph databases.
The size determines the number of instances and the allocated resources for your workspace.   
---  
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size#_workspace_size_table)Workspace Size Table
...
## [](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/workspace-size#_next_steps)Next Steps
See [Expansion and Shrink](https://docs.tigergraph.com/savanna/main/workgroup-workspace/workspaces/expansion-shrink) to learn how to change the size of a workspace or return to the [Workgroups and Workspaces](https://docs.tigergraph.com/savanna/main/workgroup-workspace/) page or [Overview](https://docs.tigergraph.com/savanna/main/overview/) page for a different topic.
Or visit [Pricing](https://docs.tigergraph.com/savanna/main/overview/pricing) and [Cost Estimation](https://docs.tigergraph.com/savanna/main/overview/cost-estimation) for detailed information on the costs associated with different workspace sizes.
