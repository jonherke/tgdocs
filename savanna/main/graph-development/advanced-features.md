...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/)[Next](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/graph-development/pages/advanced-features/index.adoc)
### Contents
  * [Write Output to S3](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/#_write_output_to_s3)
  * [Configure User Defined Functions (UDF)](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/#_configure_user_defined_functions_udf)
...
## [](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/#_write_output_to_s3)Write Output to S3
TigerGraph Savanna enables you to write data directly to Amazon S3, providing a seamless way to export and store your graph data in a scalable and cost-effective manner. Click [Export Data to S3](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/write2-s3) to learn how to configure and use this feature.
## [](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/#_configure_user_defined_functions_udf)Configure User Defined Functions (UDF)
User-Defined Functions (UDFs) are a powerful way to extend TigerGraph’s capabilities by adding custom logic to your graph queries. This guide will walk you through the process of updating existing UDFs. Click [Configure UDF](https://docs.tigergraph.com/savanna/main/graph-development/advanced-features/configure-udf) to get started.
