...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function)[Next](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/graph-development/pages/load-data/token-function.adoc)
### Contents
  * [Add a token function](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function#_add_a_token_function)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function#_next_steps)
...
TigerGraph Savanna allows you to enhance your data loading process by adding token functions. Token functions enable you to manipulate and transform data during the loading process, making it easier to prepare your data for graph analysis. This guide will walk you through the steps to add token functions using the TigerGraph Savanna UI. For more details please refer to [Token Functions](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token/).
## [](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function#_add_a_token_function)Add a token function
  1. Click on the **Token Function** button to configure token functions for your data source.
![config mapping 2](https://docs.tigergraph.com/savanna/main/graph-development/_images/config-mapping-2.png)
  2. Click on the **+** button to create a new token function, or select one from the list to edit.
![token function 1](https://docs.tigergraph.com/savanna/main/graph-development/_images/token-function-1.png)
  3. Select the token function you want to use from the `Type` dropdown menu. This will automatically populate the output data type and the required parameters. You can also check the sample input and output by hovering over the **?** icon. Please refer to the [Token Functions](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token/) documentation for more details.
![token function 3](https://docs.tigergraph.com/savanna/main/graph-development/_images/token-function-3.png)
  4. Configure the parameters in the **Parameters** section of the window. You can click on the **+** button to add more data columns from the source file.
![token function 2](https://docs.tigergraph.com/savanna/main/graph-development/_images/token-function-2.png)
  5. Click on the **Save** button to save the token function.
  6. Select the token function you just created in the source column to map to the target attribute.
![token function 4](https://docs.tigergraph.com/savanna/main/graph-development/_images/token-function-4.png)
...
## [](https://docs.tigergraph.com/savanna/main/graph-development/load-data/token-function#_next_steps)Next Steps
Next, learn more about how to [Load Data in TigerGraph Savanna](https://docs.tigergraph.com/savanna/main/graph-development/load-data/).
