...
Page 1[Prev](https://docs.tigergraph.com/savanna/main/overview/comparison_table)[Next](https://docs.tigergraph.com/savanna/main/overview/comparison_table)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/savanna/main/overview/comparison_table)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/savanna/main/overview/comparison_table)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/savanna/modules/overview/pages/comparison_table.adoc)
### Contents
  * [Architecture and Deployment](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_architecture_and_deployment)
  * [Features and Capabilities](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_features_and_capabilities)
  * [Security and Management](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_security_and_management)
  * [Next Steps](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_next_steps)
...
Most of the documentation for TigerGraph Enterprise Server also applies to TigerGraph Savanna. Here are some differences between the different TigerGraph offerings.
## [](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_architecture_and_deployment)Architecture and Deployment
...
Installation and Configuration | Yes | Easy steps to install Starter Kit See the [TigerGraph Cloud Classic FAQs](https://docs.tigergraph.com/cloud/main/support/faqs) | Users can install solutions anytime  
...
## [](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_features_and_capabilities)Features and Capabilities
Topic | TigerGraph Enterprise Server | TigerGraph Cloud Classic | TigerGraph Savanna  
---|---|---|---  
...
## [](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_security_and_management)Security and Management
Topic | TigerGraph Enterprise Server | TigerGraph Cloud Classic | TigerGraph Savanna  
---|---|---|---  
...
## [](https://docs.tigergraph.com/savanna/main/overview/comparison_table#_next_steps)Next Steps
Next, see [Get Started with TigerGraph Savanna](https://docs.tigergraph.com/savanna/main/get-started/) to unlock its full potential.
