...
Page 1[Prev](https://docs.tigergraph.com/ml-workbench/1.4/faq/reference)[Next](https://docs.tigergraph.com/ml-workbench/1.4/faq/reference)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/ml-workbench/1.4/faq/reference)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/ml-workbench/1.4/faq/reference)
...
[Edit this Page](https://github.com/tigergraph/mlworkbench-docs/edit/1.4/modules/faq/pages/reference.adoc)
# pyTigerGraph GDS Module
The centerpiece of the ML Workbench is its Python client: [pyTigerGraph](https://docs.tigergraph.com/pytigergraph/1.8/intro/).
...
Please refer to the [GDS Functions](https://docs.tigergraph.com/pytigergraph/1.8/gds/) section of the pyTigerGraph documentation to learn more about the submodules, classes, and methods, and to see working examples and code snippets.
