...
Page 1[Prev](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone)[Next](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone)
...
[Edit this Page](https://github.com/tigergraph/mlworkbench-docs/edit/1.4/modules/on-prem/pages/standalone.adoc)
### Contents
  * [Docker image](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone#_docker_image)
  * [Next steps](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone#_next_steps)
...
## [](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone#_docker_image)Docker image
...
---  
## [](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/standalone#_next_steps)Next steps
After installation, the next step is to [Activate ML Workbench](https://docs.tigergraph.com/ml-workbench/1.4/on-prem/activate).
You can then go to our [Tutorials and Sample Data](https://docs.tigergraph.com/ml-workbench/1.4/tutorials/) section. Follow the instructions, use our tutorials and download our latest notebook examples and data sets there to practice using the ML Workbench.
