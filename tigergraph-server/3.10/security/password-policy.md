...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Password Policy](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy)


[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/security/pages/password-policy.adoc)
### Contents
  * [Password policy requirements](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy#_password_policy_requirements)
  * [Enable password policy](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy#_enable_password_policy)
...
You can enable a password policy to mandate the minimal required complexity of all [user passwords](https://docs.tigergraph.com/tigergraph-server/3.10/user-access/user-credentials#_passwords) or [ACL passwords](https://docs.tigergraph.com/tigergraph-server/3.10/user-access/access-control-model#_acl_password).
Regardless of whether the password policy is enabled, no password can be an empty string or null.   
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy#_password_policy_requirements)Password policy requirements
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/security/password-policy#_enable_password_policy)Enable password policy
