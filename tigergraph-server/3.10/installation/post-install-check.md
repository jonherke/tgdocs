...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/installation/pages/post-install-check.adoc)
### Contents
  * [Check SSH connectivity between the TigerGraph nodes](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_check_ssh_connectivity_between_the_tigergraph_nodes)
  * [Port check](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_port_check)
  * [For services port check](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_for_services_port_check)
...
After switching to the correct user, you now have access to [`gadmin` commands](https://docs.tigergraph.com/tigergraph-server/3.10/system-management/management-with-gadmin). Confirm successful installation by running `gadmin status`. If the system is installed correctly and the license is activated, the command should report that all services are up and ready.
```
$ gadmin status
+--------------------+-------------------------+-------------------------+
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_check_ssh_connectivity_between_the_tigergraph_nodes)Check SSH connectivity between the TigerGraph nodes
...
If this check fails, then you need to address it. Feel free to reach out to our Technical Support Team by opening a [support ticket](https://tigergraph.zendesk.com/hc/en-us/) to request assistance.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_port_check)Port check
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_for_services_port_check)For services port check
```
#!/bin/bash
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_usage)Usage
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_dynamic_port_check)Dynamic port check
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/installation/post-install-check#_usage_2)Usage
...
Any unsuccessful connection attempt **must** be addressed. Feel free to reach out to our Technical Support Team by opening a [support ticket](https://tigergraph.zendesk.com/hc/en-us/) to request assistance.   
---  
