...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/installation/change-port)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/installation/change-port)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/installation/change-port)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/installation/change-port)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/installation/pages/change-port.adoc)
# Changing Ports
