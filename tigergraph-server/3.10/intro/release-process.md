...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/intro/pages/release-process.adoc)
### Contents
  * [Versions and Support](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_versions_and_support)
  * [LTS Version](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_lts_version)
  * [Preview Version](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_preview_version)
  * [Release Numbering and Terminology](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_release_numbering_and_terminology)
  * [Version vs. Release](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_version_vs_release)
  * [Release Numbering](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_release_numbering)
  * [Deliverables](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_deliverables)
  * [Feature Release](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_feature_release)
  * [Maintenance Release](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_maintenance_release)
  * [One-Off patches](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_one_off_patches)
  * [Support](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_support)
  * [Managed Service](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_managed_service)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_versions_and_support)Versions and Support
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_lts_version)LTS Version
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_preview_version)Preview Version
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_release_numbering_and_terminology)Release Numbering and Terminology
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_version_vs_release)Version vs. Release
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_release_numbering)Release Numbering
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_deliverables)Deliverables
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_feature_release)Feature Release
A feature release is a planned product roadmap event. In addition to the software, the following documentation deliverables accompany the release:
  * [TigerGraph DB Release Notes](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/) section included in the TigerGraph online documentation.
  * [Upgrade](https://docs.tigergraph.com/tigergraph-server/3.10/installation/upgrade) section included in the TigerGraph online documentation.
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_maintenance_release)Maintenance Release
...
**Upgrade Support:** Users should refer to the [Upgrade](https://docs.tigergraph.com/tigergraph-server/3.10/installation/upgrade) section of the documentation. Depending on the urgency of the patch, our Customer Success team may reach out to customers to discuss upgrading.
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_one_off_patches)One-Off patches
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_support)Support
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/release-process#_managed_service)Managed Service
