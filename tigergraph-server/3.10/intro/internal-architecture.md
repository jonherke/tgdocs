...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/intro/internal-architecture)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/intro/internal-architecture)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/intro/internal-architecture)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/intro/internal-architecture)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/intro/pages/internal-architecture.adoc)
### Contents
  * [System Overview](https://docs.tigergraph.com/tigergraph-server/3.10/intro/internal-architecture#_system_overview)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/intro/internal-architecture#_system_overview)System Overview
...
![Visualization of the TigerGraph Analytics Platform linked to data sources with the ETL loader and an Enterprise Data Structure with an API stream.](https://docs.tigergraph.com/tigergraph-server/3.10/intro/_images/2.1.png)
The figure below takes a closer look at the TigerGraph platform itself:
![Diagram of the TigerGraph platform showing how users pass messages to the RESTPP server via various methods, which then reach the TigerGraph services with a message queuing system.](https://docs.tigergraph.com/tigergraph-server/3.10/intro/_images/tigergraph-system-block-diagram%20\(2\)%20\(2\).png)
