...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Load from <data type>](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template)


[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/data-loading/pages/load-template.adoc)
### Contents
  * [Example Schema](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_example_schema)
  * [Create Data Source Object](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_create_data_source_object)
  * [Create a loading job](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_create_a_loading_job)
  * [Define filenames](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_define_filenames)
  * [Specify the data mapping](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_specify_the_data_mapping)
  * [Run the loading job](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_run_the_loading_job)
  * [Manage and monitor your loading job](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_manage_and_monitor_your_loading_job)
  * [Manage loading job concurrency](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_manage_loading_job_concurrency)
  * [Known Issues with Loading](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_known_issues_with_loading)
...
Table of Contents
  * [Example Schema](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_example_schema)
  * [Create Data Source Object](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_create_data_source_object)
    * [String Literals](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_string_literals)
  * [Create a loading job](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_create_a_loading_job)
    * [Define filenames](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_define_filenames)
    * [Specify the data mapping](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_specify_the_data_mapping)
  * [Run the loading job](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_run_the_loading_job)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_example_schema)Example Schema
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_create_data_source_object)Create Data Source Object
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_string_literals)String Literals
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_create_a_loading_job)Create a loading job
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_define_filenames)Define filenames
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_specify_the_data_mapping)Specify the data mapping
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_run_the_loading_job)Run the loading job
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_manage_and_monitor_your_loading_job)Manage and monitor your loading job
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_manage_loading_job_concurrency)Manage loading job concurrency
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/data-loading/load-template#_known_issues_with_loading)Known Issues with Loading
