...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/gsql-shell/pages/index.adoc)
### Contents
  * [Launch the shell](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_launch_the_shell)
  * [Change scope](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_change_scope)
  * [Multi-line commands](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_multi_line_commands)
  * [Example](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_example)
  * [Run GSQL scripts and in-line commands](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_run_gsql_scripts_and_in_line_commands)
...
To learn more about the GSQL language, follow our tutorial series starting with [GSQL 101](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/).
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_launch_the_shell)Launch the shell
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_change_scope)Change scope
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_multi_line_commands)Multi-line commands
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_example)Example
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/#_run_gsql_scripts_and_in_line_commands)Run GSQL scripts and in-line commands
