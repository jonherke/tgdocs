...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/troubleshooting/pages/log-files.adoc)
### Contents
  * [TigerGraph log structure](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_tigergraph_log_structure)
  * [Log locations on a cluster](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_log_locations_on_a_cluster)
  * [Open source TigerGraph components](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_open_source_tigergraph_components)
  * [Log rotation](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_log_rotation)
...
The TigerGraph database captures key information on activities occurring across its different components through log functions that output to log files. These log files are not only helpful in [troubleshooting](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/troubleshooting-guide) but also serve as a resource for auditing. Logs may contain sensitive information, so direct access is restricted.
This page provides a general overview of the way log files are stored in TigerGraph.
[Audit logs](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/audit-log) are structured in JSON, ensuring machine-readability and facilitating easy integration with third-party tools. The TigerGraph Linux server admin user may also use the [gcollect](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/gcollect) utility to search for and gather selected information from the logs. We also provide instructions on how to [set up log viewing with Elasticsearch, Kibana, or Filebeat](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/elk-filebeat).
## [](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_tigergraph_log_structure)TigerGraph log structure
...
All services do not create a `log.DEBUG` file by default. To change this, modify the parameter `<service>.BasicConfig.LogConfig.LogLevel`. For example, `GSQL.BasicConfig.LogConfig.LogLevel`. See [Configuration Parameters](https://docs.tigergraph.com/tigergraph-server/3.10/reference/configuration-parameters) for more information.   
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_log_locations_on_a_cluster)Log locations on a cluster
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_open_source_tigergraph_components)Open source TigerGraph components
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/troubleshooting/log-files#_log_rotation)Log rotation
