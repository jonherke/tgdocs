...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/getting-started/pages/index.adoc)
### Contents
  * [Get Started with Docker](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_get_started_with_docker)
  * [Getting started on Kubernetes](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_getting_started_on_kubernetes)
  * [Get Started on Linux](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_get_started_on_linux)
  * [Get Started from a Cloud Marketplace](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_get_started_from_a_cloud_marketplace)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_get_started_with_docker)[Get Started with Docker](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/docker)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_getting_started_on_kubernetes)[Getting started on Kubernetes](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/kubernetes)
Deploy a TigerGraph cluster on GKE, EKS, AKS, or OpenShift using the TigerGraph Operator.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_get_started_on_linux)[Get Started on Linux](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/linux)
If you have a Linux machine that meets our [Hardware and Software Requirements](https://docs.tigergraph.com/tigergraph-server/3.10/installation/hw-and-sw-requirements), you can install TigerGraph on your machine directly.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/#_get_started_from_a_cloud_marketplace)[Get Started from a Cloud Marketplace](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/)
