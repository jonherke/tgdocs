...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/gsql-shell/pages/web.adoc)
### Contents
  * [Supported browsers](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_supported_browsers)
  * [Access GSQL shell via browser](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_access_gsql_shell_via_browser)
  * [Run GSQL commands](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_run_gsql_commands)
  * [View results](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_view_results)
  * [View command history](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_view_command_history)
  * [Editor keyboard shortcuts](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_editor_keyboard_shortcuts)
  * [Limitations](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_limitations)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_supported_browsers)Supported browsers
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_access_gsql_shell_via_browser)Access GSQL shell via browser
...
For example, if your instance is on `localhost`, visit http://localhost:14240, log in if [authentication is enabled](https://docs.tigergraph.com/tigergraph-server/3.10/user-access/enabling-user-authentication), and select **GSQL Shell**.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_run_gsql_commands)Run GSQL commands
...
### [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_view_results)View results
The results of each command show up in the results panel right above the GSQL editor.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_view_command_history)View command history
You can view a history of the commands that were executed in your session on the left pane of the GSQL web shell.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_editor_keyboard_shortcuts)Editor keyboard shortcuts
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/gsql-shell/web#_limitations)Limitations
