...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/reference/glossary)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/reference/glossary)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/reference/glossary)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/reference/glossary)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/reference/pages/glossary.adoc)
# Glossary
Name | Refers to  
---|---  
...
**TS3** | TigerGraph System Service State (TS3) is a TigerGraph sub-system which helps monitor the TigerGraph system. It serves as the backend to the TigerGraph Admin Portal.  
