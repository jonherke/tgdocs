...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/cluster-and-ha-management/pages/ha-overview.adoc)
### Contents
  * [HA Considerations](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_ha_considerations)
  * [3.9.2 and Below](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_3_9_2_and_below)
  * [High Availability Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_high_availability_cluster_configuration)
  * [High Availability Support for GSQL Server](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_high_availability_support_for_gsql_server)
  * [High Availability Support for Application Server](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_high_availability_support_for_application_server)
  * [Cluster Commands](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_cluster_commands)
  * [Removal of Failed Nodes](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_removal_of_failed_nodes)
  * [File and Kafka loaders HA with Auto-Restart](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_file_and_kafka_loaders_ha_with_auto_restart)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_ha_considerations)HA Considerations
...
---  
### [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_3_9_2_and_below)3.9.2 and Below
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_high_availability_cluster_configuration)[High Availability Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-cluster)
Here you will find detailed information about terminology, system requirements, and how to configure an HA cluster.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_high_availability_support_for_gsql_server)[High Availability Support for GSQL Server](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-for-gsql-server)
Learn how TigerGraph incorporates built-in HA for all the internal critical components.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_high_availability_support_for_application_server)[High Availability Support for Application Server](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-for-application-server)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_cluster_commands)[Cluster Commands](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/cluster-commands)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_removal_of_failed_nodes)[Removal of Failed Nodes](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/remove-failed-node)
Here you find detailed Instructions for the removal of a failed node.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/cluster-and-ha-management/ha-overview#_file_and_kafka_loaders_ha_with_auto_restart)File and Kafka loaders HA with Auto-Restart
