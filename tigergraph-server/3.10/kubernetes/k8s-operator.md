...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/kubernetes/pages/k8s-operator/index.adoc)
### Contents
  * [Getting started](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/#_getting_started)
  * [Supported cloud platforms](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/#_supported_cloud_platforms)
...
We have provided a public [GitHub Repo](https://github.com/tigergraph/ecosys/tree/master/k8s) to our preview documentation of the Kubernetes Operator. These docs are frequently updated to support operation, troubleshooting, and all other relevant use cases.   
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/#_getting_started)Getting started
To get started go to our [Get Started](https://github.com/tigergraph/ecosys/blob/master/k8s/docs/02-get-started/get_started.md) GitHub page where you will install the Operator and provision your first cluster using the Operator.
## [](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/#_supported_cloud_platforms)Supported cloud platforms
The TigerGraph Kubernetes Operator is platform-agnostic. You should be able to use the Operator on any cloud platform that provides a Kubernetes service. TigerGraph has verified the full functionality of the operator on the Kubernetes services of the following platform:
  * [Google Kubernetes Engine (GKE)](https://github.com/tigergraph/ecosys/blob/master/k8s/docs/03-deploy/tigergraph-on-gke.md)
  * [Red Hat OpenShift](https://github.com/tigergraph/ecosys/blob/master/k8s/docs/03-deploy/tigergraph-on-openshift.md)
  * [AWS Elastic Kubernetes Service (EKS)](https://github.com/tigergraph/ecosys/blob/master/k8s/docs/03-deploy/tigergraph-on-eks.md)
  * [Azure Kubernetes Service (AKS)](https://github.com/tigergraph/ecosys/blob/master/k8s/docs/03-deploy/tigergraph-on-aks.md)


Additionally, TigerGraph Kubernetes Operator can be installed and deployed without internet access
  * [Install and Deploy without internet access](https://github.com/tigergraph/ecosys/blob/master/k8s/docs/03-deploy/deploy-without-internet.md)
