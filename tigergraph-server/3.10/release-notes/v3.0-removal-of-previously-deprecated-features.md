...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/release-notes/pages/v3.0-removal-of-previously-deprecated-features.adoc)
### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_v3_0_removal_of_previously_deprecated_features)V3.0 Removal of Previously Deprecated Features
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_data_types)Data Types
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_syntax_for_control_flow_statements)Syntax for Control Flow Statements
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_vertex_set_variable_declaration)Vertex set variable declaration
See [Vertex Set Variable Declaration and Assignment](https://docs.tigergraph.com/gsql-ref/3.10/querying/declaration-and-assignment-statements#_vertex_set_variables)
If a vertex type is specified, the vertex type must be within parentheses.
Deprecated Statement | Alternate Statement  
---|---  
`MySet Person = …​` | `MySet (Person) = …​`  
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_query_job_and_token_management)Query, Job, and Token Management
...
`CREATE / SHOW/ REFRESH TOKEN` | To create a token, use the [REST endpoint GET /requesttoken](https://docs.tigergraph.com/tigergraph-server/3.10/API/built-in-endpoints#_request_a_token).  
`offline2online` | The offline loading job mode was discontinued in v2.0. Do not write loading jobs using this syntax.  
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_output)Output
See [PRINT Statement](https://docs.tigergraph.com/gsql-ref/3.10/querying/output-statements-and-file-objects#_print_statement_api_v2)
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.10/release-notes/v3.0-removal-of-previously-deprecated-features#_built_in_queries)Built-in Queries
Deprecated statement | Alternate statement  
---|---  
`SELECT count() FROM …​` | 
