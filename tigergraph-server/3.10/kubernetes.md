...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/kubernetes/pages/index.adoc)
### Contents
  * [Kubernetes Classic (Deprecated)](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/#_kubernetes_classic_deprecated)
...
The [Kubernetes Operator](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/k8s-operator/) provides two main benefits over Kubernetes Classic:
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/kubernetes/#_kubernetes_classic_deprecated)Kubernetes Classic (Deprecated)
