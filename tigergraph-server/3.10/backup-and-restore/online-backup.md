...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/backup-and-restore/pages/online-backup.adoc)
### Contents
  * [Introduction](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_introduction)
  * [Key Benefits](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_key_benefits)
  * [Benchmark Insights](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_benchmark_insights)
  * [Limitations and Considerations](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_limitations_and_considerations)
...
The introduction of Online Backup in version 3.10.0 is designed to operate seamlessly. This feature maintains the same [Backup and Restore Configurations](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/configurations) as before.
Online Backup is automatic, always active, and immutable in TigerGraph 3.10.x. Users cannot disable this feature.  
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_introduction)Introduction
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_key_benefits)Key Benefits
...
In the past, this could lead to blocking write operations, causing timeouts and preventing users from upserting data. With online backup in place, users can seamlessly execute post requests via the [REST API](https://docs.tigergraph.com/tigergraph-server/4.2/API/) during the backup process. This means that even as critical operations continue, the database is concurrently backed up, ensuring continuous data availability and preventing the inability to [upsert data to the database](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest).
Summary of key benefits:
  * Significant reduction in blocking time (See [Benchmark Insights](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_benchmark_insights)) for clusters, particularly in post request handling.
  * Uninterrupted data operations.


## [](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_benchmark_insights)Benchmark Insights
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/backup-and-restore/online-backup#_limitations_and_considerations)Limitations and Considerations
