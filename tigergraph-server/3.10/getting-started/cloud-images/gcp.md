...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/getting-started/pages/cloud-images/gcp.adoc)
### Contents
  * [Deploying Your Instance](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp#_deploying_your_instance)
  * [Starting TigerGraph on Your Instance](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp#_starting_tigergraph_on_your_instance)
  * [TigerGraph License on Google Cloud Images](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp#_tigergraph_license_on_google_cloud_images)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp#_deploying_your_instance)Deploying Your Instance
  ...
  3. Review the default settings and see if they fit your needs. When ready, click **Deploy**.
     ...
     * You must allow internet traffic for TCP port 14240 if you want to access GraphStudio. For more about GraphStudio, see the [GraphStudio UI Guide](https://docs.tigergraph.com/gui/3.10/graphstudio/overview).
...
![deploy form](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/deploy-form.png)
  4. That’s it! The TigerGraph instance has been successfully deployed on Google Cloud.
![deploy page](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/deploy-page.png)


## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp#_starting_tigergraph_on_your_instance)Starting TigerGraph on Your Instance
...
![gadmin status \(3\)](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-status%20\(3\).png)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/gcp#_tigergraph_license_on_google_cloud_images)TigerGraph License on Google Cloud Images
...
![gadmin license status \(4\)](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-license-status%20\(4\).png)
