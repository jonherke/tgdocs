...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws)[Next](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.10/modules/getting-started/pages/cloud-images/aws.adoc)
### Contents
  * [Deploying Your Instance](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws#_deploying_your_instance)
  * [Starting TigerGraph on Your Instance](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws#_starting_tigergraph_on_your_instance)
  * [TigerGraph License on AWS Images](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws#_tigergraph_license_on_aws_images)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws#_deploying_your_instance)**Deploying Your Instance**
  1. Go to [AWS Marketplace](https://aws.amazon.com/marketplace/) and search for TigerGraph.
  2. Click "Continue to Subscribe".
![Subscribe Page](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/subscribe-page%20\(1\).png)
  3. Click on "Continue to Configuration".
![Pre Configuration Page](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/go-to-config-page%20\(1\).png)
...
![Configuration Page](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/configuration-page%20\(1\).png)
...
---  
The security group must allow inbound TCP traffic to port 14240 if you want to access GraphStudio (TigerGraph’s visualization platform). For more about GraphStudio, see the [GraphStudio UI Guide](https://docs.tigergraph.com/gui/3.10/graphstudio/overview).
The security group must allow inbound TCP traffic to port 9000 if you want to send RESTful requests to TigerGraph from outside the instance (this includes configuring the GSQL client on a remote machine). For more about the REST API, see the [TigerGraph RESTful API User Guide](https://docs.tigergraph.com/tigergraph-server/3.10/API/).
For more about the TigerGraph Platform, see the [TigerGraph Platform Overview](https://docs.tigergraph.com/tigergraph-server/3.10/intro/).
![Configuration Page 2](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/configuration-page-2%20\(1\).png)
  6. That’s it! The TigerGraph instance has been successfully deployed on AWS.
![Deploying Page](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/launch-successful%20\(1\).png)


## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws#_starting_tigergraph_on_your_instance)**Starting TigerGraph on Your Instance**
...
![TigerGraph Login](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/login-to-tigergraph-user%20\(2\).png)
...
![Output of gadmin status](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-status%20\(2\).png)
![Gadmin status error message](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-status-error-message%20\(2\).png)
...
![Output of gadmin start](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-start%20\(10\).png)
...
![Gadmin status after running gadmin start](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-status-after-start%20\(2\).png)
  5. TigerGraph has been successfully started on your cloud instance.


## [](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/cloud-images/aws#_tigergraph_license_on_aws_images)TigerGraph License on **AWS** Images
...
![Gadmin license status output](https://docs.tigergraph.com/tigergraph-server/3.10/getting-started/_images/gadmin-license-status%20\(3\).png)
