...
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/data-loading/pages/data-loading-v2.adoc)
### Contents
  * [Setup](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_setup)
  * [HA Setup](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_ha_setup)
  * [Validation](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_validation)
  * [Run Loading Job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_run_loading_job)
  * [Configuration](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_configuration)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_setup)`Setup`
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_ha_setup)`HA Setup`
To enable data loading HA, use a cluster with replication factor greater than 1 following [High Availability Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/3.11/cluster-and-ha-management/ha-cluster).
Then data loading HA will be enabled by default with data loading V2 enabled.
### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_validation)`Validation`
To confirm data loading V2 is successfully enabled, try running a loading job as usual described in [Data Loading Overview](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview).
...
![Example GSQL loading progress with data loading v2 enabled](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/_images/data-loading-v2-progress-example.png)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_run_loading_job)`Run Loading Job`
You can now run any loading job as usual following these instructions [Data Loading Overview](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview).
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-v2#_configuration)`Configuration`
