...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/data-loading/pages/avro-validation-with-kafka.adoc)
### Contents
  * [Overview](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_overview)
  * [ErrorTolerance](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_errortolerance)
  * [Types of Avro Transformation](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_types_of_avro_transformation)
  * [How to Enable Avro Data Validation](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_how_to_enable_avro_data_validation)
  * [Old Schema vs. New Schema:](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_old_schema_vs_new_schema)
  * [How to Show Data Malformation Errors](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_how_to_show_data_malformation_errors)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_overview)Overview
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_errortolerance)`ErrorTolerance`
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_types_of_avro_transformation)Types of Avro Transformation
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_how_to_enable_avro_data_validation)How to Enable Avro Data Validation
...
---  
### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_old_schema_vs_new_schema)Old Schema vs. New Schema:
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/avro-validation-with-kafka#_how_to_show_data_malformation_errors)How to Show Data Malformation Errors
