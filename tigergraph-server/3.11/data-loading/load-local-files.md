...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/data-loading/pages/load-local-files.adoc)
### Contents
  * [Example Schema](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_example_schema)
  * [Create a loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_create_a_loading_job)
  * [Example loading job for local files](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_example_loading_job_for_local_files)
  * [Define filenames](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_define_filenames)
  * [Specify the data mapping](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_specify_the_data_mapping)
  * [Run the loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_run_the_loading_job)
  * [Manage and monitor your loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_manage_and_monitor_your_loading_job)
  * [Manage loading job concurrency](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_manage_loading_job_concurrency)
  * [Files Loader Auto-Restart](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_files_loader_auto_restart)
  * [Known Issues with Loading](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_known_issues_with_loading)
...
Table of Contents
  ...
  * [Create a loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_create_a_loading_job)
    * [Example loading job for local files](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_example_loading_job_for_local_files)
    * [Define filenames](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_define_filenames)
      * [Local file descriptors](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_local_file_descriptors)
    * [Specify the data mapping](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_specify_the_data_mapping)
  * [Run the loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_run_the_loading_job)
  * [Manage and monitor your loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_manage_and_monitor_your_loading_job)
  * [Manage loading job concurrency](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_manage_loading_job_concurrency)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_example_schema)Example Schema
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_create_a_loading_job)Create a loading job
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_example_loading_job_for_local_files)Example loading job for local files
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_define_filenames)Define filenames
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_local_file_descriptors)Local file descriptors
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_specify_the_data_mapping)Specify the data mapping
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_run_the_loading_job)Run the loading job
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_manage_and_monitor_your_loading_job)Manage and monitor your loading job
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_manage_loading_job_concurrency)Manage loading job concurrency
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_files_loader_auto_restart)Files Loader Auto-Restart
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-local-files#_known_issues_with_loading)Known Issues with Loading
