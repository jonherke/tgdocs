...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/data-loading/pages/data-loading-overview.adoc)
### Contents
  * [Loading System Architecture](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_system_architecture)
  * [Data Sources](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_data_sources)
  * [Loading Workflow](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_workflow)
  * [Loading Jobs](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_jobs)
...
Once you have [defined a graph schema](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/defining-a-graph-schema), you can load data into the graph. This section focuses on how to configure TigerGraph for the different data sources, as well as different data formats and transport schemes.
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_system_architecture)Loading System Architecture
...
![Architectural diagram showing supported data sources](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/_images/loading-arch_3.11-rev2.png)
Figure 1. TigerGraph Data Loading Options
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_data_sources)Data Sources
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_workflow)Loading Workflow
...
```
  ...
  2. If you are using Kafka Connect, **define a`DATA_SOURCE` object**. See the details on the pages for [cloud storage](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-from-cloud), [BigQuery](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-from-warehouse#_bigquery), [Snowflake](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-from-warehouse#_snowflake), [PostgreSQL](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/load-from-warehouse#_postgresql), [Kafka](https://docs.tigergraph.com/tigergraph-server/4.2/data-loading/load-from-kafka#_configure_the_kafka_source) or [Stream from an External Kafka Cluster (Deprecated)](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-streaming-connector/kafka).
  3. **Create a[loading job](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_jobs)**.
  4. **Run your loading job**.


## [](https://docs.tigergraph.com/tigergraph-server/3.11/data-loading/data-loading-overview#_loading_jobs)Loading Jobs
...
Refer to the [Creating a Loading Job](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job) documentation for full details   
---  
