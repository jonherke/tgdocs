...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/security/pages/password-policy.adoc)
### Contents
  * [Password complexity rules](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_password_complexity_rules)
  * [Password rotation rules](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_password_rotation_rules)
  * [Enable/Disable password policy](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_enabledisable_password_policy)
  * [Configure password rules](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_configure_password_rules)
  * [How to set a new password after the old one has expired](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_how_to_set_a_new_password_after_the_old_one_has_expired)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_password_complexity_rules)Password complexity rules
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_password_rotation_rules)Password rotation rules
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_enabledisable_password_policy)Enable/Disable password policy
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_configure_password_rules)Configure password rules
...
---|---|---|---  
`Security.UserPasswordPolicy.Enable` | Enable/disable the password policy | false | true/false  
`Security.UserPasswordPolicy.MinLength` | Min length | 8 | [1,128]  
`Security.UserPasswordPolicy.UppercaseLetterRequired` | Require at Least One Uppercase Character | true | true/false  
`Security.UserPasswordPolicy.LowercaseLetterRequired` | Require at Least One Lowercase Character | true | true/false  
`Security.UserPasswordPolicy.DigitRequired` | Require at Least One Digit | true | true/false  
`Security.UserPasswordPolicy.SpecialCharacterRequired` | Require at Least One special character . | true | true/false  
`Security.UserPasswordPolicy.ExpirationDay` | How long the password remains valid after it has been updated | 90 | [1, 2147483647]  
`Security.UserPasswordPolicy.PasswordReuseThreshold` | What is the minimum number of unique passwords required before a previously used password can be reused | 5 | [1, 20]  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/password-policy#_how_to_set_a_new_password_after_the_old_one_has_expired)How to set a new password after the old one has expired
