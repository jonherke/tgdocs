...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/security/pages/file-output-policy.adoc)
### Contents
  * [GSQL.FileOutputPolicy](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy#_gsql_fileoutputpolicy)
  * [Example](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy#_example)
  * [Edit the file output policy](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy#_edit_the_file_output_policy)
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy#_example)Example
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/file-output-policy#_edit_the_file_output_policy)Edit the file output policy
