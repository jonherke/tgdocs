...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/security/pages/login-protection.adoc)
### Contents
  * [Configure the number of failed attempts to trigger login protection](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection#_configure_the_number_of_failed_attempts_to_trigger_login_protection)
  * [Configure the amount of time between failed attempts](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection#_configure_the_amount_of_time_between_failed_attempts)
  * [Configure the number of failed attempts to double wait time](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection#_configure_the_number_of_failed_attempts_to_double_wait_time)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection#_configure_the_number_of_failed_attempts_to_trigger_login_protection)Configure the number of failed attempts to trigger login protection
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection#_configure_the_amount_of_time_between_failed_attempts)Configure the amount of time between failed attempts
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/security/login-protection#_configure_the_number_of_failed_attempts_to_double_wait_time)Configure the number of failed attempts to double wait time
