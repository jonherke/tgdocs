...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_etcd)ETCD
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_executor)Executor
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_fileloader)FileLoader
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_gpe)GPE
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_gse)GSE
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_gsql)GSQL
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_kafka)Kafka
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_kafkaconnect)KafkaConnect
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_restpp)RESTPP
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/reference/configuration-parameters#_security)Security
Name | Description | Example  
---|---|---  
...
System.Backup.CompressProcessNumber | The number of concurrent process for compression during backup. Value `0` means the number of processes used to compress equals the node CPU’s cores. | `10`  
