...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/user-access/pages/user-credentials.adoc)
### Contents
  * [Passwords](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_passwords)
  * [ACL passwords](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_acl_passwords)
  * [Secrets](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_secrets)
  * [Create a secret](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_create_a_secret)
  * [List secrets](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_list_secrets)
  * [Drop a secret](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_drop_a_secret)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_passwords)Passwords
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_acl_passwords)ACL passwords
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_secrets)Secrets
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_create_a_secret)Create a secret
```
CREATE SECRET [<alias>]
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_required_privilege)Required privilege
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_list_secrets)List secrets
```
SHOW SECRET
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/user-access/user-credentials#_drop_a_secret)Drop a secret
```
DROP SECRET <secret>
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
