...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/backup-and-restore/pages/cross-cluster-backup.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_prerequisites)
  * [Procedure](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_procedure)
  * [1) Copy Data Backup to a New Cluster](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_1_copy_data_backup_to_a_new_cluster)
  * [2) Restore Cluster](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_2_restore_cluster)
  * [Procedure v3.9.1 and below](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_procedure_v3_9_1_and_below)
  * [1) Upload Metadata to New Cluster](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_1_upload_metadata_to_new_cluster)
  * [2) Copy Data Backup to a New Cluster](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_2_copy_data_backup_to_a_new_cluster)
  * [3) Restore Cluster](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_3_restore_cluster)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_prerequisites)Prerequisites
  * Your new cluster has the same [partitioning factor](https://docs.tigergraph.com/tigergraph-server/3.11/cluster-and-ha-management/ha-cluster) as the cluster from which the backup file was created.
  ...
  * [[3.9.1 and earlier](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_procedure_v3_9_1_and_below)] You have the metadata backup that goes with the data backup.
  * You have [configured backup and restore](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/configurations) on the new cluster.


## [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_procedure)Procedure
### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_1_copy_data_backup_to_a_new_cluster)1) Copy Data Backup to a New Cluster
#### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_for_amazon_s3_backup)For Amazon S3 Backup:
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_for_local_backup_storage)For Local Backup Storage:
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_2_restore_cluster)2) Restore Cluster
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_procedure_v3_9_1_and_below)Procedure v3.9.1 and below
### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_1_upload_metadata_to_new_cluster)1) Upload Metadata to New Cluster
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_2_copy_data_backup_to_a_new_cluster)2) Copy Data Backup to a New Cluster
#### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_for_amazon_s3_backup_2)For Amazon S3 Backup:
If your backups are stored in Amazon S3 buckets, set the following configuration parameter to be the location of your backup files.
```
System.Backup.S3.BucketName
![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
For the new cluster to be the same as the previous cluster.
#### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_for_local_backup_storage_2)For Local Backup Storage:
If your backups were stored locally, you need to make sure backup files from all nodes are copied to the new cluster. They do not necessarily need to be on the corresponding nodes as long as all partitions are in the new cluster at the specified paths you configured.
  * For example:
If you have configured the backup path to be
```
...
### [](https://docs.tigergraph.com/tigergraph-server/3.11/backup-and-restore/cross-cluster-backup#_3_restore_cluster)3) Restore Cluster
