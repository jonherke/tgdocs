...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp)[Next](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.11/modules/getting-started/pages/cloud-images/gcp.adoc)
### Contents
  * [Deploying Your Instance](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp#_deploying_your_instance)
  * [Starting TigerGraph on Your Instance](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp#_starting_tigergraph_on_your_instance)
  * [TigerGraph License on Google Cloud Images](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp#_tigergraph_license_on_google_cloud_images)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp#_deploying_your_instance)Deploying Your Instance
  ...
  2. Click **Launch**.
  3. Review the default settings and see if they fit your needs. When ready, click **Deploy**.
     * The instance type needs to have at least 4 CPUs and 16GB RAM for TigerGraph to work properly.
     * You must allow internet traffic for TCP port 14240 if you want to access GraphStudio. For more about GraphStudio, see the [GraphStudio UI Guide](https://docs.tigergraph.com/gui/3.11/graphstudio/overview).
...
![deploy form](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/_images/deploy-form.png)
  4. That’s it! The TigerGraph instance has been successfully deployed on Google Cloud.
![deploy page](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/_images/deploy-page.png)


## [](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp#_starting_tigergraph_on_your_instance)Starting TigerGraph on Your Instance
  1. Log into the instance and switch to user `tigergraph` using the following command:
```
$ sudo su - tigergraph
...
```
  ...
  2. Run the following command to check the current status of TigerGraph. The services **"ADMIN", "CTRL", "ETCD", "IFM", "KAFKA", and "ZK" are started automatically** and are online at this point. If any of them are down, **please wait for 30 to 60 seconds and check the status again**.
```
gadmin status
![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
![gadmin status \(3\)](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/_images/gadmin-status%20\(3\).png)
...
```
  ...
  4. Check the status again. All services are online at this point. It is normal for GPE and GSE to be in warmup when the database is empty.
```
$ gadmin status
![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
```
  ...
  5. You have successfully started TigerGraph on your cloud instance.


## [](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/cloud-images/gcp#_tigergraph_license_on_google_cloud_images)TigerGraph License on Google Cloud Images
The TigerGraph Enterprise edition image comes with **a perpetual license** that will **only work on the Google Cloud instance it’s installed on**. To view the license, run the following command:
```
...
![gadmin license status \(4\)](https://docs.tigergraph.com/tigergraph-server/3.11/getting-started/_images/gadmin-license-status%20\(4\).png)
