...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/API/pages/authentication.adoc)
### Contents
  * [REST++ Server Requests](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication#_rest_server_requests)
  * [Using Tokens](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication#_using_tokens)
  * [GSQL Server Requests](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication#_gsql_server_requests)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication#_rest_server_requests)REST++ Server Requests
...
The REST++ server implements OAuth 2.0-style authorization as follows:
  1. Each user [can create one or more **secrets** (unique pseudorandom strings)](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/user-credentials#_create_a_secret). Each secret is associated with a particular user and the user’s privileges for a particular graph.
  2. Anyone who has this secret can invoke a special REST endpoint to [generate authorization **tokens**](https://docs.tigergraph.com/tigergraph-server/3.9/API/built-in-endpoints#_request_a_token) (other pseudorandom strings).
...
### [](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication#_using_tokens)**Using Tokens**
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/API/authentication#_gsql_server_requests)GSQL Server Requests
