...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/backup-and-restore/pages/backup-cluster.adoc)
### Contents
  * [1. Prerequisites](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_prerequisites)
  * [2. Procedure](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_procedure)
  * [2.1. Data backup](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_data_backup)
  * [2.2. Metadata backup (Optional)](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_metadata_backup_optional)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_prerequisites)1. Prerequisites
  ...
  * You have provided valid [configurations for database backup](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/configurations).


## [](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_procedure)2. Procedure
### [](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_data_backup)2.1. Data backup
...
This creates a backup file named `weekly-<timestamp>` at the [backup location you configured](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/configurations).
### [](https://docs.tigergraph.com/tigergraph-server/3.9/backup-and-restore/backup-cluster#_metadata_backup_optional)2.2. Metadata backup (Optional)
