...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/troubleshooting/pages/log-files.adoc)
### Contents
  * [TigerGraph log structure](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files#_tigergraph_log_structure)
  * [Log locations on a cluster](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files#_log_locations_on_a_cluster)
  * [Open source TigerGraph components](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files#_open_source_tigergraph_components)
  * [Log rotation](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files#_log_rotation)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files#_open_source_tigergraph_components)Open source TigerGraph components
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/troubleshooting/log-files#_log_rotation)Log rotation
