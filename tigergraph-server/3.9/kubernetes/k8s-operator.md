...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/kubernetes/pages/k8s-operator/index.adoc)
### Contents
  * [Getting started](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/#_getting_started)
  * [Supported cloud platforms](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/#_supported_cloud_platforms)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/#_getting_started)Getting started
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/kubernetes/k8s-operator/#_supported_cloud_platforms)Supported cloud platforms
