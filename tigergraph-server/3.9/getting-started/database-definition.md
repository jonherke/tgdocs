...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/getting-started/pages/database-definition.adoc)
### Contents
  * [Define a schema](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_define_a_schema)
  * [Modify a schema](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_modify_a_schema)
  * [Reset all](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_reset_all)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_define_a_schema)Define a schema
...
To learn about the GSQL commands used to define a schema, see [GSQL language reference: Defining a Graph Schema.](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/defining-a-graph-schema)
## [](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_modify_a_schema)Modify a schema
...
To learn about the GSQL commands used in modifying a schema, see [GSQL language reference: Modifying a Graph Schema.](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/modifying-a-graph-schema)
## [](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_reset_all)Reset all
