...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/intro/pages/multigraph-overview.adoc)
### Contents
  * [Graphs](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_graphs)
  * [Graph-specific roles and privileges](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_graph_specific_roles_and_privileges)
  * [Setting a working graph](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_setting_a_working_graph)
  * [Use cases](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_use_cases)
  * [Effect on other specifications](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_effect_on_other_specifications)
...
For details about managing users, privileges, and roles, see [User Access Management](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/).
## [](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_setting_a_working_graph)Setting a working graph
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_use_cases)Use cases
...
## [](https://docs.tigergraph.com/tigergraph-server/3.9/intro/multigraph-overview#_effect_on_other_specifications)Effect on other specifications
  * RESTPP Endpoints: Endpoints that pertain to the graph data must include the name of the graph in the request URL. See [RESTPP API User Guide.](https://docs.tigergraph.com/tigergraph-server/3.9/API/)
  * User Authentication secrets and tokens: Our commands and procedures follow OAuth standards. See [User Access Management](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/).
