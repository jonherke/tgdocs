...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/getting-started/pages/index.adoc)
### Contents
  * [Get Started with Docker](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/#_get_started_with_docker)
  * [Get Started on Linux](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/#_get_started_on_linux)
  * [Get Started from a Cloud Marketplace](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/#_get_started_from_a_cloud_marketplace)
...
This Get Started section covers the various options for users who are installing the TigerGraph database themselves. If you are using TigerGraph Cloud please refer to [Compare TigerGraph Editions](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions) for a comparison chart of TigerGraph Server vs. TigerGraph Cloud.
## [](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/#_get_started_with_docker)[Get Started with Docker](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/docker)
If you are a Mac or Windows user, we recommend you use Docker to start up TigerGraph on your computer.
The Docker image version of TigerGraph is for personal or R&D use and not for production use.   
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/#_get_started_on_linux)[Get Started on Linux](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/linux)
If you have a Linux machine that meets our [Hardware and Software Requirements](https://docs.tigergraph.com/tigergraph-server/3.9/installation/hw-and-sw-requirements), you can install TigerGraph on your machine directly.
## [](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/#_get_started_from_a_cloud_marketplace)[Get Started from a Cloud Marketplace](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/cloud-images/)
