...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.9/reference/list-of-privileges)[Next](https://docs.tigergraph.com/tigergraph-server/3.9/reference/list-of-privileges)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.9/reference/list-of-privileges)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.9/reference/list-of-privileges)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.9/modules/reference/pages/list-of-privileges.adoc)
### Contents
  * [Table of Privileges](https://docs.tigergraph.com/tigergraph-server/3.9/reference/list-of-privileges#_table_of_privileges)
...
This page provides a complete list of privileges in TigerGraph’s Role-based Access Control system.
  * Any privilege marked “Global only” can only be granted to a global role. It cannot be granted to a local role (See [Global role vs local role](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/access-control-model)).
  * Local roles are deprecated and will be dropped in a later version.

  
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.9/reference/list-of-privileges#_table_of_privileges)Table of Privileges
...
| No  
`CREATE_DATA` | Running queries that insert vertices or edges in the allowed scope. For details see [Data CRUD privileges](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/access-control-model#_data_crud_privileges). | No  
`READ_DATA` | Running queries that read vertex or edge information in the allowed scope. For details see [Data CRUD privileges](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/access-control-model#_data_crud_privileges). | No  
`UPDATE_DATA` |  Running queries that update vertex or edge information in the allowed scope. For details see [Data CRUD privileges](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/access-control-model#_data_crud_privileges). | No  
`DELETE_DATA` | Running queries that delete vertices or edges in the allowed scope. For details see [Data CRUD privileges](https://docs.tigergraph.com/tigergraph-server/3.9/user-access/access-control-model#_data_crud_privileges). | No  
`WRITE_DATASOURCE` | 
