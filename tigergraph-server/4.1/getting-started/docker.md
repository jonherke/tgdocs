...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/getting-started/pages/docker.adoc)
### Contents
  * [1. Install Docker Desktop](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_install_docker_desktop)
  * [2. Prepare a shared folder for your container](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_prepare_a_shared_folder_for_your_container)
  * [3. Run the TigerGraph Docker image as a daemon](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_run_the_tigergraph_docker_image_as_a_daemon)
  * [4. Connect to your container (via SSH or docker exec)](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_connect_to_your_container_via_ssh_or_docker_exec)
  * [5. Secure TigerGraph](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_secure_tigergraph)
  * [6. Start TigerGraph](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_start_tigergraph)
  * [7. Operation Commands Cheat Sheet](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_operation_commands_cheat_sheet)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_install_docker_desktop)1. Install Docker Desktop
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_prepare_a_shared_folder_for_your_container)2. Prepare a shared folder for your container
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_run_the_tigergraph_docker_image_as_a_daemon)3. Run the TigerGraph Docker image as a daemon
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_connect_to_your_container_via_ssh_or_docker_exec)4. Connect to your container (via SSH or `docker exec`)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_secure_tigergraph)5. Secure TigerGraph
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_start_tigergraph)6. Start TigerGraph
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/getting-started/docker#_operation_commands_cheat_sheet)7. Operation Commands Cheat Sheet
