...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_etcd)ETCD
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_executor)Executor
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_fileloader)FileLoader
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_gpe)GPE
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_gse)GSE
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_gsql)GSQL
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_kafka)Kafka
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_kafkaconnect)KafkaConnect
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_kafkaloader)KafkaLoader
Name | Description | Example  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/reference/configuration-parameters#_restpp)RESTPP
Name | Description | Example  
---|---|---  
...
GSE | `ServFromDisk`, GSE.BasicConfig.Env | 
  ...
  * GSE will perform a one-time DB format conversion during the first startup after turning this flag on. The conversion time depends on the number of vertices. After the conversion, GSE must then be restarted for the conversion to take effect. NOTE: The built-in endpoints [`/deleted_vertex_check`](https://docs.tigergraph.com/tigergraph-server/4.1/API/built-in-endpoints#_deleted_vertex_check) and [`/data_consistency_check`](https://docs.tigergraph.com/tigergraph-server/4.1/API/built-in-endpoints#_data_consistency_check) are not supported when ServFromDisk = 1, as they require the full scan which can take significant time.
