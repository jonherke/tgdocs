...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/user-access/pages/index.adoc)
...
User authentication is not enabled by default. To secure your database and the underlying system, we strongly suggest that you [enable authentication](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/enabling-user-authentication).   
---  
