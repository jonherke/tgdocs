...
To save to cloud storage, the container name and access credentials need to be configured. After the [table of configuration parameters](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/configurations#_configuration_parameters), you will find instructions for configuring backup to
  ...
  * [to Azure Blob Storage](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/configurations#_backup_to_abs_azure_blob_storage)
  * [to Google Cloud Storage](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/configurations#_backup_to_gcs_google_cloud_storage)


## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/configurations#_prerequisites)Prerequisites
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/configurations#_configuration_parameters)Configuration parameters
