...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/backup-and-restore/pages/online-backup.adoc)
### Contents
  * [Introduction](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_introduction)
  * [Key Benefits](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_key_benefits)
  * [Benchmark Insights](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_benchmark_insights)
  * [Limitations and Considerations](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_limitations_and_considerations)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_introduction)Introduction
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_key_benefits)Key Benefits
...
Summary of key benefits:
  * Significant reduction in blocking time (See [Benchmark Insights](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_benchmark_insights)) for clusters, particularly in post request handling.
  * Uninterrupted data operations.


## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_benchmark_insights)Benchmark Insights
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/online-backup#_limitations_and_considerations)Limitations and Considerations
