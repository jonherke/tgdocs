...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/backup-and-restore/pages/differential-backups.adoc)
### Contents
  * [Terminology Definition](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_terminology_definition)
  * [How Differential Backup works](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_how_differential_backup_works)
  * [Enable Differential Backup](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_enable_differential_backup)
  * [Disable Differential Backup](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_disable_differential_backup)
  * [Limitations](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_limitations)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_terminology_definition)Terminology Definition
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_how_differential_backup_works)How Differential Backup works
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_enable_differential_backup)Enable Differential Backup
...
![backup list](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/_images/backup_list.png)
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_disable_differential_backup)Disable Differential Backup
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/differential-backups#_limitations)Limitations
