...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/gsql-shell/pages/gsql-sessions.adoc)
### Contents
  * [Session timeout](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_session_timeout)
  * [Example](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_example)
  * [Concurrent sessions](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_concurrent_sessions)
  * [Session parameters](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_session_parameters)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_session_timeout)Session timeout
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_example)Example
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_concurrent_sessions)Concurrent sessions
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/gsql-shell/gsql-sessions#_session_parameters)Session parameters
