...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/data-loading/pages/externalizing-kafka-configs.adoc)
### Contents
  * [Disallowed Configurations](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_disallowed_configurations)
  * [Disallowed](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_disallowed)
  * [Config Providers](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_config_providers)
  * [File Config Provider](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_file_config_provider)
  * [Environment Variable Config Provider](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_environment_variable_config_provider)
  * [Vault Config Provider](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_vault_config_provider)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_disallowed_configurations)Disallowed Configurations
### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_disallowed)Disallowed
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_config_providers)Config Providers
...
---|---|---|---  
[File Config Provider](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_file_config_provider) | file | org.apache.kafka.common.config.provider.FileConfigProvider | `${file:<path-to-file>:<key>}`  
[Environment Variable Config Provider](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_environment_variable_config_provider) | env | org.apache.kafka.common.config.provider.EnvVarConfigProvider | `${env:<key>} (no path needed)`  
[Vault Config Provider](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_vault_config_provider) | vault | org.apache.kafka.common.config.provider.VaultConfigProvider | `${vault:<vault-path>:<key>}`  
### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_file_config_provider)File Config Provider
...
---  
#### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_example_usage)Example usage
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_environment_variable_config_provider)Environment Variable Config Provider
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_example_usage_2)Example Usage
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_vault_config_provider)Vault Config Provider
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/externalizing-kafka-configs#_example_usage_3)Example Usage
