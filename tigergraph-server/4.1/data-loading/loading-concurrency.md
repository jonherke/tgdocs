...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/data-loading/pages/loading-concurrency.adoc)
### Contents
  * [Loading Job Concurrency](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency#_loading_job_concurrency)
  * [Number of concurrent loading jobs](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency#_number_of_concurrent_loading_jobs)
  * [Allowed resources for loading](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency#_allowed_resources_for_loading)


## [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency#_loading_job_concurrency)Loading Job Concurrency
### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency#_number_of_concurrent_loading_jobs)Number of concurrent loading jobs
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/data-loading/loading-concurrency#_allowed_resources_for_loading)Allowed resources for loading
