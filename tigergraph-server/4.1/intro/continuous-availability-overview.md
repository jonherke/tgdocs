...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/intro/pages/continuous-availability-overview.adoc)
### Contents
  * [Introduction](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_introduction)
  * [Architecture Design](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_architecture_design)
  * [Continuous Availability - Definitions](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_continuous_availability__definitions)
  * [Continuous Availability - Data Operations](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_continuous_availability_data_operations)
  * [Continuous Availability - Cluster failover operations](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_continuous_availability_cluster_failover_operations)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_introduction)Introduction
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_architecture_design)Architecture Design
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_continuous_availability__definitions)Continuous Availability - Definitions
...
![Diagram showing the mathematical relationship between the partitioning and replication factors in a TigerGraph cluster](https://docs.tigergraph.com/tigergraph-server/4.1/intro/_images/cluster_arch.png)
...
---  
### [](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_continuous_availability_data_operations)Continuous Availability - Data Operations
...
![Diagram showing a cluster with 10 partitions. The top group of partitions are labeled 1A through 5A, and the replicas are labeled 1B through 5B.](https://docs.tigergraph.com/tigergraph-server/4.1/intro/_images/replication-partitioning-factor.png)
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/intro/continuous-availability-overview#_continuous_availability_cluster_failover_operations)Continuous Availability - Cluster failover operations
...
![Diagram showing a cluster with 10 partitions. The top group of partitions are labeled 1A through 5A, and the replicas are labeled 1B through 5B. Replica 3B is crossed out with an X.](https://docs.tigergraph.com/tigergraph-server/4.1/intro/_images/ha-failover.png)
**Example** :
