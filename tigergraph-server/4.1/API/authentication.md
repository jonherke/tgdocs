...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Authentication (TigerGraph 3.x)](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication)


[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/API/pages/authentication.adoc)
### Contents
  * [REST++ Server Requests](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_rest_server_requests)
  * [Using Tokens](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_using_tokens)
  * [3rd party JWT token](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_3rd_party_jwt_token)
  * [GSQL Server Requests](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_gsql_server_requests)
...
TigerGraph’s RESTful APIs communicate with either the REST++ server on port 9000 or the GSQL server on port 14240. Each server uses different methods of authentication.
  ...
  * As of 3.10.0, the use of plaintext tokens in authentication is deprecated. In TigerGraph 4.1, authentication uses [JWT tokens](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/jwt-token) and access port is 14240 for self-managed installations.
  * For TigerGraph Cloud, use port 443.

  
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_rest_server_requests)REST++ Server Requests
TigerGraph REST++ endpoints are public by default: anyone with access to the HTTP ports of the TigerGraph server can run your endpoints. When [REST++ authentication is enabled](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/enabling-user-authentication), then a valid authorization token must be included in the header.
The REST++ server implements OAuth 2.0-style authorization as follows:
  1. Each user [can create one or more **secrets** (unique pseudorandom strings)](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/user-credentials#_create_a_secret). Each secret is associated with a particular user and the user’s privileges for a particular graph.
  2. Anyone who has this secret can invoke a special REST endpoint to [generate authorization **tokens**](https://docs.tigergraph.com/tigergraph-server/4.1/API/built-in-endpoints#_request_a_token) (other pseudorandom strings).
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_using_tokens)**Using Tokens**
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_3rd_party_jwt_token)3rd party JWT token
Since 3.10.0, TigerGraph now supports the use of 3rd party JWT token. See [OIDC JWT Authentication](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/jwt-token) for more details.
## [](https://docs.tigergraph.com/tigergraph-server/4.1/API/authentication#_gsql_server_requests)GSQL Server Requests
