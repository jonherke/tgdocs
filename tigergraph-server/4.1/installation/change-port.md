...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/installation/change-port)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/installation/change-port)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/installation/change-port)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/installation/change-port)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/installation/pages/change-port.adoc)
# Changing Ports
