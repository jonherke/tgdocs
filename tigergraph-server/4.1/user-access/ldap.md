...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap)[Next](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.1/modules/user-access/pages/ldap.adoc)
### Contents
  * [LDAP configuration parameters](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_ldap_configuration_parameters)
  * [Configure TigerGraph to use LDAP](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_configure_tigergraph_to_use_ldap)
  * [Mapping Users From LDAP to TigerGraph](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_mapping_users_from_ldap_to_tigergraph)
  * [Configure Proxy Group](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_configure_proxy_group)
  * [Group hierarchy](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_group_hierarchy)
  * [Commands to manage proxy groups](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_commands_to_manage_proxy_groups)
  * [Common errors](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_common_errors)
  * [Parameter error](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_parameter_error)
  * [Wrong username or password](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_wrong_username_or_password)
  * [User does not match any proxy rule](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_user_does_not_match_any_proxy_rule)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_ldap_configuration_parameters)LDAP configuration parameters
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_configure_tigergraph_to_use_ldap)Configure TigerGraph to use LDAP
...
## [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_mapping_users_from_ldap_to_tigergraph)Mapping Users From LDAP to TigerGraph
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_configure_proxy_group)Configure Proxy Group
...
After creating the proxy group, you can [grant roles](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/user-management) to the group to give the proxy group privileges.
### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_group_hierarchy)Group hierarchy
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_commands_to_manage_proxy_groups)Commands to manage proxy groups
  * `SHOW GROUP` displays information about all groups.
  * `DROP GROUP <group_name>` deletes the definition of a group.


#### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_proxy_users)Proxy users
...
Proxy groups cannot be [exported](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/database-import-export).However, performing a [backup and restore](https://docs.tigergraph.com/tigergraph-server/4.1/backup-and-restore/) will preserve all proxy groups present at the time of backup.  
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_common_errors)Common errors
### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_parameter_error)Parameter error
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_wrong_username_or_password)Wrong username or password
...
### [](https://docs.tigergraph.com/tigergraph-server/4.1/user-access/ldap#_user_does_not_match_any_proxy_rule)User does not match any proxy rule
