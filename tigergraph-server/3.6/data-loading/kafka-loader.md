...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/data-loading/pages/kafka-loader/index.adoc)
### Contents
  * [Architecture](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/#_architecture)
  * [Supported file formats](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/#_supported_file_formats)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/#_architecture)Architecture
...
![Diagram of the Kafka Loader showing User Input going through a GSQL server into a RESTPP Server. A Kafka cluster data source is also shown connected to the RestPP server. Both servers are labeled as the TigerGraph System.](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/_images/kafka-loading-architecture.png)
Figure 1. User input feeds into the RESTPP server via a GSQL server. A Kafka cluster feeds directly into the RESTPP server.
The Kafka loader doesn’t use consumer groups, and therefore doesn’t support HA. If a loading job is interrupted, you need to manually [resume the loading job](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/manage-loading-jobs). A resumed job picks up from where it was stopped before and will not consume messages that have already been consumed.  
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/kafka-loader/#_supported_file_formats)Supported file formats
  * CSV
  * JSON
  * Avro (when sourced from an [external Kafka cluster](https://docs.tigergraph.com/tigergraph-server/3.6/data-loading/data-streaming-connector#_stream_data_from_an_external_kafka_cluster))


NULL is not a valid input valid. TigerGraph does not store NULL values. Therefore, your input data should not contain any NULLs.  
---  
