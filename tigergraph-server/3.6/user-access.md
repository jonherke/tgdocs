...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/user-access/pages/index.adoc)
### Contents
  * [Users and Credentials](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/#_users_and_credentials)
...
User authentication is not enabled by default. To secure your database and the underlying system, we strongly suggest that you [enable authentication](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/enabling-user-authentication).   
---  
Below is a list of the key features of TigerGraph’s user access management system:
  * [Authentication](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/enabling-user-authentication)
  * [User management](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/user-management)
  * [Role management](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/role-management)
  * [Vertex-level access control (VLAC)](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/vlac)
  * [Lightweight Directory Access Protocol (LDAP)](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/ldap)
  * [Single sign-on](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/sso)


## [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/#_users_and_credentials)Users and Credentials
