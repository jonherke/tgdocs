...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/reference/ports)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/reference/ports)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/reference/ports)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/reference/ports)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/reference/pages/ports.adoc)
# List of Ports
...
17797 | Port for Dict  
19000 | RESTful API port for TS3Server  
19001 | gRPC API port for TS3Server  
...
49152 - 65535 | Dynamic ports | Required for backup and restore as well as communication between TigerGraph services.  
