...
Admin.BasicConfig.LogDirRelativePath | The relative path (to the System.LogRoot) of log directory for Admin | `admin`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_controller)Controller
Name | Description | Default  
---|---|---  
Controller.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `nan`  
...
Controller.LeaderElectionHeartBeatMaxMiss | The maximum number of heartbeat can be missed before one service is considered dead by controller | `5`  
Controller.Port | The serving grpc port for Controller | `9188`  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_dict)Dict
Name | Description | Default  
---|---|---  
Dict.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `LD_LIBRARY_PATH=$LD_LIBRARY_PATH;`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_etcd)ETCD
Name | Description | Default  
---|---|---  
...
FileLoader.ReplicaNumber | The number of replica of fileloader per node | `1`  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_gpe)GPE
Name | Description | Default  
---|---|---  
GPE.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `LD_PRELOAD=$LD_PRELOAD; LD_LIBRARY_PATH=$LD_LIBRARY_PATH; CPUPROFILE=/tmp/tg_cpu_profiler; CPUPROFILESIGNAL=12; MALLOC_CONF=prof:true,prof_active:false`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_gse)GSE
Name | Description | Default  
---|---|---  
GSE.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `LD_PRELOAD=$LD_PRELOAD; LD_LIBRARY_PATH=$LD_LIBRARY_PATH; CPUPROFILE=/tmp/tg_cpu_profiler; CPUPROFILESIGNAL=12; MALLOC_CONF=prof:true,prof_active:false`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_gsql)GSQL
Name | Description | Default  
---|---|---  
GSQL.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `CPATH=$CPATH; LD_LIBRARY_PATH=$LD_LIBRARY_PATH;`  
...
GSQL.WaitServiceOnlineTimeoutSec | Timeout to wait for all services online | `60`  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_gui)GUI
Name | Description | Default  
---|---|---  
GUI.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `nan`  
...
GUI.HTTPRequest.TimeoutSec | GUI HTTP request timeout in seconds | `3600`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_gadmin)Gadmin
Name | Description | Default  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_informant)Informant
Name | Description | Default  
---|---|---  
Informant.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `nan`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_nginx)Nginx
Name | Description | Default  
---|---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_system)System
Name | Description | Default  
---|---|---  
System.AppRoot | The root directory for TigerGraph applications | `/home/tigergraph/tigergraph/app`  
System.AuthToken | The authorization token for TigerGraph services | `7hVw4bIu1t6XtOPJXZPEhy4wyZJMsRQX`  
System.Backup.CompressProcessNumber | The number of concurrent process for compression during backup | `8`  
System.Backup.Local.Enable | Backup data to local path **IMPORTANT** : If System.Backup.Local.Enable is set to true, this also enables a daily full backup at 12:00am UTC | `false`  
...
System.CrossRegionReplication.TopicPrefix | The prefix of GPE/GUI/GSQL Kafka Topic, by default is empty. | `nan`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_ts3)TS3
Name | Description | Default  
---|---|---  
TS3.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `nan`  
...
TS3.RetentionPeriodDay | The period in days for local database records to keep, set -1 for keeping forever | `30`  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_ts3server)TS3Server
Name | Description | Default  
---|---|---  
TS3Server.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `nan`  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/reference/configuration-parameters#_zk)ZK
Name | Description | Default  
---|---|---  
ZK.BasicConfig.Env | The runtime environment variables, separated by ‘;’ | `ZK_SERVER_HEAP=4096;`  
