...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/system-management/pages/manage-services.adoc)
### Contents
  * [Start, stop or restart a service](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services#_start_stop_or_restart_a_service)
  * [Check service status](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services#_check_service_status)
...
Consult the [Glossary](https://docs.tigergraph.com/tigergraph-server/3.6/reference/glossary) for definitions of the TigerGraph services.
## [](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services#_start_stop_or_restart_a_service)Start, stop or restart a service
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/manage-services#_check_service_status)Check service status
Use `gadmin status all` or `gadmin status` with an individual service to check its state. See [Service status definitions](https://docs.tigergraph.com/tigergraph-server/3.6/system-management/management-commands#_service_status_definitions) for detailed information on the returned results.
