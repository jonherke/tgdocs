...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/cluster-resizing/pages/index.adoc)
# Cluster Resizing
As your workload changes, it makes sense to resize your cluster to meet your production needs. This section describes the steps to perform the following cluster resizing operations:
  * [Expand a cluster](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/expand-a-cluster)
  * [Downsize a cluster](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/shrink-a-cluster)
  * [Repartition a cluster](https://docs.tigergraph.com/tigergraph-server/3.6/cluster-resizing/repartition-a-cluster)


All cluster resize operations require several minutes of downtime. The exact amount of downtime varies depending on the amount of data and the number of nodes in the cluster.   
---  
