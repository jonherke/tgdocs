...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/getting-started/pages/linux.adoc)
### Contents
  * [Quickstart guide for new users](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux#_quickstart_guide_for_new_users)
  * [Installation Checklist](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux#_installation_checklist)
...
You can install TigerGraph on a Linux machine that meets the [Hardware and Software Requirements](https://docs.tigergraph.com/tigergraph-server/3.6/installation/hw-and-sw-requirements). For a step-by-step guide on installing TigerGraph on your Linux machine, please visit [Installation Guide](https://docs.tigergraph.com/tigergraph-server/3.6/installation/install).
## [](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux#_quickstart_guide_for_new_users)Quickstart guide for new users
### [](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/linux#_installation_checklist)Installation Checklist
  1. **Check** [Hardware and Software Requirements](https://docs.tigergraph.com/tigergraph-server/3.6/installation/hw-and-sw-requirements)
  2. **Download** the TigerGraph platform: <https://info.tigergraph.com/enterprise-free>
...
```
    ...
    2. For additional options, see [Installation Guide](https://docs.tigergraph.com/tigergraph-server/3.6/installation/install).
