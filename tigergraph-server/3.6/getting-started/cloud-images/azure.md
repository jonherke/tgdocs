...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/getting-started/pages/cloud-images/azure.adoc)
### Contents
  * [Deploying Your Instance](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure#_deploying_your_instance)
  * [Starting TigerGraph on Your Instance](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure#_starting_tigergraph_on_your_instance)
  * [TigerGraph License on Microsoft Azure Images](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure#_tigergraph_license_on_microsoft_azure_images)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure#_deploying_your_instance)**Deploying Your Instance**
...
![Azure Create Page](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/create-page%20\(1\).png)
...
![Azure Basic Settings Page](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/basic-settings-page%20\(1\).png)
...
---  
The "NIC network security group" must allow inbound TCP traffic to port 14240 if you want to access GraphStudio (TigerGraph’s visualization platform). For more about GraphStudio, see the [GraphStudio UI Guide](https://docs.tigergraph.com/gui/4.2/graphstudio/overview).
...
![Azure Review Page](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/review-page%20\(1\).png)
  5. That’s it! The TigerGraph instance has been successfully deployed on Microsoft Azure.
![Azure Deploying Page](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/deployment-successful-page%20\(1\).png)


## [](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure#_starting_tigergraph_on_your_instance)**Starting TigerGraph on Your Instance**
...
![TigerGraph Login](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/login-to-tigergraph%20\(7\).png)
...
![Output of gadmin status](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/gadmin-status%20\(1\).png)
![Gadmin status error message](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/gadmin-status-error-message%20\(1\).png)
...
![Output of gadmin status](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/gadmin-start%20\(9\).png)
...
![Gadmin status after running gadmin start](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/gadmin-status-after-start%20\(1\).png)
  5. TigerGraph has been successfully started on your cloud instance.


## [](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/cloud-images/azure#_tigergraph_license_on_microsoft_azure_images)TigerGraph License on **Microsoft Azure** Images
...
![Gadmin license status output](https://docs.tigergraph.com/tigergraph-server/3.6/getting-started/_images/gadmin-license-status%20\(2\).png)
