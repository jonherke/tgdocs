...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/backup-and-restore/pages/index.adoc)
### Contents
  * [Synopsis](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_synopsis)
  * [Configure GBAR](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_configure_gbar)
  * [Perform a backup](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_perform_a_backup)
  * [List Backup Files](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_list_backup_files)
  * [Restore from a backup archive](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_restore_from_a_backup_archive)
  * [Restore process](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_restore_process)
  * [Remove a backup](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_remove_a_backup)
  * [Clean up temporary files](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_clean_up_temporary_files)
  * [GBAR Detailed Example](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_gbar_detailed_example)
  * [GBAR Backup Operational Details](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_gbar_backup_operational_details)
  * [GBAR Restore Operational Details](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_gbar_restore_operational_details)
  * [Performance Summary of Example](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_performance_summary_of_example)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_synopsis)Synopsis
```
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_configure_gbar)Configure GBAR
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_perform_a_backup)Perform a backup
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_list_backup_files)List Backup Files
```
gbar list
![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_restore_from_a_backup_archive)Restore from a backup archive
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_clean_up_temporary_files)Clean up temporary files
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_gbar_detailed_example)GBAR Detailed Example
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_gbar_backup_operational_details)GBAR Backup Operational Details
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_gbar_restore_operational_details)GBAR Restore Operational Details
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/backup-and-restore/#_performance_summary_of_example)Performance Summary of Example
