...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/kubernetes/pages/k8s-operator/cluster-operations.adoc)
### Contents
  * [Create TigerGraph clusters](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_create_tigergraph_clusters)
  * [List TigerGraph clusters](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_list_tigergraph_clusters)
  * [Check cluster status](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_check_cluster_status)
  * [Delete TigerGraph clusters](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_delete_tigergraph_clusters)
...
Kubernetes Operator is a Preview Feature. Preview Features give users an early look at future production-level features. Preview Features should not be used for production deployments.  
---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_create_tigergraph_clusters)Create TigerGraph clusters
...
Each cluster is provisioned with [persistent volumes](https://kubernetes.io/docs/concepts/storage/persistent-volumes/) for each node by default. When you create a cluster with persistent volumes, you must specify a [storage class](https://kubernetes.io/docs/concepts/storage/storage-classes/).
...
If your registry is private, you also need to provide a [Secret](https://kubernetes.io/docs/concepts/configuration/secret/) that allows you to access to the private registry. Make sure the Secret exists in the same namespace as the one where you are creating the cluster.
...
The `--ha` flag specifies the [replication factor](https://docs.tigergraph.com/tigergraph-server/3.6/ha/ha-cluster) (HA factor) of the cluster, which is the total number of instances of your data. If you create a 6-node cluster with the `--ha 2` flag, your cluster has two instances of data that are divided int 3 partitions.   
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_list_tigergraph_clusters)List TigerGraph clusters
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_check_cluster_status)Check cluster status
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_delete_tigergraph_clusters)Delete TigerGraph clusters
