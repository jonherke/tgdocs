...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/kubernetes/pages/k8s-operator/connect-to-cluster.adoc)
### Contents
  * [Establish an SSH connection to the cluster](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster#_establish_an_ssh_connection_to_the_cluster)
  * [Access GraphStudio](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster#_access_graphstudio)
  * [Access REST endpoints](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster#_access_rest_endpoints)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster#_establish_an_ssh_connection_to_the_cluster)Establish an SSH connection to the cluster
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster#_access_graphstudio)Access GraphStudio
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/connect-to-cluster#_access_rest_endpoints)Access REST endpoints
To access TigerGraph’s [REST endpoints](https://docs.tigergraph.com/tigergraph-server/4.2/API/), make sure port 9000 on your cluster is accessible. Run the following command to retrieve the IP address of the REST external service.
```
$ kubectl get services --namespace <namespace_name>
![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
