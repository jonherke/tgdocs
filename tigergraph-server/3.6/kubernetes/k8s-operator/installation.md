...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/kubernetes/pages/k8s-operator/installation.adoc)
### Contents
  * [1. Prerequisites](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_prerequisites)
  * [2. Procedure](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_procedure)
  * [2.1. Install the TigerGraph kubectl plugin](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_install_the_tigergraph_kubectl_plugin)
  * [2.2. Initialize TigerGraph Kubernetes Operator](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_initialize_tigergraph_kubernetes_operator)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_prerequisites)1. Prerequisites
  ...
  * [cert-manager is installed on your Kubernetes cluster](https://cert-manager.io/docs/installation/kubectl/).
  * If you are pulling from a private registry, configure your cluster for access to the registry. You can do this by [creating a Secret](https://kubernetes.io/docs/concepts/configuration/secret/#creating-a-secret) and [using it as a container environment variable](https://kubernetes.io/docs/concepts/configuration/secret/#use-case-as-container-environment-variables).


## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_procedure)2. Procedure
### [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_install_the_tigergraph_kubectl_plugin)2.1. Install the TigerGraph `kubectl` plugin
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_initialize_tigergraph_kubernetes_operator)2.2. Initialize TigerGraph Kubernetes Operator
...
If you are using a private helm repository, replace `http://docker.tigergraph.com[](http://docker.tigergraph.com)` with the URL of your repository, and supply the name of your Secret:
```
