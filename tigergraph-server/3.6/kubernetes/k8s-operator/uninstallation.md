...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/kubernetes/pages/k8s-operator/uninstallation.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation#_prerequisites)
  * [Procedure](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation#_procedure)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation#_prerequisites)Prerequisites
  * You have [installed the TigerGraph plugin](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation#_install_the_tigergraph_kubectl_plugin) for the `kubectl` command-line tool.
  * You have configured `kubectl` for access to your Kubernetes cluster.


## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/uninstallation#_procedure)Procedure
