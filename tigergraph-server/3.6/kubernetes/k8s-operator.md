...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/kubernetes/pages/k8s-operator/index.adoc)
### Contents
  * [Getting started](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/#_getting_started)
  * [Supported cloud platforms](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/#_supported_cloud_platforms)
...
This feature is in the preview stage and should not be used in production.   
---  
The TigerGraph Kubernetes Operator provides native integration of TigerGraph Server with Kubernetes. It enables you to automate TigerGraph operations such as the creation, status checking and deletion of TigerGraph clusters.
...
The Operator provides the following features:
  * [Cluster provisioning](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_create_tigergraph_clusters)
  * [Cluster deletion](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_delete_tigergraph_clusters)
  * [Listing clusters](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_list_tigergraph_clusters)
  * [Checking cluster status](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_check_cluster_status)


## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/#_getting_started)Getting started
Install the Operator and provision your first cluster using the Operator to get started:
  * [Installing TigerGraph Kubernetes Operator](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/installation)
  * [Create clusters](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/cluster-operations#_create_tigergraph_clusters)


## [](https://docs.tigergraph.com/tigergraph-server/3.6/kubernetes/k8s-operator/#_supported_cloud_platforms)Supported cloud platforms
...
Known issue: If you provision a Kubernetes cluster with the Operator on AWS Elastic Kubernetes Service (EKS), you may experience issues logging into GraphStudio.   
---  
