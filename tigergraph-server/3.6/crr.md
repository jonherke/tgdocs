...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/crr/)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/crr/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/crr/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/crr/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/crr/pages/index.adoc)
### Contents
  * [Use cases](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_use_cases)
  * [What is included](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_what_is_included)
  * [Exclusions](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_exclusions)
  * [CRR logic](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_crr_logic)
  * [Procedures](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_procedures)
  * [FAQ](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_faq)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_use_cases)Use cases
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_what_is_included)What is included
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_exclusions)Exclusions
...
A "replica" in Kafka topic context is the committed operation of a write transaction ( `CREATE VETEX Person`) that happened successfully on the primary. Every replica has a unique identification which is consistent between primary and DR. Kafka MirrorMaker is a stand-alone tool (out-of-the-box from TigerGraph) for copying data between two Kafka, in this specific case between primary Kafka and DR Kafka.  
---  
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_procedures)Procedures
  * [Set Up Cross-Region Replication](https://docs.tigergraph.com/tigergraph-server/3.6/crr/set-up-crr)
  * [Fail over to the DR cluster](https://docs.tigergraph.com/tigergraph-server/3.6/crr/fail-over)
  * [Troubleshooting for Cross-Region Replication](https://docs.tigergraph.com/tigergraph-server/3.6/crr/troubleshooting)


## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/#_faq)FAQ
See [FAQ](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq) for frequently asked questions about CRR.
