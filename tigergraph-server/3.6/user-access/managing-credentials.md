...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/user-access/pages/managing-credentials.adoc)
### Contents
  * [Passwords](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_passwords)
  * [ACL passwords](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_acl_passwords)
  * [Secrets](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_secrets)
  * [Create a secret](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_create_a_secret)
  * [List secrets](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_list_secrets)
  * [Drop a secret](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_drop_a_secret)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_passwords)Passwords
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_acl_passwords)ACL passwords
Users have the option of [setting an ACL password](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/acl-management#_set_acl_password). When a user has an ACL password, operations that modify ACL privileges of queries owned by the user requires the ACL password. These operations include:
  * Changing the owner of a query
  * Modifying the ACL privileges on a query


## [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_secrets)Secrets
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_create_a_secret)Create a secret
```
CREATE SECRET [<alias>]
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
#### [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_required_privilege)Required privilege
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_list_secrets)List secrets
```
SHOW SECRET
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
### [](https://docs.tigergraph.com/tigergraph-server/3.6/user-access/managing-credentials#_drop_a_secret)Drop a secret
```
DROP SECRET <secret>
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
