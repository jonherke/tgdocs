...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq)[Next](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/3.6/modules/crr/pages/faq.adoc)
### Contents
  * [How can I check if data is replicated between primary and DR?](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_how_can_i_check_if_data_is_replicated_between_primary_and_dr)
  * [Why am I not seeing any loading job declared in DR?](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_why_am_i_not_seeing_any_loading_job_declared_in_dr)
  * [I’ve run a DROP ALL on primary and now new added data is not replicated in DR](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_ive_run_a_drop_all_on_primary_and_now_new_added_data_is_not_replicated_in_dr)
  * [GSQL is failing to replay a replica, and it’s reporting UNAUTHORIZED error?*](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_gsql_is_failing_to_replay_a_replica_and_its_reporting_unauthorized_error)
  * [What happens if DR is down, unavailable or under scheduled maintenance (e.g. VM Motion)?](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_what_happens_if_dr_is_down_unavailable_or_under_scheduled_maintenance_e_g_vm_motion)
  * [Can I have multiple DRs?](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_can_i_have_multiple_drs)
  * [Is failover to DR automatic?](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_is_failover_to_dr_automatic)
  * [Q: How will my application write to the new primary after DR failover?](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_q_how_will_my_application_write_to_the_new_primary_after_dr_failover)
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_how_can_i_check_if_data_is_replicated_between_primary_and_dr)How can I check if data is replicated between primary and DR?
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_why_am_i_not_seeing_any_loading_job_declared_in_dr)Why am I not seeing any loading job declared in DR?
Loading jobs are not replicated over DR, however, the data loaded by these loading jobs is replicated over DR.
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_ive_run_a_drop_all_on_primary_and_now_new_added_data_is_not_replicated_in_dr)I’ve run a `DROP ALL` on primary and now new added data is not replicated in DR
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_gsql_is_failing_to_replay_a_replica_and_its_reporting_unauthorized_error)GSQL is failing to replay a replica, and it’s reporting UNAUTHORIZED error?*
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_what_happens_if_dr_is_down_unavailable_or_under_scheduled_maintenance_e_g_vm_motion)What happens if DR is down, unavailable or under scheduled maintenance (e.g. VM Motion)?
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_can_i_have_multiple_drs)Can I have multiple DRs?
...
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_is_failover_to_dr_automatic)Is failover to DR automatic?
No, failover to DR is a manual operation.
## [](https://docs.tigergraph.com/tigergraph-server/3.6/crr/faq#_q_how_will_my_application_write_to_the_new_primary_after_dr_failover)Q: How will my application write to the new primary after DR failover?
