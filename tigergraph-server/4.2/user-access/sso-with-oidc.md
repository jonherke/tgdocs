...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [SSO with OIDC](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc)


[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/user-access/pages/sso-with-oidc.adoc)
### Contents
  * [Overview](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc#_overview)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/sso-with-oidc#_overview)Overview
