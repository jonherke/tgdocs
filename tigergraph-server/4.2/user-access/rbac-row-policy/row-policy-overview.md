...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/user-access/pages/rbac-row-policy/row-policy-overview.adoc)
### Contents
  * [User Guide](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_user_guide)
  * [Object-Based Privilege Tables](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_object_based_privilege_tables)
  * [Row Policy EBNF](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_row_policy_ebnf)
  * [Row Policy Limitations](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_row_policy_limitations)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_user_guide)User Guide
The row policy user guide has two parts:
  1. [RBAC: Row Policy Key Concepts](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/rbac-row-policy) - Learn the key concepts and features that make up row policy.
  2. [Set Up Row Policy](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/setup-row-policy) - Learn how to setup a basic row policy using an example dataset.


## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_object_based_privilege_tables)[Object-Based Privilege Tables](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-privileges-table)
Here you can find the Object-Based privilege tables for reference.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_row_policy_ebnf)[Row Policy EBNF](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-ebnf)
Here you can find the row policy EBNF examples for reference.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/rbac-row-policy/row-policy-overview#_row_policy_limitations)Row Policy Limitations
  ...
  * Statistics data will not be affected by row policies:
    ...
    * Commands that are related to built-in functions on graph, such as:
      ...
      * [RESTPP and Informant Built-in Endpoints](https://docs.tigergraph.com/tigergraph-server/4.2/API/built-in-endpoints).
  * Upsert-related operations are not regulated by row policies:
    * GSQL Query: For both installed query and interpret query, top level and dml-level [INSERT INTO](https://docs.tigergraph.com/gsql-ref/4.2/querying/data-modification-statements#_insert_into_statement) statement.
    * REST API `POST /graph/{graph_name}` [Upsert data to graph](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest)
    * Loading job: (file loading and kafka loading) loading an existing vertex with new attribute value.
    * REST API `POST /ddl`: (for spark loading job) loading an existing vertex with new attribute value. [API:built-in-endpoints.adoc#_run_a_loading_job](https://docs.tigergraph.com/tigergraph-server/4.2/API/built-in-endpoints#_run_a_loading_job)
