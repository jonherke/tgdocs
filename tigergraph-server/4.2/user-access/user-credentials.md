...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/user-access/pages/user-credentials.adoc)
### Contents
  * [Passwords](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_passwords)
  * [Secrets](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_secrets)
  * [Create a secret](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_create_a_secret)
  * [List secrets](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_list_secrets)
  * [Drop secret](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_drop_secret)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_passwords)Passwords
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_secrets)Secrets
...
---  
### [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_create_a_secret)Create a secret
Use GSQL Command:
```
CREATE SECRET [<alias>]
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_required_privilege)Required privilege
No privilege is required to create secrets for oneself. The superuser role is needed to create secrets for other users.
### [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_list_secrets)List secrets
Use GSQL Command:
```
SHOW SECRET
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
---  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_required_privilege_2)Required privilege
No privilege is required to create secrets for oneself. The superuser role is needed to create secrets for other users.
### [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_drop_secret)Drop secret
Use GSQL Command:
```
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/user-credentials#_required_privilege_3)Required privilege
No privilege is required to create secrets for oneself. The superuser role is needed to create secrets for other users.
