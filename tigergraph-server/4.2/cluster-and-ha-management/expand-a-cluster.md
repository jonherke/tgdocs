...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/cluster-and-ha-management/pages/expand-a-cluster.adoc)
### Contents
  * [1. Before you begin](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_before_you_begin)
  * [2. Procedure](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_procedure)
  * [2.1. Identify new cluster replication and partition](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_identify_new_cluster_replication_and_partition)
  * [2.2. Expand the cluster](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_expand_the_cluster)
  * [2.3. Verify success and delete temporary files](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_verify_success_and_delete_temporary_files)
...
Expanding a cluster adds more nodes to the cluster. During the expansion, the cluster’s data is redistributed across the expanded cluster. You can also change replication factor or enable [region-awareness](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/region-aware) during an expansion.
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_before_you_begin)1. Before you begin
...
---  
  ...
  * If the original cluster is a single node installation, make sure the IP used is not a [local loopback address](https://en.wikipedia.org/wiki/Localhost) such as 127.0.0.1.
...
$ gadmin restart all -y![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
```
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_procedure)2. Procedure
### [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_identify_new_cluster_replication_and_partition)2.1. Identify new cluster replication and partition
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_expand_the_cluster)2.2. Expand the cluster
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_supply_a_staging_location)2.2.1. Supply a staging location
...
For example, assume you are expanding from a 6-node cluster with a replication factor of 2 and a partitioning factor of 3, to a 10-node cluster with a replication factor of 2 and a partitioning factor of 5, and the size of the data root folder on a node is 50GB. You would need more than `(1 + ceiling(3/5)) * 50) = 100 GB` of free space on the staging path.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_configure_region_awareness)2.2.2. Configure region awareness
If you need to enable [region-aware](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/region-aware), the format of `node_ip_list` needs to include region information.
  * Enable Region Aware
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/expand-a-cluster#_verify_success_and_delete_temporary_files)2.3. Verify success and delete temporary files
