...
Table 1. Example, Service deployments without region-aware Service | Nodes  
---|---  
...
Table 2. Example, Service deployments with region-aware Service | Nodes  
---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/region-aware#_compare_to_crr)Compare to CRR
Region-Awareness **is not** [Cross-Region Replication](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-index).
Both Region-Aware and CRR can increase your system availability, but they are designed for different purpose.
Table 3. Differences between Region-Aware and CRR **Region-Aware** | **CRR**  
---|---  
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/region-aware#_system_requirements)System Requirements
To enable region-aware, the following conditions must be met  
---  
  * Eligible for [High Availability Cluster](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-cluster#_system_requirements)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/region-aware#_disable_region_aware)Disable Region Aware
