...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/cluster-and-ha-management/pages/crr-faq.adoc)
### Contents
  * [How can I verify if data is replicated between primary and Disaster Recovery (DR) clusters?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_how_can_i_verify_if_data_is_replicated_between_primary_and_disaster_recovery_dr_clusters)
  * [Why am I not seeing any loading job declared in the DR cluster?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_why_am_i_not_seeing_any_loading_job_declared_in_the_dr_cluster)
  * [What happens after I run DROP ALL on primary?.](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_what_happens_after_i_run_drop_all_on_primary)
  * [Why is GSQL failing to replay a replica with an "UNAUTHORIZED" error?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_why_is_gsql_failing_to_replay_a_replica_with_an_unauthorized_error)
  * [What happens if DR is down, unavailable or under scheduled maintenance (e.g. VM Motion)?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_what_happens_if_dr_is_down_unavailable_or_under_scheduled_maintenance_e_g_vm_motion)
  * [Can I have multiple DRs?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_can_i_have_multiple_drs)
  * [Is failover to DR automatic?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_is_failover_to_dr_automatic)
  * [How will my application write to the new primary after DR failover?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_how_will_my_application_write_to_the_new_primary_after_dr_failover)
  * [Is CRR replication synchronous or asynchronous?](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_is_crr_replication_synchronous_or_asynchronous)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_how_can_i_verify_if_data_is_replicated_between_primary_and_disaster_recovery_dr_clusters)How can I verify if data is replicated between primary and Disaster Recovery (DR) clusters?
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_why_am_i_not_seeing_any_loading_job_declared_in_the_dr_cluster)Why am I not seeing any loading job declared in the DR cluster?
Loading jobs themselves are not replicated to the DR cluster. However, the data loaded by these loading jobs is replicated.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_what_happens_after_i_run_drop_all_on_primary)What happens after I run `DROP ALL` on primary?.
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_why_is_gsql_failing_to_replay_a_replica_with_an_unauthorized_error)Why is GSQL failing to replay a replica with an "UNAUTHORIZED" error?
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_what_happens_if_dr_is_down_unavailable_or_under_scheduled_maintenance_e_g_vm_motion)What happens if DR is down, unavailable or under scheduled maintenance (e.g. VM Motion)?
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_can_i_have_multiple_drs)Can I have multiple DRs?
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_is_failover_to_dr_automatic)Is failover to DR automatic?
No, failover to DR is a manual operation.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_how_will_my_application_write_to_the_new_primary_after_dr_failover)How will my application write to the new primary after DR failover?
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-faq#_is_crr_replication_synchronous_or_asynchronous)Is CRR replication synchronous or asynchronous?
