...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/cluster-and-ha-management/pages/ha-overview.adoc)
### Contents
  * [HA Considerations](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_ha_considerations)
  * [3.9.2 and Below](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_3_9_2_and_below)
  * [High Availability Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_high_availability_cluster_configuration)
  * [Region Aware Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_region_aware_cluster_configuration)
  * [High Availability Support for GSQL Server](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_high_availability_support_for_gsql_server)
  * [High Availability Support for Application Server](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_high_availability_support_for_application_server)
  * [Cluster Commands](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_cluster_commands)
  * [Removal of Failed Nodes](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_removal_of_failed_nodes)
  * [File and Kafka loaders HA with Auto-Restart](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_file_and_kafka_loaders_ha_with_auto_restart)
...
Incorporating HA can yield a number of other system benefits, such as:
  * The query workload is distributed across all replicas.
    * This includes replicas used for long-running queries or with the [GSQL-REPLICA](https://docs.tigergraph.com/tigergraph-server/4.2/API/built-in-endpoints#_headers) header.
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_ha_considerations)HA Considerations
...
As a workaround, if the failed node cannot be recovered (e.g. hardware issue), full operation can be restored temporarily by the [removal of the failing nodes](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/remove-failed-node). For example, a 5 x 2 cluster with one node removed would become a 4x2 + 1, where 1 is the data partition that is not being replicated.   
---  
### [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_3_9_2_and_below)3.9.2 and Below
...
In this case, as with the other consideration cases above, the failed node needs to be [removed](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/remove-failed-node) from the cluster via:
```
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_high_availability_cluster_configuration)[High Availability Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-cluster)
Here you will find detailed information about terminology, system requirements, and how to configure an HA cluster.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_region_aware_cluster_configuration)[Region Aware Cluster Configuration](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/region-aware)
Learn how to configure a high available cluster that can tolerate region-level failures.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_high_availability_support_for_gsql_server)[High Availability Support for GSQL Server](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-for-gsql-server)
Learn how TigerGraph incorporates built-in HA for all the internal critical components.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_high_availability_support_for_application_server)[High Availability Support for Application Server](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-for-application-server)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_cluster_commands)[Cluster Commands](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/cluster-commands)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_removal_of_failed_nodes)[Removal of Failed Nodes](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/remove-failed-node)
Here you find detailed Instructions for the removal of a failed node.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview#_file_and_kafka_loaders_ha_with_auto_restart)File and Kafka loaders HA with Auto-Restart
Loading jobs for [Kafka](https://docs.tigergraph.com/tigergraph-server/4.2/data-loading/load-from-kafka) and [Local Files](https://docs.tigergraph.com/tigergraph-server/4.2/data-loading/load-local-files) will automatically restart the loader job process if it unexpectedly exits. And will then continue to import data from the loading job.
...
If not set, the default value is 20; `LoaderRetryMax=20`. Additionally, the current limit on how many times the loading job will be restarted after a failure is up to 20 times.  
---  
