...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/installation/pages/license.adoc)
### Contents
  * [System-Specific License Activation](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_system_specific_license_activation)
  * [Step-by-Step Guide](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_step_by_step_guide)
  * [Checking License Information](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_checking_license_information)
  * [Usage Limits Controlled by License Key](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_usage_limits_controlled_by_license_key)
  * [Configuring License Key Checks](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_configuring_license_key_checks)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_system_specific_license_activation)System-Specific License Activation
...
---  
### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_step_by_step_guide)Step-by-Step Guide
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_checking_license_information)Checking License Information
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_usage_limits_controlled_by_license_key)Usage Limits Controlled by License Key
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/license#_configuring_license_key_checks)Configuring License Key Checks
There are several configuration parameters available for system adminstrators to customize the policy used to check compliance with the license key’s limit for stored data size. See the [GSE](https://docs.tigergraph.com/tigergraph-server/4.2/reference/configuration-parameters#_gse) section of the Configuration Parameters page.
