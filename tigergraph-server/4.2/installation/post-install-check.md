...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/installation/pages/post-install-check.adoc)
### Contents
  * [Check SSH connectivity between the TigerGraph nodes](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_check_ssh_connectivity_between_the_tigergraph_nodes)
  * [Port check](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_port_check)
  * [For services port check](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_for_services_port_check)
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_check_ssh_connectivity_between_the_tigergraph_nodes)Check SSH connectivity between the TigerGraph nodes
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_port_check)Port check
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_for_services_port_check)For services port check
```
#!/bin/bash
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_usage)Usage
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_dynamic_port_check)Dynamic port check
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/installation/post-install-check#_usage_2)Usage
