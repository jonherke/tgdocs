...
### Contents
  ...
  * [create one graph using gsql command](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_one_graph_using_gsql_command)
  ...
  * [revoke datasource](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_revoke_datasource)
  ...
  * [check status of asynchronous request with requestId](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_check_status_of_asynchronous_request_with_requestid)
  ...
  * [show all roles](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_show_all_roles)
  ...
  * [delete one tuple](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_one_tuple)
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_show_vertices)show vertices
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_a_vertex)drop a vertex
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_edges_using_gsql_command_statement)create edges using gsql command statement
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_run_global_schema_change_job_directly)run global schema change job directly
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_run_an_existing_schema_change_job)run an existing schema change job
`POST /gsql/v1/schema/jobs/{jobName}`
Run an existing schema change job.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_35)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | which graph to run the schema change job on. If not provided, means run the global schema change job.  
`force` | no | If true, abort any loading jobs which have a schema conflict with this change. See [Run Schema Change options](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/modifying-a-graph-schema#_run_schema_change_options).  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_35)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_schema_change_jobs)get schema change jobs
`GET /gsql/v1/schema/jobs`
Get all local/global schema change jobs.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_36)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_36)Example: 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_loading_jobs)Loading Jobs
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_loading_job_names)Get loading job names
`GET /gsql/v1/loading-jobs`
Get the names of all loading jobs in the given graph.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_37)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that these jobs belong to  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_37)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_loading_job_information)Get loading job information
`GET /gsql/v1/loading-jobs/{jobName}`
Get information about a specific loading job.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_38)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_38)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_a_loading_job)Create a loading job
`POST /gsql/v1/loading-jobs`
Create a new loading job, equivalent to GSQL [CREATE LOADING JOB](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/creating-a-loading-job#_create_loading_job).
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_39)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that this job will belong to  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_39)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_update_a_loading_job)Update a loading job
`PUT /gsql/v1/loading-jobs`
Update an existing loading job.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_40)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that this job belongs to  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_40)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_a_loading_job)Drop a loading job
`DELETE /gsql/v1/loading-jobs/{jobName}`
Drop a loading job, equivalent to GSQL [DROP JOB](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/creating-a-loading-job#_drop_job_statement).
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_41)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that this job belongs to  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_41)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_run_a_loading_job)Run a loading job
`POST /gsql/v1/loading-jobs/run`
Run a loading job, equivalent to GSQL [RUN LOADING JOB](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/running-a-loading-job#_run_loading_job).
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_42)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that this job belongs to  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_42)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_loading_job_run_statuses_multiple_jobs)Get loading job run statuses (multiple jobs)
`GET /gsql/v1/loading-jobs/status`
Get the status of one or more loading jobs that have been started, equivalent to GSQL [SHOW LOADING STATUS](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/managing-loading-job#_show_loading_status).
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_43)Parameters:
Name | Required | Description  
---|---|---  
`jobIds` | yes | ID of the loading job  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_43)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_loading_job_run_status_one_job)Get loading job run status (one job)
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_44)Parameters:
Name | Required | Description  
---|---|---  
`jobId` | yes | ID of the loading job  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_44)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_abort_loading_jobs)Abort loading job(s)
`GET /gsql/v1/loading-jobs/abort`
Abort one or more loading jobs, equivalent to GSQL [ABORT LOADING JOB](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/managing-loading-job#_abort_loading_job).
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_45)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that this job belongs to  
`jobIds` | yes | ID of one of the loading jobs  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_45)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_abort_one_loading_job)Abort one loading job
`GET /gsql/v1/loading-jobs/abort/{jobId}`
Abort one loading job, equivalent to GSQL [ABORT LOADING JOB](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/managing-loading-job#_abort_loading_job). The behavior of this endpoint is the same as that of `GET /gsql/v1/loading-jobs/abort/` when only one `jobIds` parameter is used.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_46)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | name of the graph that this job belongs to  
`jobId` | yes | ID of the loading job  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_46)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_resume_loading_job)Resume loading job
`GET /gsql/v1/loading-jobs/resume/{jobId}`
Resume a paused/aborted loading job, equivalent to GSQL [RESUME LOADING JOB](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/managing-loading-job#_resume_loading_job).
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_47)Parameters:
Name | Required | Description  
---|---|---  
`jobId` | yes | ID of the loading job  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_47)Example 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_data_source)Data source
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_a_data_source)get a data source
`GET /gsql/v1/data-sources/{dsName}`
Get a data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_48)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_48)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_all_data_sources)get all data sources
`GET /gsql/v1/data-sources`
Get all data sources.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_49)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_49)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_update_a_data_source)update a data source
`PUT /gsql/v1/data-sources`
Update a data source .
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_50)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | the graph whose data source to update. If not provided, means to update a global data source.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_50)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_data_source)create data source
`POST /gsql/v1/data-sources`
Create a data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_51)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | the graph whose data source to create. If not provided, means to create a global data source.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_51)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_one_data_source)drop one data source
`DELETE /gsql/v1/data-sources/{dsName}`
Drop one data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_52)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | the graph whose data source to delete. If not provided, means to delete a global data source.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_52)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_grant_one_data_source)grant one data source
`POST /gsql/v1/data-sources/grant`
Grant one data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_53)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_53)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_revoke_datasource)revoke datasource
`POST /gsql/v1/data-sources/revoke`
Revoke data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_54)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_54)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_all_data_source)drop all data source
`DELETE /gsql/v1/data-sources/dropAll`
Drop all data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_55)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | If given, will delete all the data sources used by this graph. otherwise will delete all the global data sources.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_55)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_the_sample_data_of_s3_file_uris_or_local_files)get the sample data of S3 file.uris or local files
`POST /gsql/v1/sample-data`
Get the sample data of S3 file.uris or local files.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_56)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_56)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_all_buckets_of_given_s3_data_source)get all buckets of given S3 data source
`GET /gsql/v1/list-buckets/{s3Name}`
Get all buckets of given S3 data source.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_57)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_57)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_all_files_and_directories_under_given_s3_bucket_path)get all files and directories under given S3 bucket path
`GET /gsql/v1/list-files/{s3Name}`
Get all files and directories under given S3 bucket path.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_58)Parameters:
Name | Required | Description  
---|---|---  
`path` | no | Uri of the data source. If not provide, list files under `/`  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_58)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_schema_information_from_a_snowflake_data_source)get schema information from a Snowflake data source
`GET /gsql/v1/metadata/data-sources/{dsName}`
Get schema information from a Snowflake data source. `{dsPath}` is the name of a previously created Snowflake data source object.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_query_parameters)Query Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_59)Example: 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_query)Query
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_install_queries)install queries
`GET /gsql/v1/queries/install`
This api is used for installing queries
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_59)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_60)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_check_query_install_status)check query install status
`GET /gsql/v1/queries/install/{requestId}`
This api is used for checking query install status
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_61)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_list_query_names)list query names
`GET /gsql/v1/queries`
Get all query names of a graph.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_62)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_query)create query
`POST /gsql/v1/queries`
Create a query.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_60)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | the query created under which graph  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_63)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_query)drop query
`DELETE /gsql/v1/queries`
Drop quries.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_61)Parameters:
Name | Required | Description  
---|---|---  
`query` | yes | the queries to be dropped  
`graph` | yes | the queries dropped under which graph  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_64)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_query_content)get query content
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_62)Parameters:
Name | Required | Description  
---|---|---  
`queryName` | yes | the content of which query  
`graph` | yes | the query under which graph  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_65)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_run_query)run query
`POST /gsql/v1/queries/{queryName}`
The endpoint is used to run a query by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_endpoint_parameters)Endpoint Parameters:
Name | Required | Description  
---|---|---  
`queryName` | yes | the query to run  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_format_for_parameters_of_query_being_run)Format for Parameters of Query Being Run
...
List/set/bag of values |  JSON array: `[value, value, value]` | `"input": [3,4,2,2]`  
Map of values |  Divide the map in an ordered list of keys and a correspondingly ordered list of values: JSON object containing a `"valuelist"` object and a `"keylist"` object | `"input":{"keylist":[49,50], "valuelist":["Alaska","Hawaii"]}}`  
If you are passing parameters in the inline body/payload of a POST request, you may need to escape the quotation marks in the JSON structure, e.g., ```
-d "{\"input\":[3,4,2,2]}"
```
  
---  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_66)Example
Sample Query:
```
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_one_query)drop one query
`DELETE /gsql/v1/queries/{queryName}`
Drop a query by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_63)Parameters:
Name | Required | Description  
---|---|---  
`queryName` | yes | the query to drop  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_67)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_interpret_query)interpret query
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_64)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | the query interpreted under which graph  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_headers)Headers:
Name | Required | Description  
---|---|---  
`workload_queue_name` | optional | the workload queue name  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_68)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_query_info)get query info
`GET /gsql/v1/queries/info`
Get the query’s information.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_65)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | the query under which graph  
`query` | no | the query name  
`status` | no | the query status  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_69)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_query_signature)get query signature
`GET /gsql/v1/queries/signature`
Get query’s signature by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_66)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | the query under which graph  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_70)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_query_semantic_check)query semantic check
`POST /gsql/v1/internal/check/query`
Perform a semantic check of a query.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_71)Example 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_template_query)Template query
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_all_package_names)get all package names
`GET /gsql/v1/packages`
Get all package names.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_72)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_package_content)get package content
`GET /gsql/v1/package/{packageName}`
Get package by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_73)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_package)create package
`POST /gsql/v1/package/{packageName}`
Create package.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_74)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_package)drop package
`DELETE /gsql/v1/package/{packageName}`
Drop package by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_75)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_function)create function
`POST /gsql/v1/package/function`
Create function
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_76)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_function)delete function
`DELETE /gsql/v1/package/{functionName}`
Delete function by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_77)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_template_query)create template query
`POST /gsql/v1/package/template`
Create template query.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_78)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_template_query)drop template query
`DELETE /gsql/v1/package/template/{queryName}`
Drop template query.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_79)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_import_package)import package
`POST /gsql/v1/package/import/{packageName}`
Import package.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_80)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_call_template_query)call template query
`POST /gsql/v1/library/{functionName}`
Call template query.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_67)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | the function under which graph  
`functionName` | yes | the function name to call  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_81)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_template_query_info)get template query info
`GET /gsql/v1/library/{functionName}`
Get template query’s information.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_68)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_82)Example 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_database_utilities)Database Utilities
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_generic_endpoint_to_execute_any_gsql_command)generic endpoint to execute any GSQL command
`POST /gsql/v1/statements`
Execute any GSQL command asynchronously or synchronously.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_69)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_83)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_check_status_of_asynchronous_request_with_requestid)check status of asynchronous request with requestId
`GET /gsql/v1/statements/{requestId}`
Check status of asynchronous request with requestId.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_70)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_84)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_cancel_an_asynchronous_request_with_requestid)cancel an asynchronous request with requestId
`PUT /gsql/v1/statements/{requestId}/cancel`
Cancel an asynchronous request with requestId.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_71)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_85)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_recover_gdict_catalog)recover gdict catalog
`POST /gsql/v1/schema/recover`
Recover catalog.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_72)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_86)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_validate_graph_schema)validate graph schema
`POST /gsql/v1/schema/check`
Check that a schema is valid.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_73)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_87)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_clear_graph_store)clear graph store
...
---  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_88)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_gsql_version)get gsql version
`GET /gsql/v1/version`
This endpoint used for get the gsql version infomation.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_74)Parameters:
Name | Required | Description  
---|---|---  
`verbose` | no | `bool` type, `true` will print detail info.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_89)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_all)drop all
`GET /gsql/v1/drop-all`
Drop all.
This operation is not reversible. The deleted data cannot be recovered.  
---  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_90)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_graph_export)graph export
`POST /gsql/v1/db-export`
Export database.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_91)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_graph_import)graph import
`POST /gsql/v1/db-import`
Import database.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_92)Example 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_security)Security
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_new_jwt_token)create new JWT token
`POST /gsql/v1/tokens`
Create a new JWT token.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_payload)Payload:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_93)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_jwt_tokens)drop JWT tokens
`DELETE /gsql/v1/tokens`
Drop specific a list of tokens.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_75)Parameters:
Name | Required | Description  
---|---|---  
`clear` | no | default: false, true means clear out the current block list.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_94)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_check_jwt_token)check JWT token
`POST /gsql/v1/tokens/check`
Check JWT token is valid or not.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_95)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_secret)create secret
`POST /gsql/v1/secrets`
Create a secret.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_76)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_96)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_show_secrets)show secrets
`GET /gsql/v1/secrets`
Show secrets for the user.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_77)Parameters:
Name | Required | Description  
---|---|---  
`userName` | no | the user who wants to show the secrets. The default user is the logged-in user if not specified.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_97)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_secrets)delete secrets
`DELETE /gsql/v1/secrets`
Delete the secrets of the user.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_78)Parameters:
Name | Required | Description  
---|---|---  
`userName` | no | the user who wants to delete the secrets. The default user is the logged-in user if not specified.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_98)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_secret_by_alias)get secret by alias
`GET /gsql/v1/secrets/{alias}`
Get the secrets by its alias name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_79)Parameters:
Name | Required | Description  
---|---|---  
`userName` | no | the user who wants to get the secret. The default user is the logged-in user if not specified.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_99)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_secret_by_alias)drop secret by alias
`DELETE /gsql/v1/secrets/{alias}`
Delete the secret of the user by its alias name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_80)Parameters:
Name | Required | Description  
---|---|---  
`userName` | no | the user who wants to delete the secret. The default user is the logged-in user if not specified.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_100)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_a_group_by_id_using_gsql_format)retrieve a group by id using gsql format
`GET /gsql/v1/groups/{id}`
Retrieve a group by id response scim format or gsql format JSON.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_81)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_101)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_groups_using_gsql_format)retrieve groups using gsql format
`GET /gsql/v1/groups`
Retrieve groups response gsql format JSON.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_82)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_102)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_a_group_using_gsql_format)create a group using gsql format
`POST /gsql/v1/groups`
Create a group using gsql format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_83)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_103)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_update_a_group_using_gsql_format)update a group using gsql format
`PUT /gsql/v1/groups`
Update a group.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_84)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_104)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_one_group_by_name_using_gsql_format)drop one group by name using gsql format
`DELETE /gsql/v1/groups/{id}`
Drop one group by name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_85)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_105)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_groups_using_gsql_format)drop groups using gsql format
`POST /gsql/v1/groups`
Drop groups.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_86)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_106)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_a_user_by_id_using_gsql_format)retrieve a user by id using gsql format
`GET /gsql/v1/users/{id}`
Retrieve a user by id respond gsql format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_87)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_107)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_update_an_user_using_gsql_format)update an user using gsql format
`PUT /gsql/v1/users`
Update a user.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_88)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_108)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_users_for_gsql_format)drop users for gsql format
`POST /gsql/v1/users`
Drop users.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_89)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_109)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_a_user_using_gsql_format)drop a user using gsql format
`DELETE /gsql/v1/users/{id}`
Drop a user.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_90)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_110)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_a_user_using_gsql_format)create a user using gsql format
`POST /gsql/v1/users`
Create a user using gsql format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_91)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_111)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_users_using_gsql_format)retrieve users using gsql format
`GET /gsql/v1/users`
Retrieve users response gsql format JSON.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_92)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_112)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_show_all_privileges)show all privileges
`GET /gsql/v1/privileges`
List all built-in privileges.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_113)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_grant_privileges_to_roles)grant privilege(s) to role(s)
`POST /gsql/v1/privileges/grant`
Grant RABC privileges to specific roles.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_93)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_114)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_revoke_privileges_from_roles)revoke privilege(s) from role(s)
`POST /gsql/v1/privileges/revoke`
Revoke RABC privileges from specific roles
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_94)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_115)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_show_all_roles)show all roles
`GET /gsql/v1/roles`
Call this endpoint to show all roles, including built-in roles and user defined roles.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_116)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_roles)Create roles
`POST /gsql/v1/roles`
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_95)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | in which graph to create local roles, or create global roles if the parameter is missing  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_117)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_roles)Delete roles
`DELETE /gsql/v1/roles`
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_96)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_118)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_show_one_role)show one role
`GET /gsql/v1/roles/{roleName}`
Call this endpoint to show the info of a specific role.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_119)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_one_role)delete one role
`DELETE /gsql/v1/roles/{roleName}`
Call this endpoint to delete a specific role.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_120)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_grant_roles_to_users)grant role(s) to user(s)
`POST /gsql/v1/roles/grant`
Grant roles to specific users
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_97)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | in which graph the role(s) should be granted, or grant role(s) on global level if the parameter is missing  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_121)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_revoke_roles_from_users)revoke role(s) from user(s)
`POST /gsql/v1/roles/revoke`
Revoke roles from specific users
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_98)Parameters:
Name | Required | Description  
---|---|---  
`graph` | no | in which graph the role(s) should be revoked, or revoke role(s) on global level if the parameter is missing  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_122)Example: 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_scim_apis_for_usersgroups)SCIM APIs for users/groups
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_a_group_by_id_using_scim_format)retrieve a group by id using scim format
`GET /gsql/scim/v2/Groups/{id}`
Retrieve a group by id response scim format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_99)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_123)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_groups_using_scim_format)retrieve groups using scim format
`GET /gsql/scim/v2/Groups`
Retrieve groups response scim format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_100)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_124)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_a_group_using_scim_format)create a group using scim format
`POST /gsql/scim/v2/Groups`
Create a group using scim format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_101)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_125)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_update_a_group_using_scim_format)update a group using scim format
`PATCH /gsql/scim/v2/Groups/{id}`
Update a group.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_102)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_126)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_one_group_by_name_using_scim_format)drop one group by name using scim format
`DELETE /gsql/scim/v2/Groups/{id}`
Drop one group by name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_103)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_127)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_groups_using_scim_format)drop groups using scim format
`POST /gsql/scim/v2/Groups`
Drop groups.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_104)Parameters:
Name | Required | Description  
---|---|---  
`action` | no | The default value is `create`. Possible values are `create` and `delete`. `Delete` indicates dropping groups, while `create` indicates creating groups.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_128)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_a_user_by_id_using_scim_format)retrieve a user by id using scim format
`GET /gsql/scim/v2/Users/{id}`
Retrieve a user by id respond with scim format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_105)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_129)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_update_a_user_using_scim_format)update a user using scim format
`PUT /gsql/scim/v2/Users/{id}`
Update a user.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_106)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_130)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_users_using_scim_format)drop users using scim format
`POST /gsql/scim/v2/Users`
Drop users.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_107)Parameters:
Name | Required | Description  
---|---|---  
`action` | no | default: `create`. Possible values: `create`, `delete`. `delete` indicates to drop users; `create` indicates to create users. Here set the value `delete`.  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_131)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_drop_a_user_using_scim_format)drop a user using scim format
`DELETE /gsql/scim/v2/Users/{id}`
Drop a user.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_108)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_132)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_a_user_using_scim_format)create a user using scim format
`POST /gsql/scim/v2/Users`
Create a user using scim format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_109)Parameters:
None
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_133)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_retrieve_users_using_scim_format)retrieve users using scim format
`GET /gsql/scim/v2/Users`
Retrieve users response scim format.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_110)Parameters:
Name | Required | Description  
---|---|---  
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_134)Example: 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_statistics)Statistics
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_cardinality_statistics)get cardinality statistics
`GET /gsql/v1/stats/cardinality`
Fetch cardinality statistics.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_111)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | Get the cardinality stats of which graph  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_135)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_post_cardinality_statistics)post cardinality statistics
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_1_fetch_fresh_up_to_date_cardinality_statistics_and_persist_it_to_storage)1) Fetch fresh up-to-date cardinality statistics and persist it to storage
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_112)Parameters:
Name | Required | Description  
---|---|---  
...
##### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_136)Example: 
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_2_persist_user_defined_cardinality_statistics_to_storage)2) Persist user defined cardinality statistics to storage.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_113)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | Persist the cardinality stats to which graph  
##### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_137)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_cardinality_statistics)delete cardinality statistics
`DELETE /gsql/v1/stats/cardinality`
Remove cardinality statistics from storage.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_114)Parameters:
Name | Required | Description  
---|---|---  
`graph` | yes | Delete the cardinality stats of indicated graph from storage  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_138)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_histogram_statistics)get histogram statistics
`GET /gsql/v1/stats/histogram`
Fetch histogram statistics.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_139)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_post_histogram_statistics)post histogram statistics
`POST /gsql/v1/stats/histogram`
Persist new histogram statistics to storage.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_140)Example: 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_histogram_statistics)delete histogram statistics
`DELETE /gsql/v1/stats/histogram`
Remove histogram statistics from storage.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_141)Example: 
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_user_defined_objects)User Defined Objects
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_list_all_tuples)list all tuples
`GET /gsql/v1/udt/tuples`
Get all tuples.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_142)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_list_one_tuple)list one tuple
`GET /gsql/v1/udt/tuples/{tupleName}`
Get tuple by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_115)Parameters:
Name | Required | Description  
---|---|---  
`tupleName` | yes | the tuple name to get information  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_143)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_tuple)create tuple
`POST /gsql/udt/tuples`
Create a tuple.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_144)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_multiple_tuples)delete multiple tuples
`DELETE /gsql/v1/udt/tuples`
Delte multiple tuples.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_116)Parameters:
Name | Required | Description  
---|---|---  
`tupleName` | yes | the tuple names to be dropped  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_145)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_one_tuple)delete one tuple
`DELETE /gsql/v1/udt/tuples/{tupleName}`
Delete one tuple by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_146)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_list_all_accumulators)list all accumulators
`GET /gsql/v1/udt/accum`
Get all accumulators.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_147)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_list_one_accumulator)list one accumulator
`GET /gsql/v1/udt/accum/{accumName}`
Get one accumulator by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_148)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_create_accumulators)create accumulators
`POST /gsql/v1/udt/accum`
Create one accumulator.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_149)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_multiple_accumulators)delete multiple accumulators
`DELETE /gsql/v1/udt/accum`
Delete multiple accumulators.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_parameters_117)Parameters:
Name | Required | Description  
---|---|---  
`accumName` | yes | the accumulator names to drop  
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_150)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_one_accumulator)delete one accumulator
`DELETE /gsql/v1/udt/accum/{accumName}`
Delete one accumulator.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_151)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_download_user_defined_function_files)download user-defined function files
`GET /gsql/v1/udt/files/{fileName}`
Download one of the .hpp files for storing user-defined functions. {fileName} can be one of: [tg_]ExprFunctions, [tg_]ExprUtil, TokenBank.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_152)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_download_all_user_defined_function_files)download all user-defined function files
`GET /gsql/v1/udt/files`
Get all .hpp files used to store user-defined functions: [tg_]ExprFunction.hpp, [tg_]ExprUtil.hpp, TokenBank.hpp.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_153)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_upload_one_user_defined_function_file)upload one user-defined function file
`PUT /gsql/v1/udt/files/{fileName}`
Upload one of the .hpp files for storing user-defined functions. {fileName} can be one of: [tg_]ExprFunctions, [tg_]ExprUtil, TokenBank.
The file contents should be included in payload.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_154)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_upload_all_user_defined_function_files)upload all user-defined function files
`PUT /gsql/v1/udt/files`
Upload all .hpp files used to store user-defined functions: [tg_]ExprFunction.hpp, [tg_]ExprUtil.hpp, TokenBank.hpp.
See the example for the structure of the data payload.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_155)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_delete_udt_files)Remove user-defined function files
`DELETE /gsql/v1/udt/files`
Remove one or more of the .hpp files for storing user-defined functions. {fileName} accepts the following 5 filenames: [tg_]ExprFunctions, [tg_]ExprUtil, TokenBank. Use a comma-separated list to remove more than one file.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_156)Example 

Sample Request
    
```
curl -X DELETE 'localhost:14240/gsql/v1/udt/files?name=ExprFunctions,ExprUtil'
bash![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
```
{"error":false,"message":"Successfully removed the function files: [ExprFunctions, ExprUtil]."}
![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!

```

### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_token_bank_functions)get token bank functions
`GET /gsql/v1/udt/token-functions/{functionName}`
Get function content by its name.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_157)Example 
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_get_all_token_bank_functions)get all token bank functions
`GET /gsql/v1/udt/token-functions`
Get all token bank functions.
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/gsql-endpoints#_example_158)Example 
