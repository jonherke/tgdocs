...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/API/pages/upsert-rest.adoc)
### Contents
  * [Endpoint URL](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_endpoint_url)
  * [Parameters](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_parameters)
  * [Response](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_response)
  * [Request body](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_request_body)
  * [Examples](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_examples)
  * [Operation codes](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_operation_codes)
  * [Upserting vertices with composite keys](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_vertices_with_composite_keys)
  * [Upserting simple edges](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_simple_edges)
  * [Examples](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_examples_2)
  * [Upserting discriminated edges](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_discriminated_edges)
  * [Upserting Multi-Edges with Discriminators](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_multi_edges_with_discriminators)
  * [Rules for upserting edges with discriminators](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_rules_for_upserting_edges_with_discriminators)
  * [General rules for JSON formatting](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_general_rules_for_json_formatting)
  * [Valid data types](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_valid_data_types)
  * [Example](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_example)
  * [Atomic upsert transaction](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_atomic_upsert_transaction)
...
Upserting vertices or edges require the user to have sufficient privileges. See [Access Control Model in TigerGraph](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/access-control-model).
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_endpoint_url)Endpoint URL
`POST /graph/{graph_name}`
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_parameters)Parameters
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_response)Response
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_request_body)Request body
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_examples)Examples
...
Follow the instructions in the Introduction section to [format advanced data types](https://docs.tigergraph.com/tigergraph-server/4.2/API/#_formatting_data_in_json).
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_operation_codes)Operation codes
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_vertices_with_composite_keys)Upserting vertices with composite keys
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_simple_edges)Upserting simple edges
Simple edges are edges that do not have any discriminator attributes. These edges are uniquely defined by their source and target vertex IDs.
To upsert a simple edge, use the following JSON format:
```
{
 "edges": {
  "<source_vertex_type>": {
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_examples_2)Examples
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_discriminated_edges)Upserting discriminated edges
Edges with [discriminators](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/defining-a-graph-schema#_discriminator) allow multiple instances of the same edge type between two vertices, each distinguished by a unique discriminator attribute.
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_upserting_multi_edges_with_discriminators)Upserting Multi-Edges with Discriminators
Previously, users could only insert one discriminated edge at a time between two vertices. With the new update in 4.2, users can insert multiple discriminated edges in a single API request.
...
The following JSON array format allows for the insertion of multiple edges with different discriminator values between the same source and target vertices in a single operation:
```
{
 "edges": {
  "User": {
...
```
  ...
  * **actionId** is the discriminator. It uniquely identifies each edge between `id1` (source) and `id6` (target) vertices.
  * The **weight** attribute is not part of the discriminator and can be modified during upserts.
  * The **JSON array format** enables the insertion of multiple edges with different discriminators (e.g., `uuid-1`, `uuid-2`) in a single operation.


### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_rules_for_upserting_edges_with_discriminators)Rules for upserting edges with discriminators
  1. **Discriminator attributes are required:**
     * You must include all attributes defined in the discriminator when inserting or upserting an edge.
  2. **Discriminator attributes cannot be updated:**
     * Once an edge is created with a discriminator, its discriminator values cannot be changed.
  3. **Support for multi-edges with JSON arrays:**
     * The JSON array format enables the insertion of multiple edges with with different discriminators in a single operation.


  * The **actionId** uniquely identifies each instance of the `Liked` edge type.
  * Attributes like **weight** are not part of the discriminator and can be updated during upserts.
  * The **JSON array format** supports the insertion of multiple discriminated edges in a single operation.

  
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_general_rules_for_json_formatting)General rules for JSON formatting
  1. **Escaped quotes:**
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_valid_data_types)Valid data types
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_example)Example
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/API/upsert-rest#_atomic_upsert_transaction)Atomic upsert transaction
