...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/security/pages/encrypting-connections.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_prerequisites)
  * [Nginx-Based](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_nginx_based)
  * [Step 1. Obtain an SSL Certificate](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_step_1_obtain_an_ssl_certificate)
  * [Option 1: Using a Certificate From A Trusted Agent](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_option_1_using_a_certificate_from_a_trusted_agent)
  * [Option 2: Create a Self-Signed Certificate](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_option_2_create_a_self_signed_certificate)
  * [Change the Certificate Permission](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_change_the_certificate_permission)
  * [Step 2: Configure SSL with gadmin](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_step_2_configure_ssl_with_gadmin)
  * [Testing Your SSL Connection](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_testing_your_ssl_connection)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_prerequisites)Prerequisites
...
A good primer on SSL is available at Apache’s [SSL/TLS Strong Encryption: An Introduction](https://httpd.apache.org/docs/2.4/ssl/ssl_intro.html)
## [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_nginx_based)Nginx-Based
TigerGraph uses the Nginx web server, so SSL configuration makes use of some built-in support in Nginx.
<http://nginx.org/en/docs/http/configuring_https_servers.html>
## [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_step_1_obtain_an_ssl_certificate)Step 1. Obtain an SSL Certificate
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_option_1_using_a_certificate_from_a_trusted_agent)Option 1: Using a Certificate From A Trusted Agent
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_option_2_create_a_self_signed_certificate)Option 2: Create a Self-Signed Certificate
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_change_the_certificate_permission)Change the Certificate Permission
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_step_2_configure_ssl_with_gadmin)Step 2: Configure SSL with `gadmin`
...
Then restart the following services: `gsql`, `nginx`, and `gui`.
```
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections#_testing_your_ssl_connection)Testing Your SSL Connection
