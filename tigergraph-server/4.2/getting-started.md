...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/getting-started/pages/index.adoc)
### Contents
  * [Get Started with Docker](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_get_started_with_docker)
  * [Get Started on Linux](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_get_started_on_linux)
  * [Getting started on Kubernetes](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_getting_started_on_kubernetes)
  * [Get Started from a Cloud Marketplace](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_get_started_from_a_cloud_marketplace)
...
This Get Started section covers the various options for users who are installing the TigerGraph database themselves. The Community Edition can be installed on a single machine either directly on a Linux or as a Docker image. The Enterprise Edition offers additional options; it can also be installed on a cluster of servers directly or through Kubernetes.
Please see [Comparing TigerGraph Editions](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions) for a chart of the features available for your edition.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_get_started_with_docker)[Get Started with Docker](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/docker)
If you are a Mac or Windows user, we recommend you use Docker to start up TigerGraph on your computer.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_get_started_on_linux)[Get Started on Linux](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/linux)
If you have a Linux machine that meets our [Hardware and Software Requirements](https://docs.tigergraph.com/tigergraph-server/4.2/installation/hw-and-sw-requirements), you can install TigerGraph on your machine directly.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_getting_started_on_kubernetes)[Getting started on Kubernetes](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/kubernetes)
Deploy a TigerGraph cluster on GKE, EKS, AKS, or OpenShift using the TigerGraph Operator.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/#_get_started_from_a_cloud_marketplace)[Get Started from a Cloud Marketplace](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/cloud-images/)
