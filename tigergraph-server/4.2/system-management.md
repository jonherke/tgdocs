...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/system-management/pages/index.adoc)
# Manage Your Database
  * [Access Management](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/)
  * [Backup and Export](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/)
  * [Change Data Capture (CDC) Overview](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/change-data-capture/cdc-overview)
  * [Cluster Management](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/)
  * [Kubernetes](https://docs.tigergraph.com/tigergraph-server/4.2/kubernetes/)
  * [Logs](https://docs.tigergraph.com/tigergraph-server/4.2/troubleshooting/log-files) and [Metrics Reports](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/system-metrics)
  * [Resources and Processes](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/resource-and-process-mgmt)
  * [Security](https://docs.tigergraph.com/tigergraph-server/4.2/security/)
  * [Workload Management](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/workload-management)
