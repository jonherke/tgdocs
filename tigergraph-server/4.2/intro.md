...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/intro/)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/intro/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/intro/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/intro/)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Welcome to TigerGraph® DB](https://docs.tigergraph.com/tigergraph-server/4.2/intro/)


[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/intro/pages/index.adoc)
### Contents
  * [Get to Know Your TigerGraph DB](https://docs.tigergraph.com/tigergraph-server/4.2/intro/#_get_to_know_your_tigergraph_db)
  * [Advanced Topics](https://docs.tigergraph.com/tigergraph-server/4.2/intro/#_advanced_topics)
  * [Release Notes](https://docs.tigergraph.com/tigergraph-server/4.2/intro/#_release_notes)
...
The TigerGraph® self-managed database runs on standard Linux servers, with everything built-in. To view the documentation of a particular TigerGraph version, please see please see the [Version Directory](https://docs.tigergraph.com/tigergraph-server/4.1/additional-resources/legacy-tg-versions).
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/#_get_to_know_your_tigergraph_db)Get to Know Your TigerGraph DB
![getstarted](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/getstarted-homecard.png) **Get Started** Step-by-step guides to get you up and running. [System Requirements](https://docs.tigergraph.com/tigergraph-server/4.2/installation/hw-and-sw-requirements) | [Installation](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/) | [ GSQL Shell](https://docs.tigergraph.com/tigergraph-server/4.2/gsql-shell/) | ![security](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/security-homecard.png) **User Access Mgmt** Learn to use TigerGraph’s role-based access control (RBAC) and other security features. [User Access Management](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/) | [Security ](https://docs.tigergraph.com/tigergraph-server/4.2/security/)  
---|---  
![designdatbase](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/designdatbase-homecard.png) **Create a Database** Learn how to design a database, create loading jobs and write queries. [Define a Graph](https://docs.tigergraph.com/tigergraph-server/4.2/getting-started/database-definition) | [Multi-graph](https://docs.tigergraph.com/tigergraph-server/4.2/intro/multigraph-overview) | [GSQL Language Reference](https://docs.tigergraph.com/gsql-ref/4.2/intro/) | ![dataloading](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/DataLoading-Homecard.png) **Load and Export Data** Learn how to load data into and export data from TigerGraph. [Data Connectors](https://docs.tigergraph.com/tigergraph-server/4.2/data-loading/) | [Database Import/Export](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/database-import-export)  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/#_advanced_topics)Advanced Topics
![clustering](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/systemmanagment-homecard.png) **Clustering** Define and manage clusters for scaling and high availablity. [Cluster overview](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/) | [High Avalability](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-overview) | [Cross-Region Replication](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/crr-index) | ![operations](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/installation-homecard.png) **Operations Mgmt** Learn to manage TigerGraph servers and how to set up system backups. [System Management](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/management-with-gadmin) | [Backup and Restore ](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/) | [Workload Management](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/workload-management)  
---|---  
![systemconig](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/systemconig-homecard.png) **Monitoring** Observe system metrics and behavior. [Metrics Reports](https://docs.tigergraph.com/tigergraph-server/4.2/system-management/system-metrics) | [Log Files](https://docs.tigergraph.com/tigergraph-server/4.2/troubleshooting/log-files) | [Audit Logs](https://docs.tigergraph.com/tigergraph-server/4.2/troubleshooting/audit-log) | ![ArchtectureOverview](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/ArchtectureOverview-homecard.png) **Architecture** Go deeper and learn what’s behind the platform. [Internal Architecture](https://docs.tigergraph.com/tigergraph-server/4.2/intro/internal-architecture) | [Transaction and ACID](https://docs.tigergraph.com/tigergraph-server/4.2/intro/transaction-and-acid) | [Continuous Availability Overview](https://docs.tigergraph.com/tigergraph-server/4.2/intro/continuous-availability-overview)  
![ArchtectureOverview](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/TG_Icon_Library-08.png) **Kubernetes** Automate the deployment and managing of TigerGraph clusters using Kubernetes. [Kubernetes](https://docs.tigergraph.com/tigergraph-server/4.2/kubernetes/) | [Kubernetes Operator](https://docs.tigergraph.com/tigergraph-server/4.2/kubernetes/k8s-operator/) | ![ArchtectureOverview](https://docs.tigergraph.com/tigergraph-server/4.2/intro/_images/documentation-homecard.png) **Additional Resources** Explore API directories, troubleshooting guides, and more. [Best Practices](https://docs.tigergraph.com/tigergraph-server/4.2/additional-resources/best-practice-guides/best-practices-overview) | [Troubleshooting Guide](https://docs.tigergraph.com/tigergraph-server/4.2/troubleshooting/troubleshooting-guide) | [Glossary](https://docs.tigergraph.com/tigergraph-server/4.2/reference/glossary) | [List of Ports](https://docs.tigergraph.com/tigergraph-server/4.2/reference/ports)  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/#_release_notes)Release Notes
To keep up-to-date on key new features of the most recent LTS versions of TigerGraph, please see here:
  * [Release Notes - TigerGraph 4.2](https://docs.tigergraph.com/tigergraph-server/4.2/release-notes/)
