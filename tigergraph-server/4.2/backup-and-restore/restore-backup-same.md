...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/backup-and-restore/pages/restore-backup-same.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same#_prerequisites)
  * [Basic Procedure](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same#_basic_procedure)
  * [Options for Restore](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same#_options_for_restore)
...
This page describes the process and options for restoring a database from a backup file. Please see the additional considerations if you want to [restore to a different cluster other than backup’s source](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster).
Restoring a backup is an offline operation. Your database will be down for a short period of time during database restore.
## [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same#_prerequisites)Prerequisites
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same#_basic_procedure)Basic Procedure
...
`<time point>` employs [Point-in-Time Restore](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/point-in-time-restore), automatically searching for the most appropriate backup files and using only the appropriate parts of those backup files. See the documentati on [Point-in-Time Restore](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/point-in-time-restore) to understand the limitations.
...
---  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same#_options_for_restore)Options for Restore
