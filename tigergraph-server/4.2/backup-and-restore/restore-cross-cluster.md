...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/backup-and-restore/pages/restore-cross-cluster.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_prerequisites)
  * [Procedure](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_procedure)
  * [1) Copy Data Backup to a New Cluster](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_1_copy_data_backup_to_a_new_cluster)
  * [2) Restore Cluster](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_2_restore_cluster)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_prerequisites)Prerequisites
  * Your new cluster has the same [partitioning factor](https://docs.tigergraph.com/tigergraph-server/4.2/cluster-and-ha-management/ha-cluster) as the cluster from which the backup file was created.
  ...
  * [[3.9.1 and earlier](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_procedure_v3_9_1_and_below)] You have the metadata backup that goes with the data backup.
  * You have [configured backup and restore](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/configurations) on the new cluster.


## [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_procedure)Procedure
### [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_1_copy_data_backup_to_a_new_cluster)1) Copy Data Backup to a New Cluster
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_for_amazon_s3_backup)For Amazon S3 Backup:
...
#### [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_for_local_backup_storage)For Local Backup Storage:
...
### [](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-cross-cluster#_2_restore_cluster)2) Restore Cluster
Now, just like [restoring a backup in its original cluster](https://docs.tigergraph.com/tigergraph-server/4.2/backup-and-restore/restore-backup-same), simply run:
```
