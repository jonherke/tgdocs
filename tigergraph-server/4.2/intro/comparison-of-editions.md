...
Page 1[Prev](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions)[Next](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions)
...
[Edit this Page](https://github.com/tigergraph/server-docs/edit/4.2/modules/intro/pages/comparison-of-editions.adoc)
### Contents
  * [Overview](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_overview)
  * [Database Features](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_database_features)
  * [Enterprise/DevOps Features](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_enterprisedevops_features)
  * [Security Features](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_security_features)
...
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_overview)Overview
Savanna Cloud | TigerGraph DB | TigerGraph DB, Community Edition  
---|---|---  
Deployment | Fully-Managed Enterprise Cloud SaaS | Self-Managed, on Linux servers | Self-Managed, on Linux servers or in Docker  
Licensing | Pay as you go by the minute; Free credits to get started | Annual license priced by data capacity | Free, even for production use  
Included | Fully-Managed Cloud-Native Service * Security * Separation of Storage and Compute * Unlimited Scale out * Solution Kits | All TigerGraph features * Distributed Graph+Vector DB * Security & RBAC * Multiple query languages & APIs * UI tools | TigerGraph Graph + Vector DB on single server * built-in roles * Multiple query languages & APIs * UI tools  
Support | ✅ 24/7 | ✅ Standard and Premier tiers of support available | [Community Forum](https://community.tigergraph.com/) support.  
How to Get It | [Start Free Now](https://www.tigergraph.com/cloud) | [Request a 30-day free trial](https://info.tigergraph.com/enterprise-free) | [Download now](https://dl.tigergraph.com)  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_database_features)Database Features
...
**Distributed, Auto-Partitioned Graph** | ✅ | ✅ | Single Server only  
**Compressed Data Store** | ✅ | ✅ | ✅  
**Graph Data Size** | Unlimited | Unlimited | up to 200 GB  
**Vector Data Size** | Unlimited | Unlimited | up to 100 GB  
**In-Memory Processing; ACID Transactions** | ✅ | ✅ | ✅  
**Graph query languages** | GSQL, OpenCypher, GSQL pattern matching | GSQL, OpenCypher, GSQL pattern matching | GSQL, OpenCypher, GSQL pattern matching  
**Vector Similarity Search, Hybrid Search** | ✅ | ✅ | ✅  
**Dynamic Schema Change** | ✅ | ✅ | ✅  
**Graphical User Interface** | All roles: Deploy, Design, Manage | GraphStudio | GraphStudio  
**GraphStudio Visual SDK: Design, Load, Explore, Query, Visualize** | ✅ | ✅ | ✅  
**Admin Portal: monitor/manage system operation, manage users** | ✅ | ✅ | ✅  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_enterprisedevops_features)Enterprise/DevOps Features
Feature | Savanna Cloud | TigerGraph DB | TigerGraph DB, Community Edition  
---|---|---|---  
**Automated Deployment** | ✅ | No | No  
**Automated Backups** | ✅ | No | No  
**Backup and Restore** | ✅ | ✅ | Export/Import only  
**Multiple Users per Database** | ✅ | ✅ | ✅  
**Multiple Databases per Organization** | ✅ | No | No  
**HA Replication** | ✅ | ✅ | No  
**Cross-Region Replication** | Coming soon | ✅ | No  
## [](https://docs.tigergraph.com/tigergraph-server/4.2/intro/comparison-of-editions#_security_features)Security Features
Feature | Savanna Cloud | TigerGraph DB | TigerGraph DB, Community Edition  
---|---|---|---  
**Data Encryption in Motion and at Rest** | ✅ | ✅ | Encryption at rest  
**Role-Based Access Control** | ✅ | ✅ | Built-in roles only  
**LDAP and SSO** | ✅ | ✅ | No  
*Identity Provider (PDP) integration with SSO | ✅ | ✅ | No  
**Audited Compliance** | SOC 2 Type 2 | PCI-DSS | No  
**VPC Peering** | ✅ | N/A | N/A  
**Private Network** | ✅ | N/A | N/A  
