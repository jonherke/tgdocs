...
Page 1[Prev](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt)[Next](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt)
...
[Edit this Page](https://github.com/tigergraph/pytigergraph-docs/edit/v1.6/modules/core-functions/pages/udt.adoc)
### Contents
  * [getUDTs()](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt#_getudts)
  * [getUDT()](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt#_getudt)
...
The functions on this page retrieve information about user-defined tuples (UDT) for the graph. All functions in this module are called as methods on a [`TigerGraphConnection` object](https://docs.tigergraph.com/pytigergraph/current/core-functions/base).
## [](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt#_getudts)getUDTs()
`getUDTs() → list`
Returns the list of User-Defined Tuples (names only).
For information on UDTs see [User-Defined Tuple](https://docs.tigergraph.com/gsql-ref/4.2/basics/running-gsql#typedef-tuple)
#### Returns:
The list of names of UDTs (defined in the global scope, i.e. not in queries).
## [](https://docs.tigergraph.com/pytigergraph/1.6/core-functions/udt#_getudt)getUDT()
