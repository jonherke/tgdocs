...
Page 1[Prev](https://docs.tigergraph.com/pytigergraph/1.6/contributing/)[Next](https://docs.tigergraph.com/pytigergraph/1.6/contributing/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/pytigergraph/1.6/contributing/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/pytigergraph/1.6/contributing/)
...
[Edit this Page](https://github.com/tigergraph/pytigergraph-docs/edit/v1.6/modules/contributing/pages/index.adoc)
### Contents
  * [Download the Repository](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_download_the_repository)
  * [Install the Local Version of the Package](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_install_the_local_version_of_the_package)
  * [Make Changes](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_make_changes)
  * [Submit a Pull Request](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_submit_a_pull_request)
...
## [](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_download_the_repository)Download the Repository
You can download the repository from GitHub by:
```
git clone https://github.com/tigergraph/pyTigerGraph.git
sh![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!

```

## [](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_install_the_local_version_of_the_package)Install the Local Version of the Package
...
## [](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_make_changes)Make Changes
...
Finally, unit tests should be written to test the funcitonality of the change. See the [testing documentation](https://docs.tigergraph.com/pytigergraph/1.6/contributing/tests) for more information.
## [](https://docs.tigergraph.com/pytigergraph/1.6/contributing/#_submit_a_pull_request)Submit a Pull Request
