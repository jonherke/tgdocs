...
Page 1[Prev](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece)[Next](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece)
...
[Edit this Page](https://github.com/tigergraph/pytigergraph-docs/edit/v1.8/modules/gds/pages/nodepiece.adoc)
### Contents
  * [NodePieceMLPForVertexClassification](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_nodepiecemlpforvertexclassification)
  * [_init_()](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_init)
  * [forward()](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_forward)
  * [compute_loss()](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_compute_loss)
...
## [](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_nodepiecemlpforvertexclassification)NodePieceMLPForVertexClassification
...
### [](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_init)__init__()
`_init_(num_layers: int, out_dim: int, hidden_dim: int, vocab_size: int, sequence_length: int, embedding_dim = 768, dropout = 0.0, class_weights = None)`
...
### [](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_forward)forward()
...
### [](https://docs.tigergraph.com/pytigergraph/1.8/gds/nodepiece#_compute_loss)compute_loss()
