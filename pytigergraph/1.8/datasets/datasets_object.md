...
Page 1[Prev](https://docs.tigergraph.com/pytigergraph/1.8/datasets/datasets_object)[Next](https://docs.tigergraph.com/pytigergraph/1.8/datasets/datasets_object)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/pytigergraph/1.8/datasets/datasets_object)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/pytigergraph/1.8/datasets/datasets_object)
...
[Edit this Page](https://github.com/tigergraph/pytigergraph-docs/edit/v1.8/modules/datasets/pages/datasets_object.adoc)
### Contents
  * [_init_()](https://docs.tigergraph.com/pytigergraph/1.8/datasets/datasets_object#_init)
...
## [](https://docs.tigergraph.com/pytigergraph/1.8/datasets/datasets_object#_init)__init__()
...
#### Parameters:
`name` (str, optional): Name of the dataset to get. Defaults to `None`.
