...
Page 1[Prev](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms)[Next](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms)
...
[Edit this Page](https://github.com/tigergraph/pytigergraph-docs/edit/v1.7/modules/gds/pages/pyg_transforms.adoc)
### Contents
  * [TemporalPyGTransform](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms#_temporalpygtransform)
  * [_init_()](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms#_init)
  * [call()](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms#_call)
...
## [](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms#_temporalpygtransform)TemporalPyGTransform
...
### [](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms#_init)__init__()
`_init_(vertex_start_attrs: dict, vertex_end_attrs: dict, edge_start_attrs: dict, edge_end_attrs: dict, start_dt: int, end_dt: int, feature_transforms: dict, timestep: int = 86400)`
...
### [](https://docs.tigergraph.com/pytigergraph/1.7/gds/pyg_transforms#_call)_call_()
`_call_(data) → list`
