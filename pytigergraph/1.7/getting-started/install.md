...
Page 1[Prev](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install)[Next](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install)
...
[Edit this Page](https://github.com/tigergraph/pytigergraph-docs/edit/v1.7/modules/getting-started/pages/install.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_prerequisites)
  * [Install pyTigerGraph](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_install_pytigergraph)
  * [Install pyTigerGraph[gds]](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_install_pytigergraphgds)
  * [Import pyTigerGraph](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_import_pytigergraph)
...
## [](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_prerequisites)Prerequisites
...
## [](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_install_pytigergraph)Install _pyTigerGraph_
...
## [](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_install_pytigergraphgds)Install _pyTigerGraph[gds]_
To utilize [pyTigerGraph’s Graph Data Science (GDS) functionality](https://docs.tigergraph.com/pytigergraph/1.7/gds/), run the following command to install `pyTigerGraph[gds]`.
```
...
Certain GDS classes, such as [data loaders](https://docs.tigergraph.com/pytigergraph/1.7/gds/dataloaders), can produce output in PyTorch Geometric (PyG) or Deep Graph Library (DGL) formats. To support those formats, you need to have installed the respective packages in your Python environment:
...
## [](https://docs.tigergraph.com/pytigergraph/1.7/getting-started/install#_import_pytigergraph)Import `pyTigerGraph`
