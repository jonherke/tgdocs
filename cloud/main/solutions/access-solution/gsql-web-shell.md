...
Page 1[Prev](https://docs.tigergraph.com/cloud/main/solutions/access-solution/gsql-web-shell)[Next](https://docs.tigergraph.com/cloud/main/solutions/access-solution/gsql-web-shell)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/cloud/main/solutions/access-solution/gsql-web-shell)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/cloud/main/solutions/access-solution/gsql-web-shell)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/cloud/modules/solutions/pages/access-solution/gsql-web-shell.adoc)
### Contents
  * [Access](https://docs.tigergraph.com/cloud/main/solutions/access-solution/gsql-web-shell#_access)
...
The GSQL Shell is a newly redesigned browser-based interface for running GSQL commands on a cluster. It includes useful developer tools such as keyboard shortcuts and customized autocomplete for commands.
Most TigerGraph Cloud Classic solutions, free and paid, have access to the GSQL Shell in the TigerGraph suite.
Please see the main [GSQL Shell documentation page](https://docs.tigergraph.com/tigergraph-server/4.2/gsql-shell/web) for complete information.
## [](https://docs.tigergraph.com/cloud/main/solutions/access-solution/gsql-web-shell#_access)Access
From the Tools menu in the Cluster view, select **GSQL Shell**.
...
In addition, the GSQL Shell is newly available for solutions running Tigergraph Server version 3.7.0 and newer. Older solutions created before 3.7.0 do not have access to the GSQL Shell. Please contact support@tigergraph.com to discuss migration to a newer version.
