...
Page 1[Prev](https://docs.tigergraph.com/cloud/main/security/)[Next](https://docs.tigergraph.com/cloud/main/security/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/cloud/main/security/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/cloud/main/security/)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/cloud/modules/security/pages/index.adoc)
### Contents
  * [Network access](https://docs.tigergraph.com/cloud/main/security/#_network_access)
  * [Authentication](https://docs.tigergraph.com/cloud/main/security/#_authentication)
  * [Authorization](https://docs.tigergraph.com/cloud/main/security/#_authorization)
  * [Data encryption](https://docs.tigergraph.com/cloud/main/security/#_data_encryption)
  * [Operational compliance](https://docs.tigergraph.com/cloud/main/security/#_operational_compliance)
  * [Vulnerability scanning](https://docs.tigergraph.com/cloud/main/security/#_vulnerability_scanning)
  * [Vulnerability remediation](https://docs.tigergraph.com/cloud/main/security/#_vulnerability_remediation)
...
TigerGraph Cloud Classic leverages the secured infrastructure of our cloud service providers and provides additional security features to ensure the security of your data and network. This page provides an overview of the security features available on TigerGraph Cloud Classic.
## [](https://docs.tigergraph.com/cloud/main/security/#_network_access)Network access
  * All communication secured
    * TLS 1.2 for client-server communication
  * Dedicated VPCs for each organization
  * [VPC peering](https://docs.tigergraph.com/cloud/main/security/vpc-peering/readme)
  * Private Links
    * [AWS](https://docs.tigergraph.com/cloud/main/security/private-access/aws)
    * [Azure](https://docs.tigergraph.com/cloud/main/security/private-access/azure)
    * [GCP](https://docs.tigergraph.com/cloud/main/security/private-access/gcp)
  * Secured external cloud data access
    * [RESTPP authentication](https://docs.tigergraph.com/cloud/main/solutions/access-solution/rest-requests)


## [](https://docs.tigergraph.com/cloud/main/security/#_authentication)Authentication
  * [Strong password requirement](https://docs.tigergraph.com/cloud/main/security/password-policy) when [creating an account](https://docs.tigergraph.com/cloud/main/start/overview#_get_started_with_tigergraph_cloud)
  * [Integrated identity and access management (IAM)](https://docs.tigergraph.com/cloud/main/security/user-management)
  * [SSO with SAML 2.0 federated auth](https://docs.tigergraph.com/cloud/main/security/idp)


## [](https://docs.tigergraph.com/cloud/main/security/#_authorization)Authorization
  * [User management for a cloud organization](https://docs.tigergraph.com/cloud/main/security/user-management)
    * Predefined roles and privileges
  * [Access management for clusters](https://docs.tigergraph.com/cloud/main/security/manage-org-users#_access_management)
  * Audit logs for privileged user actions


## [](https://docs.tigergraph.com/cloud/main/security/#_data_encryption)Data encryption
  * Automatic [data in-transit encryption](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-connections): TLS 1.2 for all endpoints
  * Automatic [data at-rest encryption](https://docs.tigergraph.com/tigergraph-server/4.2/security/encrypting-data-at-rest): native encryption functionality through cloud providers


## [](https://docs.tigergraph.com/cloud/main/security/#_operational_compliance)Operational compliance
...
## [](https://docs.tigergraph.com/cloud/main/security/#_vulnerability_scanning)Vulnerability scanning
...
### [](https://docs.tigergraph.com/cloud/main/security/#_vulnerability_remediation)Vulnerability remediation
