...
Page 1[Prev](https://docs.tigergraph.com/cloud/main/security/password-policy)[Next](https://docs.tigergraph.com/cloud/main/security/password-policy)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/cloud/main/security/password-policy)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/cloud/main/security/password-policy)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/cloud/modules/security/pages/password-policy.adoc)
# Password Policy
TigerGraph Cloud Classic user accounts have their own password requirements separate from the [TigerGraph Server password policy](https://docs.tigergraph.com/tigergraph-server/4.2/security/password-policy).
