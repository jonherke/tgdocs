...
Page 1[Prev](https://docs.tigergraph.com/cloud/main/security/user-management)[Next](https://docs.tigergraph.com/cloud/main/security/user-management)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/cloud/main/security/user-management)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/cloud/main/security/user-management)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [User Management](https://docs.tigergraph.com/cloud/main/security/user-management)


[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/cloud/modules/security/pages/user-management.adoc)
### Contents
  * [TigerGraph Cloud Classic user account](https://docs.tigergraph.com/cloud/main/security/user-management#_tigergraph_cloud_classic_user_account)
  * [Single Sign-On (SSO)](https://docs.tigergraph.com/cloud/main/security/user-management#_single_sign_on_sso)
  * [TigerGraph user access levels](https://docs.tigergraph.com/cloud/main/security/user-management#_tigergraph_user_access_levels)
...
## [](https://docs.tigergraph.com/cloud/main/security/user-management#_tigergraph_cloud_classic_user_account)TigerGraph Cloud Classic user account
Your TigerGraph Cloud Classic user account serves as your credential on the platform level. Depending on your role, you have various levels of access to clusters, billing information and organization user information.
See [Manage your TigerGraph Cloud Classic User Account](https://docs.tigergraph.com/cloud/main/security/manage-cloud-account) for more information about making changes to your account.
## [](https://docs.tigergraph.com/cloud/main/security/user-management#_single_sign_on_sso)Single Sign-On (SSO)
Organization admins can link a TigerGraph Cloud Classic Organization with an IDP such as Okta and Azure Active Directory (AAD). This allows for user management to be done entirely outside TigerGraph Cloud Classic inside a preferred IDP.
See [IDP integration with SSO](https://docs.tigergraph.com/cloud/main/security/idp) for more information.
## [](https://docs.tigergraph.com/cloud/main/security/user-management#_tigergraph_user_access_levels)TigerGraph user access levels
On the individual cluster level, the same [role-based access control](https://docs.tigergraph.com/gui/4.2/admin-portal/management/user-management) used by the on-premises version of TigerGraph also applies to TigerGraph Cloud Classic. Each cluster can have many TigerGraph Cloud Classic users and each user can have different roles for each graph with different privileges.
For more information on how to manage users and roles in Admin Portal, see [User Management](https://docs.tigergraph.com/gui/4.2/admin-portal/management/user-management).
