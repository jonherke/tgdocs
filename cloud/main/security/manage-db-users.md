...
Page 1[Prev](https://docs.tigergraph.com/cloud/main/security/manage-db-users)[Next](https://docs.tigergraph.com/cloud/main/security/manage-db-users)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/cloud/main/security/manage-db-users)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/cloud/main/security/manage-db-users)
...
[Edit this Page](https://github.com/tigergraph/cloud-docs/edit/main/modules/cloud/modules/security/pages/manage-db-users.adoc)
### Contents
  * [Create a database user](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_create_a_database_user)
  * [Prerequisite](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_prerequisite)
  * [Procedure](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_procedure)
  * [Delete a database user](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_delete_a_database_user)
  * [Prerequisite](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_prerequisite_2)
  * [Procedure](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_procedure_2)
...
---  
![database access](https://docs.tigergraph.com/cloud/main/security/_images/database-access.png)
## [](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_create_a_database_user)Create a database user
### [](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_prerequisite)Prerequisite
  * Your TigerGraph Cloud Classic account has role Organization Admin


### [](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_procedure)Procedure
  ...
  5. Assign roles to the user as needed. For details on TigerGraph’s role-based access control model, see [Access Control Model](https://docs.tigergraph.com/tigergraph-server/4.2/user-access/access-control-model#_role_based_access_control).


## [](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_delete_a_database_user)Delete a database user
### [](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_prerequisite_2)Prerequisite
  * Your TigerGraph Cloud Classic account has role Organization Admin


### [](https://docs.tigergraph.com/cloud/main/security/manage-db-users#_procedure_2)Procedure
  1. From the Cloud portal, go to **Clusters**.
  2. Find the cluster you want to create users for, and select **Access Management**.
  3. From the Cluster Access Management page, click **Database Access**.
