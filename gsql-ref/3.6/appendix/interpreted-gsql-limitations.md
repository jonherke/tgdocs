...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/appendix/interpreted-gsql-limitations)[Next](https://docs.tigergraph.com/gsql-ref/3.6/appendix/interpreted-gsql-limitations)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/appendix/interpreted-gsql-limitations)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/appendix/interpreted-gsql-limitations)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/appendix/pages/interpreted-gsql-limitations.adoc)
### Contents
  * [Unsupported Features in Interpreted Mode](https://docs.tigergraph.com/gsql-ref/3.6/appendix/interpreted-gsql-limitations#_unsupported_features_in_interpreted_mode)
...
This page lists the limitations of GSQL’s [Interpreted mode](https://docs.tigergraph.com/gsql-ref/3.6/querying/query-operations#interpret-a-created-query).
To use the features on this page, [install the query](https://docs.tigergraph.com/gsql-ref/3.6/querying/query-operations#_install_query) and then run it instead.
## [](https://docs.tigergraph.com/gsql-ref/3.6/appendix/interpreted-gsql-limitations#_unsupported_features_in_interpreted_mode)Unsupported Features in Interpreted Mode
