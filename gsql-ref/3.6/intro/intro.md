...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro)[Next](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/intro/pages/intro.adoc)
### Contents
  * [Documentation Notation](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro#_documentation_notation)
...
The GSQL Language Reference is divided into two major parts:
  * [Part 1](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/system-and-language-basics) describes system basics, defining a graph schema, and loading data.
  * [Part 2](https://docs.tigergraph.com/gsql-ref/3.6/querying/) describes querying.
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro#_documentation_notation)**Documentation Notation**
...
In a very few cases, some option keywords are case-sensitive. For example, in the command to delete all data from the graph store, clear graph store -HARD the option -HARD must be in all capital letters.  
---  
