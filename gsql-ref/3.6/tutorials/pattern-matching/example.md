...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example)[Next](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/tutorials/pages/pattern-matching/example.adoc)
### Contents
  * [A Recommendation Application](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example#_a_recommendation_application)
  * [GSQL recommend_message Application](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example#_gsql_recommend_message_application)
  * [Install the query](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example#_install_the_query)
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example#_a_recommendation_application)A Recommendation Application
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example#_gsql_recommend_message_application)GSQL recommend_message Application
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example#_install_the_query)Install the query
