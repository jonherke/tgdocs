...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/summary)[Next](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/summary)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/summary)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/summary)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/tutorials/pages/pattern-matching/summary.adoc)
...
With a little practice, you will be writing GSQL pattern matching queries to efficiently solve real-world problems. You can post your feedback and questions on the [GSQL community forum](https://community.tigergraph.com/). Our community members and developers love to hear any feedback from your graph journey of using GSQL and are ready to help clarify any doubts.
