...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/)[Next](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/tutorials/pages/pattern-matching/index.adoc)
### Contents
  * [What is a graph pattern?](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/#_what_is_a_graph_pattern)
  * [What is pattern matching?](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/#_what_is_pattern_matching)
...
This tutorial assumes you have finished [GSQL 101](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/gsql-101/), and are familiar with the basics of defining a schema, loading data, and how to write basic queries.
## [](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/#_what_is_a_graph_pattern)What is a graph pattern?
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/#_what_is_pattern_matching)What is pattern matching?
...
Follow the sequence below to learn how to write pattern matching queries in GSQL.
  * [Prepare your environment - Pattern Matching tutorial](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/prepare-environment)
  * [One-hop patterns](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/one-hop-patterns)
  * [Repeating a 1-Hop Pattern](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/repeating-a-pattern)
  * [Multiple Hop Patterns and Accumulation](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/multiple-hop-and-accumulation)
  * [Example - A Recommender](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/example)
  * [Advanced Features](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/adv/)
  * [Pattern Matching Tutorial Summary](https://docs.tigergraph.com/gsql-ref/3.6/tutorials/pattern-matching/summary)
