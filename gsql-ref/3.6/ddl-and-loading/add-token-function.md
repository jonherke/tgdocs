...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function)[Next](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/ddl-and-loading/pages/add-token-function.adoc)
### Contents
  * [Define a token function in C++](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_define_a_token_function_in_c)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_example)
  * [User-defined Token Functions for WHERE Clause](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_user_defined_token_functions_for_where_clause)
  * [Use GitHub to store token functions](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_use_github_to_store_token_functions)
  * [Store token functions locally](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_store_token_functions_locally)
  * [Step 1: Modify the current TokenBank file](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_step_1_modify_the_current_tokenbank_file)
  * [Step 2: Define your token function](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_step_2_define_your_token_function)
  * [Step 3: Store the modified TokenBank.cpp file](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_step_3_store_the_modified_tokenbank_cpp_file)
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_define_a_token_function_in_c)Define a token function in C++
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_example)Example
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_user_defined_token_functions_for_where_clause)User-defined Token Functions for `WHERE` Clause
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_use_github_to_store_token_functions)Use GitHub to store token functions
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_store_token_functions_locally)Store token functions locally
### [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_step_1_modify_the_current_tokenbank_file)Step 1: Modify the current TokenBank file
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_step_2_define_your_token_function)Step 2: Define your token function
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function#_step_3_store_the_modified_tokenbank_cpp_file)Step 3: Store the modified TokenBank.cpp file
