...
![A schema for a User-Book-Rating graph. The vertex User is connected to Occupation with the user_occupation edge and to Book with the user_book_rating edge. Book is connected to Genre with the book_genre edge.](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/_images/user-book-rating-schema.png)
...
![User-Book-Rating schema with addtional edges.](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/_images/user-book-rating-schema-expanded.png)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/defining-a-graph-schema#_create_vertex)`CREATE VERTEX`
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/defining-a-graph-schema#_alter_index)`ALTER INDEX`
...
Unlike [the `gsql --reset` command](https://docs.tigergraph.com/tigergraph-server/3.9/getting-started/database-definition#_reset_all), `DROP ALL` does not erase user and role information.
