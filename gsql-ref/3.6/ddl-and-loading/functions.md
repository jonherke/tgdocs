...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/)[Next](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/ddl-and-loading/pages/functions/index.adoc)
# Functions
...
There are four types of token functions:
  ...
  * [Token Functions in WHERE Clause](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token_where/)
  * [Reducer functions](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/reducer/)
  * [User-defined token functions](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/add-token-function)
