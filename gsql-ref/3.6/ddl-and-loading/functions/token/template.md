...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template)[Next](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/ddl-and-loading/pages/functions/token/template.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_syntax)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_parameters)
  * [Return type](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_return_type)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_example)


=
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_syntax)Syntax
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_parameters)Parameters
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_return_type)Return type
## [](https://docs.tigergraph.com/gsql-ref/3.6/ddl-and-loading/functions/token/template#_example)Example
