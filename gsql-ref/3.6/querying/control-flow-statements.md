...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements)[Next](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/querying/pages/control-flow-statements.adoc)
### Contents
  * [Differences in Block Syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_differences_in_block_syntax)
  * [IF Statement](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_if_statement)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples)
  * [CASE Statement](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_case_statement)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax_2)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples_2)
  * [WHILE Statement](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_while_statement)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax_3)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples_3)
  * [FOREACH Statement](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_foreach_statement)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax_4)
  * [Limitations](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_limitations)
  * [FOREACH …​ IN RANGE](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_foreach_in_range)
  * [Query-body-level FOREACH Examples](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_query_body_level_foreach_examples)
  * [DML-sub FOREACH Examples](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_dml_sub_foreach_examples)
  * [CONTINUE and BREAK Statements](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_continue_and_break_statements)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples_4)
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_differences_in_block_syntax)Differences in Block Syntax
...
For more detailed general examples of the difference between query-body statements and DML-sub statements, see [statement types](https://docs.tigergraph.com/gsql-ref/3.6/querying/query-operations#_statement_types).
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_if_statement)`IF` Statement
The `IF` statement provides conditional branching: execute a block of statements ( `queryBodyStmts` or `dmlSubStmtList` ) only if a given _condition_ is true. The `IF` statement allows for zero or more `ELSE-IF` clauses, followed by an optional `ELSE` clause. The `IF` statement can be used either at the query-body level or at the DML-sub-statement level. (See the [note about differences in block syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_differences_in_block_syntax).)
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax)Syntax
`IF` syntax
```
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples)Examples
  * Query
  * Results
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_case_statement)`CASE` Statement
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax_2)Syntax
`CASE` syntax
```
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples_2)Examples
  * Query
  * Results
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_while_statement)`WHILE` Statement
The WHILE statement provides unbounded iteration over a block of statements. WHILE statements can be used as query-body statements or DML-sub-statements. (See the [note about differences in block syntax](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_differences_in_block_syntax).)
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax_3)Syntax
WHILE syntax
```
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples_3)Examples
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_foreach_statement)`FOREACH` Statement
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_syntax_4)Syntax
`FOREACH` syntax
```
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_limitations)Limitations
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_foreach_in_range)`FOREACH …​ IN RANGE`
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_query_body_level_foreach_examples)Query-body-level FOREACH Examples
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_dml_sub_foreach_examples)DML-sub FOREACH Examples
  * Query
  * Results
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_continue_and_break_statements)`CONTINUE` and `BREAK` Statements
...
### [](https://docs.tigergraph.com/gsql-ref/3.6/querying/control-flow-statements#_examples_4)Examples
