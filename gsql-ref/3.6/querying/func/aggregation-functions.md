...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions)[Next](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.6/modules/querying/pages/func/aggregation-functions.adoc)
### Contents
  * [avg()](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_avg)
  * [count()](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_count)
  * [max()](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_max)
  * [min()](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_min)
  * [sum()](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_sum)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_avg)avg()
### Syntax
`avg( [DISTINCT] setExp )`
### Description
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_count)count()
### Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_max)max()
### Syntax
`max( [DISTINCT] setExp )`
### Description
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_min)min()
### Syntax
`min( [DISTINCT] setExp )`
### Description
...
## [](https://docs.tigergraph.com/gsql-ref/3.6/querying/func/aggregation-functions#_sum)sum()
### Syntax
`sum( [DISTINCT] setExp )`
### Description
