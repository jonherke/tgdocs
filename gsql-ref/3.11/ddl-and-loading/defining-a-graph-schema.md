...
![A schema for a User-Book-Rating graph. The vertex User is connected to Occupation with the user_occupation edge and to Book with the user_book_rating edge. Book is connected to Genre with the book_genre edge.](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/_images/user-book-rating-schema.png)
...
![User-Book-Rating schema with addtional edges.](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/_images/user-book-rating-schema-expanded.png)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/defining-a-graph-schema#_create_vertex)`CREATE VERTEX`
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/defining-a-graph-schema#_primary_idkey_options)Primary ID/key options
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/defining-a-graph-schema#_use_graph)`USE GRAPH`
