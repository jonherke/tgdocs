...
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_load_statement)Load statement
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_edge_loading)Edge loading
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_one_level_flatten_function)One-level flatten function
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_two_level_flatten_function)Two-level flatten function
...
102 | CHN | Chinese  
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_flatten_a_json_array_of_primitive_values)Flatten a JSON array of primitive values
...
C | 3  
c++ | 3  
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_flatten_a_json_array_of_json_objects)Flatten a JSON array of JSON objects
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_flatten_a_json_object_in_a_csv_file)Flatten a JSON object in a CSV file
...
go | 4 | new | -1 (default)  
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job#_delete_statement)DELETE statement
