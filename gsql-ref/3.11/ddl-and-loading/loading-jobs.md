...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/loading-jobs)[Next](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/loading-jobs)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/loading-jobs)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/loading-jobs)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/ddl-and-loading/pages/loading-jobs.adoc)
# Loading Jobs
A unique and powerful feature of the GSQL ® language is the inclusion of high-level language to express how to load data into the database, via the definition of _loading jobs_.
...
The loading job documentation is organized into three parts:
  * [Creating a loading job](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/creating-a-loading-job)
  * [Running a loading job](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/running-a-loading-job)
  * [Managing loading jobs](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/managing-loading-job)
