...
[find_in_set(_str_ , _str_list_)](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/string-functions#find_in_set) | `INT` | Returns the position of a string within a list of strings separated by commas.  
