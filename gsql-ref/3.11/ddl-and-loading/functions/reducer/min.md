...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min)[Next](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/ddl-and-loading/pages/functions/reducer/min.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_syntax)
  * [Accepted parameter types](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_accepted_parameter_types)
  * [Return value](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_return_value)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_syntax)Syntax
`REDUCE( min (arg) )`
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_accepted_parameter_types)Accepted parameter types
This function only accepts parameters that can be interpreted as a numeric type.
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_return_value)Return value
`INT`, `UINT`, `FLOAT`, `DOUBLE`: minimum of all arg values cumulatively received
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/min#_example)Example
