...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/)[Next](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/ddl-and-loading/pages/functions/reducer/index.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/#_syntax)
  * [Table of reducer functions](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/#_table_of_reducer_functions)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/#_syntax)Syntax
...
Each reducer function can be used for several data types:
  ...
  * For `LIST`, `SET`, and `MAP` containers, the `input_expr` type is one of the [allowed element types](https://docs.tigergraph.com/gsql-ref/3.11/basics/system-and-language-basics#_collection_types) for these containers. The output is the entire container.


## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/reducer/#_table_of_reducer_functions)Table of reducer functions
