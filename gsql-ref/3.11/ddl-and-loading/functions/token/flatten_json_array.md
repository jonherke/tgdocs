...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array)[Next](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/ddl-and-loading/pages/functions/token/flatten_json_array.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_syntax)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_parameters)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_examples)
  * [Flatten a JSON array of primitive values](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_flatten_a_json_array_of_primitive_values)
  * [Flatten a JSON array of JSON objects](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_flatten_a_json_array_of_json_objects)
  * [Flatten a JSON object in a CSV file](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_flatten_a_json_object_in_a_csv_file)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_syntax)Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_parameters)Parameters
...
Required. The name of the fields in the JSON object.
## [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_examples)Examples
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_flatten_a_json_array_of_primitive_values)Flatten a JSON array of primitive values
...
For example, if we have the following [JSON line file](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/_attachments/encoding2.json). The `plug-in` field is a JSON array of primitive values:
encoding2.json
```
...
C | 3  
c++ | 3  
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_flatten_a_json_array_of_json_objects)Flatten a JSON array of JSON objects
...
For example, if we have the following [JSON line file](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/_attachments/encoding3.json). There is a `plug-in` field in each JSON object, and it is an array.
encoding3.json
```
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/functions/token/flatten_json_array#_flatten_a_json_object_in_a_csv_file)Flatten a JSON object in a CSV file
...
If we have [the following CSV file](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/_attachments/encoding.csv). The second column in the CSV file is a JSON object we want to flatten.
encoding.csv
```
