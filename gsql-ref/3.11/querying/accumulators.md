...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators)[Next](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/querying/pages/accumulators.adoc)
### Contents
  * [Declaration of Accumulators](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_declaration_of_accumulators)
  * [Vertex-attached Accumulators](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_vertex_attached_accumulators)
  * [Edge-attached Accumulators](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_edge_attached_accumulators)
  * [Global accumulators](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_global_accumulators)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example)
  * [Accumulator Types](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_accumulator_types)
  * [SumAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_sumaccum)
  * [MinAccum / MaxAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_minaccum_maxaccum)
  * [AvgAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_avgaccum)
  * [AndAccum / OrAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_andaccum_oraccum)
  * [BitwiseAndAccum / BitwiseOrAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_bitwiseandaccum_bitwiseoraccum)
  * [ListAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_listaccum)
  * [SetAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_setaccum)
  * [BagAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_bagaccum)
  * [MapAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_mapaccum)
  * [ArrayAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_arrayaccum)
  * [HeapAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_heapaccum)
  * [GroupByAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_groupbyaccum)
  * [Nested Accumulators](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_nested_accumulators)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_declaration_of_accumulators)Declaration of Accumulators
...
Accumulators are [block-scoped](https://docs.tigergraph.com/gsql-ref/3.11/querying/declaration-and-assignment-statements#_block_scoping) and can only be accessed in the block where they are declared.
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_vertex_attached_accumulators)Vertex-attached Accumulators
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_edge_attached_accumulators)Edge-attached Accumulators
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_global_accumulators)Global accumulators
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example)Example
  * Query
  * Results
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_accumulator_types)Accumulator Types
...
`ArrayAccum< accumType >` | Empty list | See the [ArrayAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_arrayaccum) section below for details.  
...
`GroupByAccum< _type [, type] , accumType [, accumType]*_ >`|  Empty group by map | Adds or updates a key:value pair GroupByAccum. See Section [GroupByAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_groupbyaccum) for more details.  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_sumaccum)SumAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_2)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_minaccum_maxaccum)MinAccum / MaxAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_3)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_avgaccum)AvgAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_4)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_andaccum_oraccum)AndAccum / OrAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_5)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_bitwiseandaccum_bitwiseoraccum)BitwiseAndAccum / BitwiseOrAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_declaration)Declaration
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_accumulation_behavior)Accumulation behavior
...
---  
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_functions)Functions
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_6)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_listaccum)ListAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_examples)Examples
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_setaccum)SetAccum
...
SetAccum also can be used with the three canonical set operators: `UNION`, `INTERSECT`, and `MINUS` (see the [Set/Bag Expression and Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_and_operators) section for more details).
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_7)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_bagaccum)BagAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_8)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_mapaccum)MapAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_9)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_arrayaccum)ArrayAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_element_level_operations)**Element-level operations**
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_accumulator_level_operations)Accumulator-level operations
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_10)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_heapaccum)HeapAccum
...
You must have defined a custom [tuple type](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_tuple) to declare a `HeapAccum`, and one of the fields in the tuple must be a data type that can be sorted.
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_functions_2)Functions
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_11)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_groupbyaccum)GroupByAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_example_12)Example
  * Query
  * Results
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_known_issues)Known Issues
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_nested_accumulators)Nested Accumulators
...
```
  ...
  4. ArrayAccum: Unlike the other accumulators in this list, where nesting is optional, nesting is mandatory for ArrayAccum. See the [ArrayAccum](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators#_arrayaccum) section.
