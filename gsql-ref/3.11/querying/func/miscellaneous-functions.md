...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions)[Next](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/querying/pages/func/miscellaneous-functions.adoc)
### Contents
  * [coalesce()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_coalesce)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_syntax)
  * [Description](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_description)
  * [Return type](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_return_type)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_parameters)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_example)
  * [evaluate()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_evaluate)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_syntax_2)
  * [Description](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_description_2)
  * [Return type](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_return_type_2)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_parameters_2)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_example_2)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_coalesce)`coalesce()`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_syntax)Syntax
`coalesce( exp [, exp ...] )`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_description)Description
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_return_type)Return type
`BOOL`, `INT`, `FLOAT,` `DOUBLE`, `STRING`, or `VERTEX`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_parameters)Parameters
The function takes a number of parameters and returns the first one that does not evaluate to `NULL`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_example)Example
```
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_evaluate)`evaluate()`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_syntax_2)Syntax
`evaluate( expressionStr, typeStr )`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_description_2)Description
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_return_type_2)Return type
Type indicated by `typeStr`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_parameters_2)Parameters
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/miscellaneous-functions#_example_2)Example
Example query
```
