...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods)[Next](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/querying/pages/func/jsonarray-methods.adoc)
### Contents
  * [getBool()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getbool)
  * [getDouble()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getdouble)
  * [getInt()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getint)
  * [getJsonArray()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getjsonarray)
  * [getJsonObject()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getjsonobject)
  * [getString()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getstring)
  * [size()](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_size)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getbool)`getBool()`
### Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getdouble)`getDouble()`
### Syntax
...
---|---|---  
`idx` | The index of the value to return | `INT`  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getint)`getInt()`
### Syntax
...
---|---|---  
`idx` | The index of the value to return | `INT`  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getjsonarray)`getJsonArray()`
### Syntax
...
---|---|---  
`idx` | The index of the value to return | `INT`  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getjsonobject)`getJsonObject()`
### Syntax
...
---|---|---  
`idx` | The index of the value to return | `INT`  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_getstring)`getString()`
### Syntax
...
---|---|---  
`idx` | The index of the value to return | `INT`  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/jsonarray-methods#_size)`size()`
### Syntax
`jsonarray.size()`
### Description
