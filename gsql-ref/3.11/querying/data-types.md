...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types)[Next](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/querying/pages/data-types.adoc)
### Contents
  * [Identifiers](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_identifiers)
  * [Overview](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_overview)
  * [Base types](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_base_types)
  * [Vertex](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_vertex)
  * [Edge](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_edge)
  * [Vertex and Edge Attribute Types](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_vertex_and_edge_attribute_types)
  * [JSONOBJECT](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_jsonobject)
  * [JSONARRAY](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_jsonarray)
  * [Container types](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_container_types)
  * [Tuple](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_tuple)
  * [FILE Object](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_file_object)
  * [Local disk file](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_local_disk_file)
  * [S3 object](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_s3_object)
  * [Query parameter types](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_query_parameter_types)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_identifiers)Identifiers
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_overview)Overview
...
`accumType` | Family of specialized data objects which support accumulation operations | 
  * Accumulate and aggregate data, when traversing a set of vertices or edges (Details are in the [Query Lang Spec - Accumulators](https://docs.tigergraph.com/gsql-ref/3.11/querying/accumulators) chapter.)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_base_types)Base types
...
`DATETIME` | `1970-01-01 00:00:00` | No literal. Can be converted from a correctly formatted string with [`to_datetime()`](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/type-conversion-functions#_to_datetime).  
`VERTEX` | `"Unknown"` | No literal.  
`EDGE` | No edge: `{}` | No literal.  
`JSONOBJECT` | An empty object: `{}` | No literal. Can be converted from a correctly formatted string with [`parse_json_object()`](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/type-conversion-functions#_parse_json_object).  
`JSONARRAY` | An empty array: `[]` | No literal. Can be converted from a correctly formatted string with [`parse_json_array()`](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/type-conversion-functions#_parse_json_array).  
The `FLOAT` and `DOUBLE` data types have the same precision limits as in C++. See [Common Errors and Problems](https://docs.tigergraph.com/gsql-ref/3.11/appendix/common-errors-and-problems) for more details.
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_vertex)Vertex
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_vertex_types)Vertex types
...
When you run a query with a vertex type, the syntax is different for typed vertex parameters and generic vertex parameters. See the [RUN QUERY parameter list](https://docs.tigergraph.com/gsql-ref/3.11/querying/query-operations#parameter-list) for details.
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_edge)Edge
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_edge_types)Edge types
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_vertex_and_edge_attribute_types)Vertex and Edge Attribute Types
...
`DATETIME` | `DATETIME`  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_jsonobject)`JSONOBJECT`
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_assign_a_jsonobject_value_to_a_base_type_variable)Assign a `JSONOBJECT` value to a base type variable
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_jsonarray)`JSONARRAY`
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_assign_a_jsonarray_value_to_a_base_type_variable)Assign a `JSONARRAY` value to a base type variable
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_container_types)Container types
...
To see how container type variables are declared in a GSQL query, see [Local container variables](https://docs.tigergraph.com/gsql-ref/3.11/querying/declaration-and-assignment-statements#_local_container_variable).
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_tuple)Tuple
...
---|---  
**2** | `Secret_Info` has already been defined in [`Investment_Net` Schema](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#Investment_Net-schema).  
```
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_file_object)`FILE` Object
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_local_disk_file)Local disk file
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_s3_object)S3 object
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_define_s3_file_object)Define s3 file object
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_set_s3_connection_credentials)Set S3 connection credentials
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_output)Output
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/data-types#_error_code)Error code
