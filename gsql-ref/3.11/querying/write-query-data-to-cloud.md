...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud)[Next](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/querying/pages/write-query-data-to-cloud.adoc)
### Contents
  * [Using gadmin config](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_using_gadmin_config)
  * [Using GSQL Session Parameters](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_using_gsql_session_parameters)
  * [Unique File Paths to Avoid Conflicts](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_unique_file_paths_to_avoid_conflicts)
  * [Example:](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_using_gadmin_config)Using gadmin config
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_using_gsql_session_parameters)Using GSQL Session Parameters
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_unique_file_paths_to_avoid_conflicts)Unique File Paths to Avoid Conflicts
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/write-query-data-to-cloud#_example)Example:
