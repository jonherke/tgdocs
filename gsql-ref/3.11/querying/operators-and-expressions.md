...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions)[Next](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/querying/pages/operators-and-expressions.adoc)
### Contents
  * [Constants](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_constants)
  * [Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_operators)
  * [Mathematical Operators and Expressions](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_mathematical_operators_and_expressions)
  * [Boolean Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_boolean_operators)
  * [Bit Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_bit_operators)
  * [String Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_string_operators)
  * [Tuple Fields](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_tuple_fields)
  * [Comparison Operators and Conditions](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_comparison_operators_and_conditions)
  * [BETWEEN …​ AND …​](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_between_and)
  * [IS NULL, IS NOT NULL](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_is_null_is_not_null)
  * [LIKE](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_like)
  * [Vertex, edge, and accumulator attributes](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_vertex_edge_and_accumulator_attributes)
  * [Accessing attributes](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_accessing_attributes)
  * [Accumulator Functions](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_accumulator_functions)
  * [Set/Bag Expression and Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_and_operators)
  * [Set/Bag expression operators - UNION, INTERSECT, MINUS](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_operators_union_intersect_minus)
  * [Set/Bag Expression Membership Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_membership_operators)
  * [Subqueries](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_subqueries)
  * [Subquery Limitations](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_subquery_limitations)
  * [Main Components of a Subquery](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_main_components_of_a_subquery)
  * [Parameter types](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_parameter_types)
  * [Return types](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_return_types)
  * [Recursive subqueries](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_recursive_subqueries)
  * [Examples of Expressions](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_examples_of_expressions)
  * [Examples of Expression Statements](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_examples_of_expression_statements)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_constants)Constants
```
constant := numeric | stringLiteral | TRUE | FALSE | GSQL_UINT_MAX
     | GSQL_INT_MAX | GSQL_INT_MIN | TO_DATETIME "(" stringLiteral ")"
ebnf![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_operators)Operators
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_mathematical_operators_and_expressions)Mathematical Operators and Expressions
We support the following standard mathematical operators and meanings. The latter four (`<<` `>>` `&` `|`) are for bitwise operations. See the [Bit Operators](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_bit_operators) section below.
```
mathOperator := "*" | "/" | "%" | "+" | "-" | "<<" | ">>" | "&" | "|"
ebnf![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_operator_precedence)Operator precedence
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example)Example
  * Query
  * Results
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_automatic_numeric_type_casting)Automatic numeric type casting
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_boolean_operators)Boolean Operators
We support the standard Boolean operators and standard order of precedence: `AND`, `OR`, `NOT`
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_bit_operators)Bit Operators
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_string_operators)String Operators
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_tuple_fields)Tuple Fields
The fields of the tuple can be accessed using the dot operator.
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_comparison_operators_and_conditions)Comparison Operators and Conditions
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_between_and)BETWEEN …​ AND …​
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_is_null_is_not_null)IS NULL, IS NOT NULL
`IS NULL` and `IS NOT NULL` can be used for checking whether an optional parameter is given any value.
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example_2)Example
  * Query
  * Results
...
---  
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_like)LIKE
```
expr [NOT] LIKE expr [ESCAPE escape_char]
gsql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
---  
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_escape_escape_char)`ESCAPE escape_char`
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example_3)Example
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_vertex_edge_and_accumulator_attributes)Vertex, edge, and accumulator attributes
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_accessing_attributes)Accessing attributes
...
Dynamic query support The name of the attribute can be parameterized using the **getAttr** and **setAttr** [vertex functions](https://docs.tigergraph.com/gsql-ref/3.11/querying/func/vertex-methods), described later in this section. This allows you to write [dynamic query](https://docs.tigergraph.com/gsql-ref/3.11/querying/query-operations#_dynamic_querying) procedures where the attribute names are specified when you run the query.  
---  
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example_4)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_accumulator_functions)Accumulator Functions
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_previous_value_of_accumulator)Previous value of accumulator
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_and_operators)Set/Bag Expression and Operators
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_operators_union_intersect_minus)Set/Bag expression operators - UNION, INTERSECT, MINUS
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_operator_examples)Set/bag operator examples
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_setbag_expression_membership_operators)Set/Bag Expression Membership Operators
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example_5)Example
  * Query
  * Result
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_subqueries)Subqueries
...
A subquery must end with a [return statement](https://docs.tigergraph.com/gsql-ref/3.11/querying/output-statements-and-file-objects) to pass its output value to a query. Exactly one type is allowed in the `RETURNS` header, and thus the `RETURN` statement can only return one expression.
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_subquery_limitations)Subquery Limitations
  * [Interpreted mode](https://docs.tigergraph.com/gsql-ref/3.11/querying/query-operations#_interpret_query) is not supported.
  * A [distributed query](https://docs.tigergraph.com/gsql-ref/3.11/querying/distributed-query-mode) cannot call another distributed query
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_main_components_of_a_subquery)Main Components of a Subquery
```
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_parameter_types)Parameter types
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_return_types)Return types
A subquery’s return value can be any [base type variable](https://docs.tigergraph.com/gsql-ref/3.11/querying/declaration-and-assignment-statements#_base_type_variables) or accumulator with the following exceptions:
  * If the return type is a `HeapAccum` or `GroupByAccum` that has a user-defined tuple as an element, the user-defined tuple must be [defined at the catalog level](https://docs.tigergraph.com/gsql-ref/3.11/ddl-and-loading/defining-a-graph-schema#_typedef).
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example_6)Example
...
### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_recursive_subqueries)Recursive subqueries
...
#### [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_example_7)Example
  * Subquery
  * Query
  * Result
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_examples_of_expressions)Examples of Expressions
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/querying/operators-and-expressions#_examples_of_expression_statements)Examples of Expression Statements
  * Query
  * Results
