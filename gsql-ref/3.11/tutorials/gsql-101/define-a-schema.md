...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema)[Next](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/tutorials/pages/gsql-101/define-a-schema.adoc)
### Contents
  * [Create a vertex type](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema#_create_a_vertex_type)
  * [Create an edge type](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema#_create_an_edge_type)
  * [Create a graph](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema#_create_a_graph)
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema#_create_a_vertex_type)Create a vertex type
...
We show GSQL keywords in all caps to highlight them in accordance with the [GSQL Style Guide](https://docs.tigergraph.com/gsql-ref/3.11/appendix/gsql-style-guide), but they are case-insensitive.  
---  
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema#_create_an_edge_type)Create an edge type
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/tutorials/gsql-101/define-a-schema#_create_a_graph)Create a graph
