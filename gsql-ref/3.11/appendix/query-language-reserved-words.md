...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words)[Next](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.11/modules/appendix/pages/query-language-reserved-words.adoc)
### Contents
  * [Reserved words](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words#_reserved_words)
  * [Non-reserved keywords](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words#_non_reserved_keywords)
...
There is a separate list for [DDL Keywords & Reserved Words](https://docs.tigergraph.com/gsql-ref/3.11/appendix/keywords-and-reserved-words). The compiler will reject the use of a Reserved Word as a user-defined identifier.
## [](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words#_reserved_words)Reserved words
The following words are reserved for use by the GSQL query language. That is a query may not use any of these words for a user-defined identifier such as the name of a local variable or a local `TUPLE` type. Some of them come from C++, which is a dependency for GSQL.
You should also not use words from the following lists to name vertex or edge types. While GSQL does not raise an error when you define the types, you will not be able to reference the types in a query.
C++ reserved words
  * ALIGNAS
  * ALIGNOF
  * AND
...
## [](https://docs.tigergraph.com/gsql-ref/3.11/appendix/query-language-reserved-words#_non_reserved_keywords)Non-reserved keywords
