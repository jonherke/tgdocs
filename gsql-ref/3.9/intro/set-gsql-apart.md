...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart)[Next](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/intro/pages/set-gsql-apart.adoc)
### Contents
  * [Designed for analytics](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_designed_for_analytics)
  * [Turing-complete](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_turing_complete)
  * [Fast loading and querying](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_fast_loading_and_querying)
  * [SQL-like](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_sql_like)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_designed_for_analytics)Designed for analytics
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_fast_loading_and_querying)Fast loading and querying
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/intro/set-gsql-apart#_sql_like)SQL-like
