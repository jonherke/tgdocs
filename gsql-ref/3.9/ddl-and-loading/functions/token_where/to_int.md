...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int)[Next](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/ddl-and-loading/pages/functions/token_where/to_int.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int#_syntax)
  * [Return value](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int#_return_value)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int#_syntax)Syntax
`to_int( token )`
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int#_return_value)Return value
`INT`. The integer converted from the input token.
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/to_int#_example)Example
