...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add)[Next](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/ddl-and-loading/pages/functions/reducer/add.adoc)
### Contents
  * [Accepted parameter types](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add#_accepted_parameter_types)
  * [Return values](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add#_return_values)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add#_examples)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add#_accepted_parameter_types)Accepted parameter types
`INT`, `UINT`, `FLOAT`, `DOUBLE`, `STRING`, `LIST`, `SET`, `MAP`
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add#_return_values)Return values
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/reducer/add#_examples)Examples
