...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/)[Next](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/ddl-and-loading/pages/functions/token_where/index.adoc)
### Contents
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/#_examples)
  * [Single token function](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/#_single_token_function)
  * [Token functions with logical operators](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/#_token_functions_with_logical_operators)
...
Besides the functions in the following table, all [token functions for attribute expressions](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/) can also be used in the `WHERE` clause, including [user-defined functions](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/add-token-function).   
---  
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/#_examples)Examples
### [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/#_single_token_function)Single token function
...
### [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token_where/#_token_functions_with_logical_operators)Token functions with logical operators
