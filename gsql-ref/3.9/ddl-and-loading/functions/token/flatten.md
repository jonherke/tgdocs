...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten)[Next](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/ddl-and-loading/pages/functions/token/flatten.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_syntax)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_parameters)
  * [Return type](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_return_type)
  * [Examples](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_examples)
  * [One-level flatten](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_one_level_flatten)
  * [Two-level flatten](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_two_level_flatten)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_syntax)Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_parameters)Parameters
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_return_type)Return type
`STRING`
## [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_examples)Examples
### [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_one_level_flatten)One-level flatten
...
102 | science_fiction  
102 | Chinese  
### [](https://docs.tigergraph.com/gsql-ref/3.9/ddl-and-loading/functions/token/flatten#_two_level_flatten)Two-level flatten
