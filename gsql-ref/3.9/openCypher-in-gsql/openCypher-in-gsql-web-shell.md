...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell)[Next](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/openCypher-in-gsql/pages/openCypher-in-gsql-web-shell.adoc)
### Contents
  * [Example: Interpreted Query](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_interpreted_query)
  * [Example: Installed Query](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_installed_query)
...
For more details on the current openCypher support, see [openCypher in GSQL](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql).
## [](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_interpreted_query)Example: Interpreted Query
```
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.9/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_installed_query)Example: Installed Query
