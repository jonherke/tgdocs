...
### [](https://docs.tigergraph.com/gsql-ref/3.9/querying/query-operations#_dynamic_querying)Dynamic querying
...
### [](https://docs.tigergraph.com/gsql-ref/3.9/querying/query-operations#_syntax)Syntax
```
