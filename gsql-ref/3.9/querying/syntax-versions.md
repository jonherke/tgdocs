...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions)[Next](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/querying/pages/syntax-versions.adoc)
### Contents
  * [Differences between V1 and V2](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions#_differences_between_v1_and_v2)
  * [Changing a query from V1 to V2](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions#_changing_a_query_from_v1_to_v2)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions#_differences_between_v1_and_v2)Differences between V1 and V2
...
Source vertex set | The source vertex set in a step in the `FROM` clause must be [a vertex set (seed set)](https://docs.tigergraph.com/gsql-ref/3.9/querying/declaration-and-assignment-statements#_vertex_set_variables) declared earlier in the query. | The [source vertex set path pattern](https://docs.tigergraph.com/gsql-ref/3.9/querying/select-statement/#<em>source_vertex_set) in `FROM` clause can be a vertex set, a vertex type, or use or `ANY` to indicate any vertex.  
Table 2. Other differences Feature | V1 | V2  
---|---|---  
[`POST-ACCUM` clause](https://docs.tigergraph.com/gsql-ref/3.9/querying/select-statement/#_post_accum_clause) | 
...
[SQL-like `SELECT` statement](https://docs.tigergraph.com/gsql-ref/3.9/querying/select-statement/sql-like-select-statement) | Not supported. | Supported.  
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions#_changing_a_query_from_v1_to_v2)Changing a query from V1 to V2
