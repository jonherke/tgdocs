...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/appendix/legacy-tg-versions)[Next](https://docs.tigergraph.com/gsql-ref/3.9/appendix/legacy-tg-versions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/appendix/legacy-tg-versions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/appendix/legacy-tg-versions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/appendix/pages/legacy-tg-versions.adoc)
### Contents
  * [LTS Versions](https://docs.tigergraph.com/gsql-ref/3.9/appendix/legacy-tg-versions#_lts_versions)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/appendix/legacy-tg-versions#_lts_versions)LTS Versions
  * [3.6](https://docs.tigergraph.com/gsql-ref/3.6/intro/intro)


Documentation will be available on our legacy documentation website. * 3.8 * 3.7 * 3.5 * 3.4 * 3.3 * 3.2
