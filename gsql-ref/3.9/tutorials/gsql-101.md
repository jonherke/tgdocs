...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/)[Next](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/tutorials/pages/gsql-101/index.adoc)
### Contents
  * [Prerequisites](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_prerequisites)
  * [What is a graph?](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_what_is_a_graph)
  * [Data set](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_data_set)
  * [Prepare your TigerGraph environment](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_prepare_your_tigergraph_environment)
  * [Restarting TigerGraph](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_restarting_tigergraph)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_prerequisites)Prerequisites
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_what_is_a_graph)What is a graph?
...
![Illustration of a Person vertex with a Friendship edge](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/_images/friendship-social-graph-schema.png)
...
![Diagram of seven Person vertices and seven Friendship edges](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/_images/friendship-social-graph.png)
...
### [](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_data_set)Data set
...
### [](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_prepare_your_tigergraph_environment)Prepare your TigerGraph environment
...
Having prepared your environment, you are now ready to start the following sequence to get started with GSQL 101:
  ...
  * [Load data](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/load-data-gsql-101)
  * [Run built-in queries](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/built-in-select-queries)
  * [Develop parameterized queries](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/parameterized-gsql-query)
  * [Review](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/review)


## [](https://docs.tigergraph.com/gsql-ref/3.9/tutorials/gsql-101/#_restarting_tigergraph)Restarting TigerGraph
