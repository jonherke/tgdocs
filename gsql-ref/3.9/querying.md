...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.9/querying/)[Next](https://docs.tigergraph.com/gsql-ref/3.9/querying/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.9/querying/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.9/querying/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.9/modules/querying/pages/index.adoc)
### Contents
  * [What is a GSQL query?](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_what_is_a_gsql_query)
  * [Query syntax versions](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_query_syntax_versions)
  * [Query operations](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_query_operations)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_syntax)
  * [Example graphs](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_example_graphs)
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_what_is_a_gsql_query)What is a GSQL query?
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_query_syntax_versions)Query syntax versions
The current default syntax version for GSQL queries is Syntax V2. Most documentation in this section describes the language in Syntax V2. To see the different between the legacy version and V2, see [Query Language Syntax Versions](https://docs.tigergraph.com/gsql-ref/3.9/querying/syntax-versions).
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_query_operations)Query operations
A typical workflow for working with GSQL queries is to [create the query](https://docs.tigergraph.com/gsql-ref/3.9/querying/query-operations#_create_query), [install the query](https://docs.tigergraph.com/gsql-ref/3.9/querying/query-operations#_install_query), and then [run the query](https://docs.tigergraph.com/gsql-ref/3.9/querying/query-operations#_run_query).
GSQL also supports [interpreting a query](https://docs.tigergraph.com/gsql-ref/3.9/querying/query-operations#interpret-a-created-query), which allows users to skip query installation and execute the query directly.
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_syntax)Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/3.9/querying/#_example_graphs)Example graphs
...
[Download graph files and loading script](https://docs.tigergraph.com/gsql-ref/3.9/querying/_attachments/gsql_ref_examples_2.0.tar.gz).
