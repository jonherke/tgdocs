...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/)[Next](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/querying/pages/query-optimizer/index.adoc)
### Contents
  * [Heuristics-based optimization](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/#_heuristics_based_optimization)
  * [Cost-based optimization](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/#_cost_based_optimization)
...
When writing a GSQL query with multi-hop `SELECT` statements, the [path pattern (Syntax V2)](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/from-clause-v2#_path_pattern) specified in the `FROM` clause is declarative. In other words, it specifies the structure of paths to be matched, without specifying the particulars of how the graph is traversed to find these paths. It is the query optimizer’s job to determine the best graph traversal plan to satisfy the query.
...
---  
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/#_heuristics_based_optimization)Heuristics-based optimization
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/#_cost_based_optimization)Cost-based optimization
...
To enable cost-based optimization, see [Enabling Cost-Based Optimization](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/enable-cost-optimizer).
For references on the REST endpoints for gathering statistics for the optimizer, see [Statistics REST APIs](https://docs.tigergraph.com/gsql-ref/4.2/querying/query-optimizer/stats-api).
