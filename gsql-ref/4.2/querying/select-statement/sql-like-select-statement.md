...
[Products](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/querying/pages/select-statement/sql-like-select-statement.adoc)
### Contents
  * [Example](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_example)
  * [GROUP BY Clause](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_group_by_clause)
  * [Coordinating SELECT and GROUP BY](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_coordinating_select_and_group_by)
  * [Implied GROUP BY](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_implied_group_by)
  * [Examples](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_examples)
...
The SQL-like form may use the [GROUP BY clause](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement) but may not use the `ACCUM` and `POST-ACCUM` clauses.
...
---  
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_example)Example
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_group_by_clause)GROUP BY Clause
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_coordinating_select_and_group_by)Coordinating SELECT and GROUP BY
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_implied_group_by)Implied GROUP BY
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/select-statement/sql-like-select-statement#_examples)Examples
