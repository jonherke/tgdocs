...
[Products](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/querying/pages/write-output-to-cloud.adoc)
### Contents
  * [Using gadmin config](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_using_gadmin_config)
  * [Using GSQL Session Parameters](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_using_gsql_session_parameters)
  * [Unique File Paths to Avoid Conflicts](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_unique_file_paths_to_avoid_conflicts)
  * [Example:](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_using_gadmin_config)Using gadmin config
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_using_gsql_session_parameters)Using GSQL Session Parameters
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_unique_file_paths_to_avoid_conflicts)Unique File Paths to Avoid Conflicts
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/write-output-to-cloud#_example)Example:
