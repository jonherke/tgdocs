...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions)[Next](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/querying/pages/func/context-functions.adoc)
### Contents
  * [Enable Context Functions](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_enable_context_functions)
  * [current_roles()](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_current_roles)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_syntax)
  * [Description](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_description)
  * [Return type](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_return_type)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_parameters)
  * [Example](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_example)
  * [is_granted_to_current_roles(string roleName)](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_is_granted_to_current_rolesstring_rolename)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_syntax_2)
  * [Description](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_description_2)
  * [Return type](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_return_type_2)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_parameters_2)
  * [Example](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_example_2)
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_enable_context_functions)Enable Context Functions
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_current_roles)current_roles()
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_syntax)Syntax
`current_roles()`
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_description)Description
Returns a `SetAccum` of strings of role names granted to the current user.
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_return_type)Return type
`STRING`
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_parameters)Parameters
Parameter | Description | Data type  
---|---|---  
None | None | None  
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_example)Example
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_is_granted_to_current_rolesstring_rolename)is_granted_to_current_roles(string roleName)
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_syntax_2)Syntax
`is_granted_to_current_roles( "roleName" )`
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_description_2)Description
Returns true/false if the current user holds a particular role specified in the parameter.
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_return_type_2)Return type
`BOOL`
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_parameters_2)Parameters
Parameter | Description | Data type  
---|---|---  
`roleName` | A role name to check against current users roles. | `STRING`  
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/context-functions#_example_2)Example
