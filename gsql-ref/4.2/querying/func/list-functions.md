...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions)[Next](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/querying/pages/func/list-functions.adoc)
# List Functions
This page lists the list (ListAccum) functions that are available in the GSQL query language.
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_head)`head()`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_syntax)Syntax
`head(list)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_description)Description
`head()` returns the first element in a list. It is semantically the same as `list.get(0)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_return_type)Return type
`ELEMENT`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_parameters)Parameters
Parameter | Description | Data type  
---|---|---  
`list` | A ListAccum parameter, where we want to retrieve the first element in the list | `ListAccum<ELEMENT>`  
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_example)Example
```
head(["a", "b", "c"]) -> "a"
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_last)`last()`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_syntax_2)Syntax
`last(list)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_description_2)Description
`last()` returns the last element in a list. It is semantically the same as `list.get(list.size() - 1)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_return_type_2)Return type
`ELEMENT`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_parameters_2)Parameters
Parameter | Description | Data type  
---|---|---  
`list` | A ListAccum parameter, where we want to retrieve the last element in the list | `ListAccum<ELEMENT>`  
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_example_2)Example
```
last(["a", "b", "c"]) -> "c"
text![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_range)`range()`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_syntax_3)Syntax
`range(start, end [, step])`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_description_3)Description
...
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_return_type_3)Return type
`ListAccum<INT>`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_parameters_3)Parameters
Parameter | Description | Data type  
---|---|---  
...
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_example_3)Example
```
...
---  
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_size)`size()`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_syntax_4)Syntax
`size(list)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_description_4)Description
`size()` returns the number of elements in a `ListAccum`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_return_type_4)Return type
`UINT`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_parameters_4)Parameters
Parameter | Description | Data type  
---|---|---  
`list` | A ListAccum parameter | `ListAccum<ELEMENT>`  
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_example_4)Example
```
size(["a", "b", "c"]) -> 3
text![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_split)`split()`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_syntax_5)Syntax
`split(original, splitDelimiter)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_description_5)Description
`split()` returns a list of strings resulting from the splitting of the original string on matches of the given delimiter.
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_return_type_5)Return type
`ListAccum<STRING>`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_parameters_5)Parameters
Parameter | Description | Data type  
---|---|---  
`original` | The original string to split | `STRING`  
`splitDelimiter` | The delimiter to split the original string on | `STRING`  
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_example_5)Example
```
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_tail)`tail()`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_syntax_6)Syntax
`tail(list)`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_description_6)Description
`tail()` returns the copy of the list that includes all but the first element in the parameter list.
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_return_type_6)Return type
`ListAccum<ELEMENT>`
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_parameters_6)Parameters
Parameter | Description | Data type  
---|---|---  
`list` | A ListAccum parameter | `ListAccum<ELEMENT>`  
#### [](https://docs.tigergraph.com/gsql-ref/4.2/querying/func/list-functions#_example_6)Example
```
tail(["a", "b", "c"]) -> ["b", "c"]
text![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
