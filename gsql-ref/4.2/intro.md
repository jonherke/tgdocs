...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/intro/)[Next](https://docs.tigergraph.com/gsql-ref/4.2/intro/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/intro/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/intro/)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Query Language Reference](https://docs.tigergraph.com/gsql-ref/4.2/intro/)


[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/intro/pages/index.adoc)
### Contents
  * [Graph and Vector Querying](https://docs.tigergraph.com/gsql-ref/4.2/intro/#_graph_and_vector_querying)
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/intro/#_graph_and_vector_querying)Graph and Vector Querying
![getstarted](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/getstarted-homecard.png) **Tutorials** Step-by-step tutorials to help you get started creating graphs and querying. [GSQL Tutorial](https://github.com/tigergraph/ecosys/blob/master/tutorials/GSQL.md) | [Accumulators](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial) | [OpenCypher](https://github.com/tigergraph/ecosys/blob/master/tutorials/Cypher.md) | [VECTOR search](https://github.com/tigergraph/ecosys/blob/master/tutorials/VectorSearch.md) | ![types](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/vector.png) **Hybrid Vector Search** Use graph+vector search for powerfully selective searches, supercharging AI [Vector Database Operations](https://docs.tigergraph.com/gsql-ref/4.2/vector/) | [Hybrid Graph+Vector Search Tutorial](https://github.com/tigergraph/ecosys/blob/master/tutorials/VectorSearch.md)  
---|---  
![graphstudio](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/img.png) **openCypher in GSQL** TigerGraph’s GSQL query language supports many openCypher features. [openCypher in GSQL Tutorial (on GitHub) ](https://github.com/tigergraph/ecosys/blob/master/tutorials/Cypher.md) | [openCypher in GSQL](https://docs.tigergraph.com/gsql-ref/4.2/openCypher-in-gsql/) | ![basics](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/lang.png) **Language Basics** Learn [How to run GSQL](https://docs.tigergraph.com/gsql-ref/4.2/basics/running-gsql) and [Database Data Types](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/attribute-data-types).  
![types](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/schema-homecard.png) **Define a Schema** Use the Database Definition Language (DDL) syntax to define the [schema](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/) the blueprint for data elements in a database. | ![query](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/querying-homecard.png) **Graph Querying** [GSQL Query Language](https://docs.tigergraph.com/gsql-ref/4.2/querying/) is a language for the exploration and analysis of large scale graphs.  
![loadingjobs](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/DataLoading-Homecard.png) **Loading Data** [Loading Jobs](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/loading-jobs) are a unique and powerful feature used to load data into the database. | ![apendix](https://docs.tigergraph.com/gsql-ref/4.2/intro/_images/documentation-homecard.png) **Appendix** Checkout the other information on GSQL under the "Appendix" dropdown for more information. [Cheat Sheets |](https://docs.tigergraph.com/gsql-ref/4.2/appendix/cheat-sheets) [GSQL Style Guide](https://docs.tigergraph.com/gsql-ref/4.2/appendix/gsql-style-guide)  
