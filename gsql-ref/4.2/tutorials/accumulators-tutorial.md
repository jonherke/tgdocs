...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial)[Next](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/tutorials/pages/accumulators-tutorial.adoc)
### Contents
  * [What is an Accumulator?](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_what_is_an_accumulator)
  * [Global vs. Vertex-attached Accumulator](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_global_vs_vertex_attached_accumulator)
  * [ACCUM vs. POST-ACCUM](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_accum_vs_post_accum)
  * [Conclusion](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_conclusion)
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_what_is_an_accumulator)**What is an Accumulator?**
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_global_vs_vertex_attached_accumulator)**Global vs. Vertex-attached Accumulator**
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_accum_vs_post_accum)**ACCUM vs. POST-ACCUM**
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial#_conclusion)**Conclusion**
