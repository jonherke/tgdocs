...
[Products](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/tutorials/pages/pattern-matching/adv/per-clause.adoc)
### Contents
  * [Introduction](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_introduction)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_syntax)
  * [Semantics](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_semantics)
  * [PER Clause Examples](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_per_clause_examples)
  * [Performance and Best Practices](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_performance_and_best_practices)
  * [Use PER (target) If Possible](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_use_per_target_if_possible)
  * [Write Patterns with Smallest Expected Vertex Set on the Left](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_write_patterns_with_smallest_expected_vertex_set_on_the_left)
  * [Specify Complete Type Information](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_specify_complete_type_information)
  * [LDBC Benchmark Queries](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_ldbc_benchmark_queries)
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_introduction)Introduction
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_syntax)Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_semantics)Semantics
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_per_clause_examples)PER Clause Examples
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_performance_and_best_practices)Performance and Best Practices
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_use_per_target_if_possible)Use PER (target) If Possible
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_write_patterns_with_smallest_expected_vertex_set_on_the_left)Write Patterns with Smallest Expected Vertex Set on the Left
...
### [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_specify_complete_type_information)Specify Complete Type Information
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/adv/per-clause#_ldbc_benchmark_queries)LDBC Benchmark Queries
