...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words)[Next](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/appendix/pages/query-language-reserved-words.adoc)
### Contents
  * [Reserved words](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words#_reserved_words)
  * [Non-reserved keywords](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words#_non_reserved_keywords)
...
There is a separate list for [DDL Keywords & Reserved Words](https://docs.tigergraph.com/gsql-ref/4.2/appendix/keywords-and-reserved-words). The compiler will reject the use of a Reserved Word as a user-defined identifier.
## [](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words#_reserved_words)Reserved words
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/appendix/query-language-reserved-words#_non_reserved_keywords)Non-reserved keywords
