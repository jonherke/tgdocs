...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal)[Next](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.2/modules/ddl-and-loading/pages/functions/token_where/gsql_token_equal.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal#_syntax)
  * [Return value](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal#_return_value)
  * [Example](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal#_syntax)Syntax
`gsql_token_equal( string1, string2 )`
## [](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal#_return_value)Return value
`BOOL`. Returns true if two strings are exactly the same, case-sensitive. Returns false if otherwise.
## [](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/functions/token_where/gsql_token_equal#_example)Example
```
