...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide)[Next](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/appendix/pages/gsql-style-guide.adoc)
### Contents
  * [General](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_general)
  * [Naming](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_naming)
  * [Spacing](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_spacing)
  * [Block indentation](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_block_indentation)
  * [Line length](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_line_length)
  * [Keyword justification](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_keyword_justification)
  * [Comments](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_comments)
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_general)General
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_naming)Naming
...
| `@num_fraudsters`[[1](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_footnotedef_1 "View footnote.")]  
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_spacing)Spacing
### [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_block_indentation)Block indentation
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_line_length)Line length
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_recommended)Recommended
```
CREATE QUERY hello(VERTEX<Person> p) {
  start = {p};
  result = SELECT tgt
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_not_recommended)Not recommended
```
CREATE QUERY hello(VERTEX<Person> p) {
  Start = {p};
  Result = SELECT tgt
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_keyword_justification)Keyword justification
...
---|---  
## [](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_comments)Comments
...
[1](https://docs.tigergraph.com/gsql-ref/3.10/appendix/gsql-style-guide#_footnoteref_1). If you want to use `num` to refer to a quantity, always put it at the beginning. For example, use `num_students` to refer to the number of students instead of `students_num`
