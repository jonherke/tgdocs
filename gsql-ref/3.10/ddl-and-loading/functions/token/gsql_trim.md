...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim)[Next](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/ddl-and-loading/pages/functions/token/gsql_trim.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_syntax)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_parameters)
  * [Return type](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_return_type)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_syntax)Syntax
`gsql_trim(in_string)`
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_parameters)Parameters 

in_string
    
Required. The string whose leading and trailing whitespace to trim.
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_return_type)Return type
`STRING`
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_trim#_example)Example
```
