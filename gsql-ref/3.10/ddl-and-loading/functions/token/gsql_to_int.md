...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int)[Next](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/ddl-and-loading/pages/functions/token/gsql_to_int.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_syntax)
  * [Parameters](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_parameters)
  * [Return type](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_return_type)
  * [Example](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_syntax)Syntax
`gsql_to_int(in_string)`
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_parameters)Parameters 

in_string
    
The string representation of an integer.
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_return_type)Return type
`INT`
## [](https://docs.tigergraph.com/gsql-ref/3.10/ddl-and-loading/functions/token/gsql_to_int#_example)Example
```
gsql_to_int("120") -> 120
gsql_to_int("-123") -> -123
```
