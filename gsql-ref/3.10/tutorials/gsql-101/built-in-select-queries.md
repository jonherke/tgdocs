...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries)[Next](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/tutorials/pages/gsql-101/built-in-select-queries.adoc)
### Contents
  * [Get vertex/edge statistics](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries#_get_vertexedge_statistics)
  * [Select vertices](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries#_select_vertices)
  * [Select edges](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries#_select_edges)
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries#_get_vertexedge_statistics)Get vertex/edge statistics
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries#_select_vertices)Select vertices
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/gsql-101/built-in-select-queries#_select_edges)Select edges
