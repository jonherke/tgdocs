...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml)[Next](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/tutorials/pages/pattern-matching/adv/dml.adoc)
### Contents
  * [INSERT](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml#_insert)
  * [UPDATE](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml#_update)
  * [DELETE](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml#_delete)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml#_insert)INSERT
Pattern matching Insert is supported at both the top-level and within-SELECT levels, using the same syntax as in classic GSQL. You can insert vertices and edges.
  * For a top-level statement, use [INSERT INTO](https://docs.tigergraph.com/gsql-ref/3.10/querying/data-modification-statements#_insert_into_statement),
  * Inside an ACCUM or POST-ACCUM clause, use the [DML-sub INSERT](https://docs.tigergraph.com/gsql-ref/3.10/querying/data-modification-statements#_dml_sub_insert) statement.
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml#_update)UPDATE
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/tutorials/pattern-matching/adv/dml#_delete)DELETE
