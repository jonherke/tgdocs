...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/intro/)[Next](https://docs.tigergraph.com/gsql-ref/3.10/intro/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/intro/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/intro/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/intro/pages/index.adoc)
### Contents
  * [Get to Know GSQL](https://docs.tigergraph.com/gsql-ref/3.10/intro/#_get_to_know_gsql)
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/intro/#_get_to_know_gsql)Get to Know GSQL
![getstarted](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/getstarted-homecard.png) **Tutorials** A set of step-by-step tutorials to help you get started using GSQL in TigerGraph. [GSQL 101 |](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/gsql-101/) [Pattern Maching Tutorial |](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/pattern-matching/) [Accumulators Tutorial](https://docs.tigergraph.com/gsql-ref/4.2/tutorials/accumulators-tutorial) | ![graphstudio](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/img.png) **openCypher in GSQL** TigerGraph’s GSQL query language supports many openCypher features. [openCypher in GSQL |](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql) [Clause Extension |](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-gsql-from-clause-extension) [openCypher in Web Shell](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell)  
---|---  
![basics](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/lang.png) **System & Language Basics** Learn the [Basic Elements](https://docs.tigergraph.com/gsql-ref/4.2/basics/running-gsql) that make up the GSQL Data Definition. | ![types](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/attrbutes-homecard.png) **Attribute Data Types** Learn about [Vertex and Edge Attributes](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/attribute-data-types) and the different data types that can be stored in them.  
![types](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/schema-homecard.png) **Schema Definition** Use the Database Definition Language (DDL) syntax to define the [schema](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/) the blueprint for data elements in a database. | ![query](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/querying-homecard.png) **Querying** [GSQL Query Language](https://docs.tigergraph.com/gsql-ref/4.2/querying/) is a language for the exploration and analysis of large scale graphs.  
![loadingjobs](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/DataLoading-Homecard.png) **Loading Jobs** [Loading Jobs](https://docs.tigergraph.com/gsql-ref/4.2/ddl-and-loading/loading-jobs) are a unique and powerful feature used to load data into the database. | ![apendix](https://docs.tigergraph.com/gsql-ref/3.10/intro/_images/documentation-homecard.png) **Appendix** Checkout the other information on GSQL under the "Appendix" dropdown for more information. [Cheat Sheets |](https://docs.tigergraph.com/gsql-ref/4.2/appendix/cheat-sheets) [GSQL Style Guide](https://docs.tigergraph.com/gsql-ref/4.2/appendix/gsql-style-guide)  
