...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/)[Next](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/querying/pages/func/index.adoc)
# Functions
...
Built-in functions:
  ...
  * [Datetime functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/datetime-functions)
  * [Edge methods](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/edge-methods)
  * [JSON array functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/jsonarray-methods)
  * [JSON object functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/json-object-methods)
  * [Mathematical functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/mathematical-functions)
  * [String functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/string-functions)
  * [Type conversion functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/type-conversion-functions)
  * [Vertex functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/vertex-methods)
...
In GSQL, users can supplement the language by defining their own Query User-Defined Functions (Query UDF). To learn about how to define a Query UDF, see [Query User-Defined Functions](https://docs.tigergraph.com/gsql-ref/3.10/querying/func/query-user-defined-functions).
