...
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_heapaccum)HeapAccum
...
You must have defined a custom [tuple type](https://docs.tigergraph.com/gsql-ref/3.10/querying/data-types#_tuple) to declare a `HeapAccum`, and one of the fields in the tuple must be a data type that can be sorted.
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_functions_2)Functions
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_example_11)Example
  * Query
  * Results
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_groupbyaccum)GroupByAccum
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_example_12)Example
  * Query
  * Results
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_known_issues)Known Issues
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_nested_accumulators)Nested Accumulators
...
```
  ...
  4. ArrayAccum: Unlike the other accumulators in this list, where nesting is optional, nesting is mandatory for ArrayAccum. See the [ArrayAccum](https://docs.tigergraph.com/gsql-ref/3.10/querying/accumulators#_arrayaccum) section.
