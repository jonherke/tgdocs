...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api)[Next](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/querying/pages/query-optimizer/stats-api.adoc)
### Contents
  * [Cardinality](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_cardinality)
  * [Compute cardinality statistics](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_compute_cardinality_statistics)
  * [Retrieve cardinality statistics](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_retrieve_cardinality_statistics)
  * [Delete cardinality statistics](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_delete_cardinality_statistics)
  * [Histogram](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_histogram)
  * [Compute histogram statistics](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_compute_histogram_statistics)
  * [Retrieve histogram statistics](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_retrieve_histogram_statistics)
  * [Delete histogram statistics](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_delete_histogram_statistics)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_cardinality)Cardinality
The following endpoints compute, fetch and delete vertex and edge counts (cardinality) of a graph.
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_compute_cardinality_statistics)Compute cardinality statistics
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_parameters)Parameters
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_examples)Examples
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_retrieve_cardinality_statistics)Retrieve cardinality statistics
`GET :14240/gsqlserver/gsql/stats/card`
This endpoint retrieves the cardinality statistics of a graph.
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_parameters_2)Parameters
Parameter | Description | Data type  
---|---|---  
`graph` | Name of the graph. Required. | `STRING`  
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_examples_2)Examples
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_delete_cardinality_statistics)Delete cardinality statistics
`DELETE :14240/gsqlserver/gsql/stats/card`
This endpoint deletes the cardinality statistics of a graph.
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_parameters_3)Parameters
Parameter | Description | Data type  
---|---|---  
`graph` | Name of the graph. Required. | `STRING`  
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_examples_3)Examples
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_histogram)Histogram
Histograms store information about the distribution of attribute values.
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_compute_histogram_statistics)Compute histogram statistics
`POST :14240/gsqlserver/gsql/stats/histogram`
This endpoint computes histograms for a specified attribute of a vertex type.
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_parameters_4)Parameters
No URL parameters. Provide parameters in the request body.
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_request_body)Request body
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_examples_4)Examples
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_retrieve_histogram_statistics)Retrieve histogram statistics
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_parameters_5)Parameters
Parameter | Description | Data type  
---|---|---  
`graph` | Name of the graph. | `STRING`  
`vertex` | Name of the vertex type. | `STRING`  
...
`to` | Target edge type of a refined edge type. | `STRING`  
`attribute` | Name of the attribute. | `STRING`  
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_examples_5)Examples
...
### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_delete_histogram_statistics)Delete histogram statistics
...
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_parameters_6)Parameters
Parameter | Description | Data type  
---|---|---  
`graph` | Name of the graph. | `STRING`  
`vertex` | Name of the vertex type. | `STRING`  
...
`to` | Target edge type of a refined edge type. | `STRING`  
`attribute` | Name of the attribute. | `STRING`  
#### [](https://docs.tigergraph.com/gsql-ref/3.10/querying/query-optimizer/stats-api#_examples_6)Examples
