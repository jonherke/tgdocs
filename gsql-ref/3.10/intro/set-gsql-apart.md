...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart)[Next](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/intro/pages/set-gsql-apart.adoc)
### Contents
  * [Designed for analytics](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_designed_for_analytics)
  * [Turing-complete](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_turing_complete)
  * [Fast loading and querying](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_fast_loading_and_querying)
  * [SQL-like](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_sql_like)
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_designed_for_analytics)Designed for analytics
...
## [](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_turing_complete)Turing-complete
GSQL is Turing-complete with full support for imperative and procedural programming, ideal for algorithmic computation. The Turing completeness of the language, especially with the conventional [control flow statements](https://docs.tigergraph.com/gsql-ref/3.10/querying/control-flow-statements), allows users to describe any algorithm with GSQL.
TigerGraph offers an [open-source data science library of algorithms](https://docs.tigergraph.com/graph-ml/3.10/intro/) implemented entirely in GSQL, including [Louvain algorithm for community detection](https://docs.tigergraph.com/graph-ml/3.10/community-algorithms/louvain) and the [PageRank algorithm](https://docs.tigergraph.com/graph-ml/3.10/centrality-algorithms/pagerank), demonstrating GSQL’s ability to describe complex algorithms.
## [](https://docs.tigergraph.com/gsql-ref/3.10/intro/set-gsql-apart#_fast_loading_and_querying)Fast loading and querying
...
SELECT p.*
FROM Product p
ORDER BY p.ProductName;sql![copy icon](https://docs.tigergraph.com/_/img/octicons-16.svg#view-clippy)Copied!
```
|  ```
