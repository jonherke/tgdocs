...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell)[Next](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/3.10/modules/openCypher-in-gsql/pages/openCypher-in-gsql-web-shell.adoc)
### Contents
  * [Example: Interpreted Query](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_interpreted_query)
  * [Example: Installed Query](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_installed_query)
...
Follow these two simple rules:
  1. Use the keyword `OPENCYPHER` to specify the query type when you `CREATE` or `INTERPRET` a query:
     * `INTERPRET OPENCYPHER QUERY`
     * `CREATE OPENCYPHER QUERY`
  2. Replace the body of the query procedure with OpenCypher instead of GSQL. End with a `RETURN` clause.


For more details on the current openCypher support, see [openCypher in GSQL](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql).
## [](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_interpreted_query)Example: Interpreted Query
```
...
---  
## [](https://docs.tigergraph.com/gsql-ref/3.10/openCypher-in-gsql/openCypher-in-gsql-web-shell#_example_installed_query)Example: Installed Query
  1. Create an openCypher query.
```
...
Note that you don’t need to specify `OPENCYPHER` when you install or run the query. In particular, `INSTALL QUERY ALL` will work on a combination of GSQL and openCypher queries.
