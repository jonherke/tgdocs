...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/review)[Next](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/review)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/review)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/review)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Review - GSQL 101](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/review)


[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/tutorials/pages/gsql-101/review.adoc)
# Review - GSQL 101
...
Want to learn more?
  * To learn to do the same types of operations using the GraphStudio Visual SDK and UI, see the [TigerGraph GraphStudio UI Guide](https://docs.tigergraph.com/gui/4.2/graphstudio/overview).
  * Continue learning [Pattern Matching](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/pattern-matching/).
  * To discuss and get help with fellow GSQL users and GSQL developers, join the [GSQL community forum](https://community.tigergraph.com/).
