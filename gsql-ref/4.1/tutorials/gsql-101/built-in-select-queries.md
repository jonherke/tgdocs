...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries)[Next](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Run Built-in Queries - GSQL 101](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries)


[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/tutorials/pages/gsql-101/built-in-select-queries.adoc)
### Contents
  * [Get vertex/edge statistics](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries#_get_vertexedge_statistics)
  * [Select vertices](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries#_select_vertices)
  * [Select edges](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries#_select_edges)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries#_get_vertexedge_statistics)Get vertex/edge statistics
...
REST endpoints return results in JSON format. However, JSON data can’t be read easily from JSON files by using bash script like other normal files. The `jq` tool is used to solve this problem. We recommend you install jq and redirect the REST call result to jq before it is output.  
---  
Linux Shell
```
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries#_select_vertices)Select vertices
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/tutorials/gsql-101/built-in-select-queries#_select_edges)Select edges
...
For more built-in REST endpoints, visit the [Built-in Endpoints page](https://docs.tigergraph.com/tigergraph-server/4.2/API/built-in-endpoints).
