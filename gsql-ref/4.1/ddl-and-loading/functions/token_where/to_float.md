...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float)[Next](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/ddl-and-loading/pages/functions/token_where/to_float.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float#_syntax)
  * [Return value](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float#_return_value)
  * [Example](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float#_syntax)Syntax
`to_float( token )`
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float#_return_value)Return value
`FLOAT`. The floating point value converted from integers.
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/token_where/to_float#_example)Example
