...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max)[Next](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/ddl-and-loading/pages/functions/reducer/max.adoc)
### Contents
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_syntax)
  * [Accepted parameter types](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_accepted_parameter_types)
  * [Return value](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_return_value)
  * [Example](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_example)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_syntax)Syntax
`REDUCE( max (arg) )`
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_accepted_parameter_types)Accepted parameter types
This function only accepts parameters that can be interpreted as a numeric type.
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_return_value)Return value
`INT`, `UINT`, `FLOAT`, `DOUBLE`: maximum of all arg values cumulatively received
## [](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/functions/reducer/max#_example)Example
