...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions)[Next](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions)
...
[](https://docs.tigergraph.com/home/)
  ...
  * [Query Descriptions](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions)


[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/querying/pages/query-descriptions.adoc)
### Contents
  * [Update description](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_update_description)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_syntax)
  * [Show description](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_show_description)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_syntax_2)
  * [Drop description](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_drop_description)
  * [Syntax](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_syntax_3)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_update_description)Update description
After creating a query, you can add a description for the query.
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_syntax)Syntax
UPDATE DESCRIPTION OF <objectType> <objectName> [ON GRAPH <graphName>] <description>
Required privilege UPDATE_QUERY
...
---  
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_show_description)Show description
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_syntax_2)Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_drop_description)Drop description
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-descriptions#_syntax_3)Syntax
