...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions)[Next](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/querying/pages/func/aggregation-functions.adoc)
### Contents
  * [avg()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_avg)
  * [count()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_count)
  * [max()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_max)
  * [min()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_min)
  * [stdev()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_stdev)
  * [stdevp()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_stdevp)
  * [sum()](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_sum)
...
---  
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_avg)avg()
### Syntax
`avg( [DISTINCT] setExp )`
### Description
...
---|---|---  
`setExp` | An expression that evaluates to a `SET`, `BAG`, `SetAccum` or `BagAccum` | `SET`, `BAG`, `SetAccum`, `BagAccum`  
### Example
```
avg([5, 4, 1, 0, 0, 0]) -> 1
avg([3, 2, 1]) -> 2
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_count)count()
### Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_max)max()
### Syntax
`max( [DISTINCT] setExp )`
### Description
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_min)min()
### Syntax
`min( [DISTINCT] setExp )`
### Description
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_stdev)stdev()
### Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_stdevp)stdevp()
### Syntax
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/aggregation-functions#_sum)sum()
### Syntax
`sum( [DISTINCT] setExp )`
### Description
