...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods)[Next](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/querying/pages/func/edge-methods.adoc)
### Contents
  * [Dot-syntax methods](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_dot_syntax_methods)
  * [Edge functions](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_edge_functions)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_dot_syntax_methods)Dot-syntax methods
This section includes object-oriented methods that are invoked on an edge or edge alias, invoked using the dot (`.`) operator.
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_getattr)`getAttr()`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_syntax)Syntax
`e.getAttr( attrName, attrType )`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_description)Description
Returns the value of an attribute of the edge.
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_return_type)Return type
The data type of the attribute itself.
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_parameters)Parameters
...
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_example)Example
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_isdirected)`isDirected()`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_syntax_2)Syntax
`e.isDirected()`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_description_2)Description
Returns a boolean value indicating whether the edge is directed or undirected.
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_return_type_2)Return type
`BOOL`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_parameters_2)Parameters
None.
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_setattr)`setAttr()`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_syntax_3)Syntax
`e.setAttr( attrName, attrNewValue )`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_description_3)Description
...
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_return_type_3)Return type
No return value.
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_parameters_3)Parameters
Parameter | Description | Data type  
---|---|---  
...
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_example_2)Example
```
...
---|---  
## [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_edge_functions)Edge functions
This section includes functions that return an edge, or take in an edge as its parameter.
### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_elementid)`elementId()`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_syntax_4)Syntax
`elementId(e)`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_description_4)Description
...
---  
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_return_type_4)Return type
`STRING`
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_parameters_4)Parameters
Parameter | Description | Data type  
---|---|---  
`e` | An edge | `EDGE`  
#### [](https://docs.tigergraph.com/gsql-ref/4.1/querying/func/edge-methods#_example_3)Example
```
