...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words)[Next](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/appendix/pages/keywords-and-reserved-words.adoc)
### Contents
  * [GSQL Reserved Words](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_gsql_reserved_words)
  * [Reserved prefixes](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_reserved_prefixes)
  * [Reserved word list](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_reserved_word_list)
  * [GSQL Non-Reserved Keywords](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_gsql_non_reserved_keywords)
  * [Non-reserved keyword list](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_non_reserved_keyword_list)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_gsql_reserved_words)GSQL Reserved Words
...
There is a separate list for [Reserved Words in the **Query Language**](https://docs.tigergraph.com/gsql-ref/4.1/appendix/query-language-reserved-words). The compiler will reject the use of a reserved word as well as any word beginning with a reserved prefix as a user-defined identifier.
### [](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_reserved_prefixes)Reserved prefixes
  * `gsql_sys_`


### [](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_reserved_word_list)Reserved word list
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_gsql_non_reserved_keywords)GSQL Non-Reserved Keywords
These keywords in the language are non-reserved, so users may use them for user-defined identifiers.
### [](https://docs.tigergraph.com/gsql-ref/4.1/appendix/keywords-and-reserved-words#_non_reserved_keyword_list)Non-reserved keyword list
  * ABORT
  * ACL
  * ADMIN
  * API
