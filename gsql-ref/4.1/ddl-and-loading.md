...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/)[Next](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/ddl-and-loading/pages/index.adoc)
# Schema Definition
...
The DDL documentation is split into two logical parts:
  * [Defining a graph schema](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/defining-a-graph-schema)
  * [Modifying a graph schema](https://docs.tigergraph.com/gsql-ref/4.1/ddl-and-loading/modifying-a-graph-schema)
