...
Page 1[Prev](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics)[Next](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics)
...
[Edit this Page](https://github.com/tigergraph/gsql-docs/edit/4.1/modules/basics/pages/system-and-language-basics.adoc)
### Contents
  * [Language basics](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_language_basics)
  * [Running GSQL](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_running_gsql)
  * [Token-based authentication method](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_token_based_authentication_method)
  * [GSQL client session timeout](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_gsql_client_session_timeout)
  * [Multiple shell sessions](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_multiple_shell_sessions)
  * [Multi-line mode - BEGIN, END, ABORT](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_multi_line_mode_begin_end_abort)
  * [Command files and inline commands](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_command_files_and_inline_commands)
  * [Help and information](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_help_and_information)
  * [--reset option](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_reset_option)
  * [Summary](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_summary)
  * [Session parameters](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_session_parameters)
  * [Examples](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_examples)
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_language_basics)Language basics
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_running_gsql)Running GSQL
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_token_based_authentication_method)Token-based authentication method
...
---  
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_gsql_client_session_timeout)GSQL client session timeout
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_multiple_shell_sessions)Multiple shell sessions
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_multi_line_mode_begin_end_abort)Multi-line mode - BEGIN, END, ABORT
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_command_files_and_inline_commands)Command files and inline commands
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_help_and_information)Help and information
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_reset_option)--reset option
...
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_summary)Summary
The tables below summarize the basic commands introduced so far.
#### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_gsql_commands)GSQL commands
Command | Description  
---|---  
...
#### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_system_shell_commands)System shell commands
Command | Description  
---|---  
...
## [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_session_parameters)Session parameters
...
`single_gpr` | Changes the internal engine framework for single queries to the engine framework currently used for distributed queries, also known as GPR. Enabling this mode may increase performance in certain cases. Default value is `false`. The loop variable in a `FOREACH[](https://docs.tigergraph.com/gsql-ref/4.1/querying/control-flow-statements#_foreach_statement)`[ loop](https://docs.tigergraph.com/gsql-ref/4.1/querying/control-flow-statements#_foreach_statement) with this option enabled is treated as a copy, while normally, changes to the loop variable will change the value in the set or bag expression.  
`cost-opt` | Whether to use [cost-based optimization](https://docs.tigergraph.com/gsql-ref/4.1/querying/query-optimizer/) when installing a query. If set to true, query installation during this session uses cost-based optimization.  
### [](https://docs.tigergraph.com/gsql-ref/4.1/basics/system-and-language-basics#_examples)Examples
  * File
  * Results
