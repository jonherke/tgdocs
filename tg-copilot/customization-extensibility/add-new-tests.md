...
Page 1[Prev](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests)[Next](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests)
...
[Edit this Page](https://github.com/tigergraph/copilot-docs/edit/main/modules/customization-extensibility/pages/add-new-tests.adoc)
### Contents
  * [Next Steps](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests#_next_steps)
...
To add a new InquiryAI test suite to TigerGraph CoPilot, follow these steps:
  ...
  7. Test your test suite. Run the test suite and ensure that it works as expected. Run the tests with the following command (and add desired options described here):
```
./run_tests.sh
...
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests#_next_steps)Next Steps
