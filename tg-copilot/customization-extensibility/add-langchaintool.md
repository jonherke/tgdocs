...
Page 1[Prev](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool)[Next](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool)
...
[Edit this Page](https://github.com/tigergraph/copilot-docs/edit/main/modules/customization-extensibility/pages/add-langchaintool.adoc)
### Contents
  * [Next Steps](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool#_next_steps)
...
To add a new LangChain tool, follow these steps:
  ...
  2. Define your tool. The tool should a valid Python class that inherits from the LangChain BaseTool class. For more information refer to the [LangChain’s documentation](https://python.langchain.com/docs/modules/tools/custom_tools/#subclass-basetool).
  3. Add your tool to the `app/tools/_init_.py`file. This file should contain an import statement for your tool. For example:
```
...
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool#_next_steps)Next Steps
