...
Page 1[Prev](https://docs.tigergraph.com/tg-copilot/getstarted/)[Next](https://docs.tigergraph.com/tg-copilot/getstarted/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tg-copilot/getstarted/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tg-copilot/getstarted/)
...
[Edit this Page](https://github.com/tigergraph/copilot-docs/edit/main/modules/getstarted/pages/index.adoc)
### Contents
  * [On Cloud](https://docs.tigergraph.com/tg-copilot/getstarted/#_on_cloud)
  * [Self-Managed](https://docs.tigergraph.com/tg-copilot/getstarted/#_self_managed)
  * [Next Steps](https://docs.tigergraph.com/tg-copilot/getstarted/#_next_steps)
...
## [](https://docs.tigergraph.com/tg-copilot/getstarted/#_on_cloud)[On Cloud](https://docs.tigergraph.com/tg-copilot/getstarted/oncloud)
Create a workspace and add TigerGraph CoPilot on TigerGraph Cloud.
## [](https://docs.tigergraph.com/tg-copilot/getstarted/#_self_managed)[Self-Managed](https://docs.tigergraph.com/tg-copilot/getstarted/self-managed)
Download a local self-managed TigerGraph CoPilot service.
## [](https://docs.tigergraph.com/tg-copilot/getstarted/#_next_steps)Next Steps
Next, go to [Using TigerGraph CoPilot](https://docs.tigergraph.com/tg-copilot/using-copilot/) to learn how to use TigerGraph CoPilot.
  * [Test TigerGraph CoPilot](https://docs.tigergraph.com/tg-copilot/testing/) - Once setup with TigerGraph CoPilot users can test the service.
  * [Customization and Extensibility](https://docs.tigergraph.com/tg-copilot/customization-extensibility/) - These options allow users to expand and customize the TigerGraph CoPilot Service.
  * [Contribute](https://docs.tigergraph.com/tg-copilot/contribution/) - Join the community and contribute to TigerGraph CoPilot on our [Github](https://github.com/tigergraph/CoPilot/blob/main/docs/Contributing.md).
