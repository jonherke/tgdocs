...
Page 1[Prev](https://docs.tigergraph.com/tg-copilot/customization-extensibility/)[Next](https://docs.tigergraph.com/tg-copilot/customization-extensibility/)
Search by [Algolia](https://www.algolia.com/docsearch)
[Products](https://docs.tigergraph.com/tg-copilot/customization-extensibility/)
TigerGraph Savanna
...
[Resources](https://docs.tigergraph.com/tg-copilot/customization-extensibility/)
...
[Edit this Page](https://github.com/tigergraph/copilot-docs/edit/main/modules/customization-extensibility/pages/index.adoc)
### Contents
  * [Adding a New LangChain Tool](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_a_new_langchain_tool)
  * [Adding a New Embedding Service](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_a_new_embedding_service)
  * [Adding a New LLM Generation Service](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_a_new_llm_generation_service)
  * [Adding New Tests](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_new_tests)
  * [Next Steps](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_next_steps)
...
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_a_new_langchain_tool)[Adding a New LangChain Tool](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-langchaintool)
...
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_a_new_embedding_service)[Adding a New Embedding Service](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-embedding-service)
Here you can add a new embedding service to TigerGraph CoPilot to better fit their deployment environment.
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_a_new_llm_generation_service)[Adding a New LLM Generation Service](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-llm)
Here you can learn how to add a new LLM generation service to TigerGraph CoPilot,
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_adding_new_tests)[Adding New Tests](https://docs.tigergraph.com/tg-copilot/customization-extensibility/add-new-tests)
Here you can learn to add a new InquiryAI test suite to TigerGraph CoPilot.
## [](https://docs.tigergraph.com/tg-copilot/customization-extensibility/#_next_steps)Next Steps
